...
/**
 ...
 The example below demonstrates how to record view and conversion events. The `@"level1Complete"` event represents the view event,
 and if the user makes a purchase, the code below records a `@"level1UserBoughtUpgrade"` event as the conversion event.
