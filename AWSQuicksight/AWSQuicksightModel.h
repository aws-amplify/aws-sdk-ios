...
typedef NS_ENUM(NSInteger, AWSQuicksightDataSourceErrorInfoType) {
    ...
    AWSQuicksightDataSourceErrorInfoTypeAccessDenied,
    AWSQuicksightDataSourceErrorInfoTypeCopySourceNotFound,
 ...
 */
@property (nonatomic, strong) NSArray<AWSQuicksightDataSourceParameters *> * _Nullable alternateDataSourceParameters;
 ...
 */
@property (nonatomic, strong) NSString * _Nullable replicateSourceArn;
