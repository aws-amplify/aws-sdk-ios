...
+ (NSValueTransformer *)metricNameJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"BurstCapacityTime"] == NSOrderedSame) {
            return @(AWSLightsailMetricNameBurstCapacityTime);
        }
        if ([value caseInsensitiveCompare:@"BurstCapacityPercentage"] == NSOrderedSame) {
            return @(AWSLightsailMetricNameBurstCapacityPercentage);
        }
        ...
        switch ([value integerValue]) {
            ...
            case AWSLightsailMetricNameBurstCapacityTime:
                return @"BurstCapacityTime";
            case AWSLightsailMetricNameBurstCapacityPercentage:
...
+ (NSValueTransformer *)metricNameJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"BurstCapacityTime"] == NSOrderedSame) {
            return @(AWSLightsailInstanceMetricNameBurstCapacityTime);
        }
        if ([value caseInsensitiveCompare:@"BurstCapacityPercentage"] == NSOrderedSame) {
            return @(AWSLightsailInstanceMetricNameBurstCapacityPercentage);
        }
        ...
        switch ([value integerValue]) {
            ...
            case AWSLightsailInstanceMetricNameStatusCheckFailedSystem:
                return @"StatusCheckFailed_System";
            case AWSLightsailInstanceMetricNameBurstCapacityTime:
                return @"BurstCapacityTime";
            case AWSLightsailInstanceMetricNameBurstCapacityPercentage:
                return @"BurstCapacityPercentage";
            default:
                return nil;
        }
