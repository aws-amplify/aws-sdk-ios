...
+ (NSValueTransformer *)configurationJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSceRightsizingRecommendationConfiguration class]];
}
...
@implementation AWSceRightsizingRecommendationConfiguration
...
+ (NSValueTransformer *)recommendationTargetJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"SAME_INSTANCE_FAMILY"] == NSOrderedSame) {
            return @(AWSceRecommendationTargetSameInstanceFamily);
        }
        if ([value caseInsensitiveCompare:@"CROSS_INSTANCE_FAMILY"] == NSOrderedSame) {
            return @(AWSceRecommendationTargetCrossInstanceFamily);
        }
        return @(AWSceRecommendationTargetUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSceRecommendationTargetSameInstanceFamily:
                return @"SAME_INSTANCE_FAMILY";
            case AWSceRecommendationTargetCrossInstanceFamily:
