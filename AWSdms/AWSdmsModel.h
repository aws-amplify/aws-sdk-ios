...
FOUNDATION_EXPORT NSString *const AWSdmsErrorDomain;

typedef NS_ENUM(NSInteger, AWSdmsErrorType) {
    AWSdmsErrorUnknown,
    AWSdmsErrorAccessDenied,
    AWSdmsErrorInsufficientResourceCapacity,
    AWSdmsErrorInvalidCertificate,
    AWSdmsErrorInvalidResourceState,
    AWSdmsErrorInvalidSubnet,
    AWSdmsErrorKMSAccessDenied,
    AWSdmsErrorKMSDisabled,
    AWSdmsErrorKMSInvalidState,
    AWSdmsErrorKMSKeyNotAccessible,
    AWSdmsErrorKMSNotFound,
    AWSdmsErrorKMSThrottling,
    AWSdmsErrorReplicationSubnetGroupDoesNotCoverEnoughAZs,
    AWSdmsErrorResourceAlreadyExists,
    AWSdmsErrorResourceNotFound,
    AWSdmsErrorResourceQuotaExceeded,
    AWSdmsErrorSNSInvalidTopic,
    AWSdmsErrorSNSNoAuthorization,
    AWSdmsErrorStorageQuotaExceeded,
    AWSdmsErrorSubnetAlreadyInUse,
    AWSdmsErrorUpgradeDependencyFailure,
};

typedef NS_ENUM(NSInteger, AWSdmsAuthMechanismValue) {
    AWSdmsAuthMechanismValueUnknown,
    AWSdmsAuthMechanismValueDefault,
    AWSdmsAuthMechanismValueMongodbCr,
    AWSdmsAuthMechanismValueScramSha1,
};

typedef NS_ENUM(NSInteger, AWSdmsAuthTypeValue) {
    AWSdmsAuthTypeValueUnknown,
    AWSdmsAuthTypeValueNo,
    AWSdmsAuthTypeValuePassword,
};

typedef NS_ENUM(NSInteger, AWSdmsCompressionTypeValue) {
    AWSdmsCompressionTypeValueUnknown,
    AWSdmsCompressionTypeValueNone,
    AWSdmsCompressionTypeValueGzip,
};

typedef NS_ENUM(NSInteger, AWSdmsDataFormatValue) {
    AWSdmsDataFormatValueUnknown,
    AWSdmsDataFormatValueCsv,
    AWSdmsDataFormatValueParquet,
};

typedef NS_ENUM(NSInteger, AWSdmsDmsSslModeValue) {
    AWSdmsDmsSslModeValueUnknown,
    AWSdmsDmsSslModeValueNone,
    AWSdmsDmsSslModeValueRequire,
    AWSdmsDmsSslModeValueVerifyCa,
    AWSdmsDmsSslModeValueVerifyFull,
};

typedef NS_ENUM(NSInteger, AWSdmsEncodingTypeValue) {
    AWSdmsEncodingTypeValueUnknown,
    AWSdmsEncodingTypeValuePlain,
    AWSdmsEncodingTypeValuePlainDictionary,
    AWSdmsEncodingTypeValueRleDictionary,
};

typedef NS_ENUM(NSInteger, AWSdmsEncryptionModeValue) {
    AWSdmsEncryptionModeValueUnknown,
    AWSdmsEncryptionModeValueSseS3,
    AWSdmsEncryptionModeValueSseKms,
};

typedef NS_ENUM(NSInteger, AWSdmsMessageFormatValue) {
    AWSdmsMessageFormatValueUnknown,
    AWSdmsMessageFormatValueJson,
    AWSdmsMessageFormatValueJsonUnformatted,
};

typedef NS_ENUM(NSInteger, AWSdmsMigrationTypeValue) {
    AWSdmsMigrationTypeValueUnknown,
    AWSdmsMigrationTypeValueFullLoad,
    AWSdmsMigrationTypeValueCdc,
    AWSdmsMigrationTypeValueFullLoadAndCdc,
};

typedef NS_ENUM(NSInteger, AWSdmsNestingLevelValue) {
    AWSdmsNestingLevelValueUnknown,
    AWSdmsNestingLevelValueNone,
    AWSdmsNestingLevelValueOne,
};

typedef NS_ENUM(NSInteger, AWSdmsParquetVersionValue) {
    AWSdmsParquetVersionValueUnknown,
    AWSdmsParquetVersionValueParquet10,
    AWSdmsParquetVersionValueParquet20,
};

typedef NS_ENUM(NSInteger, AWSdmsRefreshSchemasStatusTypeValue) {
    AWSdmsRefreshSchemasStatusTypeValueUnknown,
    AWSdmsRefreshSchemasStatusTypeValueSuccessful,
    AWSdmsRefreshSchemasStatusTypeValueFailed,
    AWSdmsRefreshSchemasStatusTypeValueRefreshing,
};

typedef NS_ENUM(NSInteger, AWSdmsReleaseStatusValues) {
    AWSdmsReleaseStatusValuesUnknown,
    AWSdmsReleaseStatusValuesBeta,
};

typedef NS_ENUM(NSInteger, AWSdmsReloadOptionValue) {
    AWSdmsReloadOptionValueUnknown,
    AWSdmsReloadOptionValueDataReload,
    AWSdmsReloadOptionValueValidateOnly,
};

typedef NS_ENUM(NSInteger, AWSdmsReplicationEndpointTypeValue) {
    AWSdmsReplicationEndpointTypeValueUnknown,
    AWSdmsReplicationEndpointTypeValueSource,
    AWSdmsReplicationEndpointTypeValueTarget,
};

typedef NS_ENUM(NSInteger, AWSdmsSourceType) {
    AWSdmsSourceTypeUnknown,
    AWSdmsSourceTypeReplicationInstance,
};

typedef NS_ENUM(NSInteger, AWSdmsStartReplicationTaskTypeValue) {
    AWSdmsStartReplicationTaskTypeValueUnknown,
    AWSdmsStartReplicationTaskTypeValueStartReplication,
    AWSdmsStartReplicationTaskTypeValueResumeProcessing,
    AWSdmsStartReplicationTaskTypeValueReloadTarget,
};

@class AWSdmsAccountQuota;
@class AWSdmsAddTagsToResourceMessage;
@class AWSdmsAddTagsToResourceResponse;
@class AWSdmsApplyPendingMaintenanceActionMessage;
@class AWSdmsApplyPendingMaintenanceActionResponse;
@class AWSdmsAvailabilityZone;
@class AWSdmsCertificate;
@class AWSdmsConnection;
@class AWSdmsCreateEndpointMessage;
@class AWSdmsCreateEndpointResponse;
@class AWSdmsCreateEventSubscriptionMessage;
@class AWSdmsCreateEventSubscriptionResponse;
@class AWSdmsCreateReplicationInstanceMessage;
@class AWSdmsCreateReplicationInstanceResponse;
@class AWSdmsCreateReplicationSubnetGroupMessage;
@class AWSdmsCreateReplicationSubnetGroupResponse;
@class AWSdmsCreateReplicationTaskMessage;
@class AWSdmsCreateReplicationTaskResponse;
@class AWSdmsDeleteCertificateMessage;
@class AWSdmsDeleteCertificateResponse;
@class AWSdmsDeleteConnectionMessage;
@class AWSdmsDeleteConnectionResponse;
@class AWSdmsDeleteEndpointMessage;
@class AWSdmsDeleteEndpointResponse;
@class AWSdmsDeleteEventSubscriptionMessage;
@class AWSdmsDeleteEventSubscriptionResponse;
@class AWSdmsDeleteReplicationInstanceMessage;
@class AWSdmsDeleteReplicationInstanceResponse;
@class AWSdmsDeleteReplicationSubnetGroupMessage;
@class AWSdmsDeleteReplicationSubnetGroupResponse;
@class AWSdmsDeleteReplicationTaskMessage;
@class AWSdmsDeleteReplicationTaskResponse;
@class AWSdmsDescribeAccountAttributesMessage;
@class AWSdmsDescribeAccountAttributesResponse;
@class AWSdmsDescribeCertificatesMessage;
@class AWSdmsDescribeCertificatesResponse;
@class AWSdmsDescribeConnectionsMessage;
@class AWSdmsDescribeConnectionsResponse;
@class AWSdmsDescribeEndpointTypesMessage;
@class AWSdmsDescribeEndpointTypesResponse;
@class AWSdmsDescribeEndpointsMessage;
@class AWSdmsDescribeEndpointsResponse;
@class AWSdmsDescribeEventCategoriesMessage;
@class AWSdmsDescribeEventCategoriesResponse;
@class AWSdmsDescribeEventSubscriptionsMessage;
@class AWSdmsDescribeEventSubscriptionsResponse;
@class AWSdmsDescribeEventsMessage;
@class AWSdmsDescribeEventsResponse;
@class AWSdmsDescribeOrderableReplicationInstancesMessage;
@class AWSdmsDescribeOrderableReplicationInstancesResponse;
@class AWSdmsDescribePendingMaintenanceActionsMessage;
@class AWSdmsDescribePendingMaintenanceActionsResponse;
@class AWSdmsDescribeRefreshSchemasStatusMessage;
@class AWSdmsDescribeRefreshSchemasStatusResponse;
@class AWSdmsDescribeReplicationInstanceTaskLogsMessage;
@class AWSdmsDescribeReplicationInstanceTaskLogsResponse;
@class AWSdmsDescribeReplicationInstancesMessage;
@class AWSdmsDescribeReplicationInstancesResponse;
@class AWSdmsDescribeReplicationSubnetGroupsMessage;
@class AWSdmsDescribeReplicationSubnetGroupsResponse;
@class AWSdmsDescribeReplicationTaskAssessmentResultsMessage;
@class AWSdmsDescribeReplicationTaskAssessmentResultsResponse;
@class AWSdmsDescribeReplicationTasksMessage;
@class AWSdmsDescribeReplicationTasksResponse;
@class AWSdmsDescribeSchemasMessage;
@class AWSdmsDescribeSchemasResponse;
@class AWSdmsDescribeTableStatisticsMessage;
@class AWSdmsDescribeTableStatisticsResponse;
@class AWSdmsDmsTransferSettings;
@class AWSdmsDynamoDbSettings;
@class AWSdmsElasticsearchSettings;
@class AWSdmsEndpoint;
@class AWSdmsEvent;
@class AWSdmsEventCategoryGroup;
@class AWSdmsEventSubscription;
@class AWSdmsFilter;
@class AWSdmsImportCertificateMessage;
@class AWSdmsImportCertificateResponse;
@class AWSdmsKafkaSettings;
@class AWSdmsKinesisSettings;
@class AWSdmsListTagsForResourceMessage;
@class AWSdmsListTagsForResourceResponse;
@class AWSdmsModifyEndpointMessage;
@class AWSdmsModifyEndpointResponse;
@class AWSdmsModifyEventSubscriptionMessage;
@class AWSdmsModifyEventSubscriptionResponse;
@class AWSdmsModifyReplicationInstanceMessage;
@class AWSdmsModifyReplicationInstanceResponse;
@class AWSdmsModifyReplicationSubnetGroupMessage;
@class AWSdmsModifyReplicationSubnetGroupResponse;
@class AWSdmsModifyReplicationTaskMessage;
@class AWSdmsModifyReplicationTaskResponse;
@class AWSdmsMongoDbSettings;
@class AWSdmsNeptuneSettings;
@class AWSdmsOrderableReplicationInstance;
@class AWSdmsPendingMaintenanceAction;
@class AWSdmsRebootReplicationInstanceMessage;
@class AWSdmsRebootReplicationInstanceResponse;
@class AWSdmsRedshiftSettings;
@class AWSdmsRefreshSchemasMessage;
@class AWSdmsRefreshSchemasResponse;
@class AWSdmsRefreshSchemasStatus;
@class AWSdmsReloadTablesMessage;
@class AWSdmsReloadTablesResponse;
@class AWSdmsRemoveTagsFromResourceMessage;
@class AWSdmsRemoveTagsFromResourceResponse;
@class AWSdmsReplicationInstance;
@class AWSdmsReplicationInstanceTaskLog;
@class AWSdmsReplicationPendingModifiedValues;
@class AWSdmsReplicationSubnetGroup;
@class AWSdmsReplicationTask;
@class AWSdmsReplicationTaskAssessmentResult;
@class AWSdmsReplicationTaskStats;
@class AWSdmsResourcePendingMaintenanceActions;
@class AWSdmsS3Settings;
@class AWSdmsStartReplicationTaskAssessmentMessage;
@class AWSdmsStartReplicationTaskAssessmentResponse;
@class AWSdmsStartReplicationTaskMessage;
@class AWSdmsStartReplicationTaskResponse;
@class AWSdmsStopReplicationTaskMessage;
@class AWSdmsStopReplicationTaskResponse;
@class AWSdmsSubnet;
@class AWSdmsSupportedEndpointType;
@class AWSdmsTableStatistics;
@class AWSdmsTableToReload;
@class AWSdmsTag;
@class AWSdmsTestConnectionMessage;
@class AWSdmsTestConnectionResponse;
@class AWSdmsVpcSecurityGroupMembership;

/**
 <p>Describes a quota for an AWS account, for example, the number of replication instances allowed.</p>
 */
@interface AWSdmsAccountQuota : AWSModel
 ...
 */
@interface AWSdmsAddTagsToResourceMessage : AWSRequest
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsTag *> * _Nullable tags;
...
/**
 <p/>
 */
@interface AWSdmsAddTagsToResourceResponse : AWSModel
 ...
 */
@interface AWSdmsApplyPendingMaintenanceActionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsApplyPendingMaintenanceActionResponse : AWSModel


/**
 <p>The AWS DMS resource that the pending maintenance action will be applied to.</p>
 */
@property (nonatomic, strong) AWSdmsResourcePendingMaintenanceActions * _Nullable resourcePendingMaintenanceActions;
 ...
 */
@interface AWSdmsAvailabilityZone : AWSModel
 ...
 */
@interface AWSdmsCertificate : AWSModel
 ...
 */
@interface AWSdmsConnection : AWSModel
 ...
 */
@interface AWSdmsCreateEndpointMessage : AWSRequest
 ...
 */
@property (nonatomic, strong) AWSdmsDmsTransferSettings * _Nullable dmsTransferSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsDynamoDbSettings * _Nullable dynamoDbSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsElasticsearchSettings * _Nullable elasticsearchSettings;
 ...
 */
@property (nonatomic, assign) AWSdmsReplicationEndpointTypeValue endpointType;
 ...
 */
@property (nonatomic, strong) AWSdmsKafkaSettings * _Nullable kafkaSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsKinesisSettings * _Nullable kinesisSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsMongoDbSettings * _Nullable mongoDbSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsNeptuneSettings * _Nullable neptuneSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsRedshiftSettings * _Nullable redshiftSettings;
 ...
 */
@property (nonatomic, strong) AWSdmsS3Settings * _Nullable s3Settings;
 ...
 */
@property (nonatomic, assign) AWSdmsDmsSslModeValue sslMode;
...
/**
 <p/>
 */
@interface AWSdmsCreateEndpointResponse : AWSModel


/**
 <p>The endpoint that was created.</p>
 */
@property (nonatomic, strong) AWSdmsEndpoint * _Nullable endpoint;
 ...
 */
@interface AWSdmsCreateEventSubscriptionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsCreateEventSubscriptionResponse : AWSModel


/**
 <p>The event subscription that was created.</p>
 */
@property (nonatomic, strong) AWSdmsEventSubscription * _Nullable eventSubscription;
 ...
 */
@interface AWSdmsCreateReplicationInstanceMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsCreateReplicationInstanceResponse : AWSModel


/**
 <p>The replication instance that was created.</p>
 */
@property (nonatomic, strong) AWSdmsReplicationInstance * _Nullable replicationInstance;
 ...
 */
@interface AWSdmsCreateReplicationSubnetGroupMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsCreateReplicationSubnetGroupResponse : AWSModel


/**
 <p>The replication subnet group that was created.</p>
 */
@property (nonatomic, strong) AWSdmsReplicationSubnetGroup * _Nullable replicationSubnetGroup;
 ...
 */
@interface AWSdmsCreateReplicationTaskMessage : AWSRequest
 ...
 */
@property (nonatomic, assign) AWSdmsMigrationTypeValue migrationType;
...
/**
 <p/>
 */
@interface AWSdmsCreateReplicationTaskResponse : AWSModel


/**
 <p>The replication task that was created.</p>
 */
@property (nonatomic, strong) AWSdmsReplicationTask * _Nullable replicationTask;
 ...
 */
@interface AWSdmsDeleteCertificateMessage : AWSRequest
 ...
 */
@interface AWSdmsDeleteCertificateResponse : AWSModel


/**
 <p>The Secure Sockets Layer (SSL) certificate.</p>
 */
@property (nonatomic, strong) AWSdmsCertificate * _Nullable certificate;
 ...
 */
@interface AWSdmsDeleteConnectionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteConnectionResponse : AWSModel


/**
 <p>The connection that is being deleted.</p>
 */
@property (nonatomic, strong) AWSdmsConnection * _Nullable connection;
 ...
 */
@interface AWSdmsDeleteEndpointMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteEndpointResponse : AWSModel
 ...
 */
@interface AWSdmsDeleteEventSubscriptionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteEventSubscriptionResponse : AWSModel
 ...
 */
@interface AWSdmsDeleteReplicationInstanceMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteReplicationInstanceResponse : AWSModel
 ...
 */
@interface AWSdmsDeleteReplicationSubnetGroupMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteReplicationSubnetGroupResponse : AWSModel
 ...
 */
@interface AWSdmsDeleteReplicationTaskMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDeleteReplicationTaskResponse : AWSModel
...
/**
 <p/>
 */
@interface AWSdmsDescribeAccountAttributesMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeAccountAttributesResponse : AWSModel


/**
 <p>Account quota information.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsAccountQuota *> * _Nullable accountQuotas;
 ...
 */
@interface AWSdmsDescribeCertificatesMessage : AWSRequest


/**
 <p>Filters applied to the certificate described in the form of key-value pairs.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsFilter *> * _Nullable filters;
 ...
 */
@interface AWSdmsDescribeCertificatesResponse : AWSModel


/**
 <p>The Secure Sockets Layer (SSL) certificates associated with the replication instance.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsCertificate *> * _Nullable certificates;
...
/**
 <p/>
 */
@interface AWSdmsDescribeConnectionsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeConnectionsResponse : AWSModel


/**
 <p>A description of the connections.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsConnection *> * _Nullable connections;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEndpointTypesMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeEndpointTypesResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsSupportedEndpointType *> * _Nullable supportedEndpointTypes;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEndpointsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeEndpointsResponse : AWSModel


/**
 <p>Endpoint description.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsEndpoint *> * _Nullable endpoints;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventCategoriesMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventCategoriesResponse : AWSModel


/**
 <p>A list of event categories.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsEventCategoryGroup *> * _Nullable eventCategoryGroupList;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventSubscriptionsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventSubscriptionsResponse : AWSModel


/**
 <p>A list of event subscriptions.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsEventSubscription *> * _Nullable eventSubscriptionsList;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventsMessage : AWSRequest
...
/**
 <p>The type of AWS DMS resource that generates events.</p><p>Valid values: replication-instance | replication-task</p>
 */
@property (nonatomic, assign) AWSdmsSourceType sourceType;
...
/**
 <p/>
 */
@interface AWSdmsDescribeEventsResponse : AWSModel


/**
 <p>The events described.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsEvent *> * _Nullable events;
...
/**
 <p/>
 */
@interface AWSdmsDescribeOrderableReplicationInstancesMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeOrderableReplicationInstancesResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsOrderableReplicationInstance *> * _Nullable orderableReplicationInstances;
...
/**
 <p/>
 */
@interface AWSdmsDescribePendingMaintenanceActionsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribePendingMaintenanceActionsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsResourcePendingMaintenanceActions *> * _Nullable pendingMaintenanceActions;
...
/**
 ...
 Required parameters: [EndpointArn]
 */
@interface AWSdmsDescribeRefreshSchemasStatusMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeRefreshSchemasStatusResponse : AWSModel


/**
 <p>The status of the schema.</p>
 */
@property (nonatomic, strong) AWSdmsRefreshSchemasStatus * _Nullable refreshSchemasStatus;
 ...
 */
@interface AWSdmsDescribeReplicationInstanceTaskLogsMessage : AWSRequest
 ...
 */
@interface AWSdmsDescribeReplicationInstanceTaskLogsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsReplicationInstanceTaskLog *> * _Nullable replicationInstanceTaskLogs;
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationInstancesMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationInstancesResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsReplicationInstance *> * _Nullable replicationInstances;
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationSubnetGroupsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationSubnetGroupsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsReplicationSubnetGroup *> * _Nullable replicationSubnetGroups;
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationTaskAssessmentResultsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationTaskAssessmentResultsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsReplicationTaskAssessmentResult *> * _Nullable replicationTaskAssessmentResults;
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationTasksMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeReplicationTasksResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsReplicationTask *> * _Nullable replicationTasks;
...
/**
 ...
 Required parameters: [EndpointArn]
 */
@interface AWSdmsDescribeSchemasMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeSchemasResponse : AWSModel
...
/**
 ...
 Required parameters: [ReplicationTaskArn]
 */
@interface AWSdmsDescribeTableStatisticsMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsDescribeTableStatisticsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsTableStatistics *> * _Nullable tableStatistics;
 ...
 */
@interface AWSdmsDmsTransferSettings : AWSModel
 ...
 */
@interface AWSdmsDynamoDbSettings : AWSModel
 ...
 */
@interface AWSdmsElasticsearchSettings : AWSModel
 ...
 */
@interface AWSdmsEndpoint : AWSModel
 ...
 */
@interface AWSdmsEvent : AWSModel
 ...
 */
@interface AWSdmsEventCategoryGroup : AWSModel
 ...
 */
@interface AWSdmsEventSubscription : AWSModel
 ...
 */
@interface AWSdmsFilter : AWSModel
 ...
 */
@interface AWSdmsImportCertificateMessage : AWSRequest
 ...
 */
@interface AWSdmsImportCertificateResponse : AWSModel
 ...
 */
@interface AWSdmsKafkaSettings : AWSModel
 ...
 */
@interface AWSdmsKinesisSettings : AWSModel
 ...
 */
@property (nonatomic, assign) AWSdmsMessageFormatValue messageFormat;
 ...
 */
@interface AWSdmsListTagsForResourceMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsListTagsForResourceResponse : AWSModel


/**
 <p>A list of tags for the resource.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsTag *> * _Nullable tagList;
...
/**
 ...
 Required parameters: [EndpointArn]
 */
@interface AWSdmsModifyEndpointMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsModifyEndpointResponse : AWSModel
...
/**
 ...
 Required parameters: [SubscriptionName]
 */
@interface AWSdmsModifyEventSubscriptionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsModifyEventSubscriptionResponse : AWSModel
...
/**
 ...
 Required parameters: [ReplicationInstanceArn]
 */
@interface AWSdmsModifyReplicationInstanceMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsModifyReplicationInstanceResponse : AWSModel
 ...
 */
@interface AWSdmsModifyReplicationSubnetGroupMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsModifyReplicationSubnetGroupResponse : AWSModel
...
/**
 ...
 Required parameters: [ReplicationTaskArn]
 */
@interface AWSdmsModifyReplicationTaskMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsModifyReplicationTaskResponse : AWSModel
 ...
 */
@interface AWSdmsMongoDbSettings : AWSModel
 ...
 */
@property (nonatomic, assign) AWSdmsAuthMechanismValue authMechanism;
 ...
 */
@property (nonatomic, assign) AWSdmsAuthTypeValue authType;
 ...
 */
@property (nonatomic, assign) AWSdmsNestingLevelValue nestingLevel;
 ...
 */
@interface AWSdmsNeptuneSettings : AWSModel
 ...
 */
@interface AWSdmsOrderableReplicationInstance : AWSModel
 ...
 */
@property (nonatomic, assign) AWSdmsReleaseStatusValues releaseStatus;
 ...
 */
@interface AWSdmsPendingMaintenanceAction : AWSModel
 ...
 */
@interface AWSdmsRebootReplicationInstanceMessage : AWSRequest
 ...
 */
@interface AWSdmsRebootReplicationInstanceResponse : AWSModel
...
/**
 <p>Provides information that defines an Amazon Redshift endpoint.</p>
 */
@interface AWSdmsRedshiftSettings : AWSModel
 ...
 */
@property (nonatomic, assign) AWSdmsEncryptionModeValue encryptionMode;
...
/**
 ...
 Required parameters: [EndpointArn, ReplicationInstanceArn]
 */
@interface AWSdmsRefreshSchemasMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsRefreshSchemasResponse : AWSModel
 ...
 */
@interface AWSdmsRefreshSchemasStatus : AWSModel
...
/**
 <p>The status of the schema.</p>
 */
@property (nonatomic, assign) AWSdmsRefreshSchemasStatusTypeValue status;
 ...
 */
@interface AWSdmsReloadTablesMessage : AWSRequest
 ...
 */
@property (nonatomic, assign) AWSdmsReloadOptionValue reloadOption;
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsTableToReload *> * _Nullable tablesToReload;
 ...
 */
@interface AWSdmsReloadTablesResponse : AWSModel
 ...
 */
@interface AWSdmsRemoveTagsFromResourceMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsRemoveTagsFromResourceResponse : AWSModel
 ...
 */
@interface AWSdmsReplicationInstance : AWSModel
 ...
 */
@property (nonatomic, strong) AWSdmsReplicationPendingModifiedValues * _Nullable pendingModifiedValues;
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsVpcSecurityGroupMembership *> * _Nullable vpcSecurityGroups;
 ...
 */
@interface AWSdmsReplicationInstanceTaskLog : AWSModel
 ...
 */
@interface AWSdmsReplicationPendingModifiedValues : AWSModel
 ...
 */
@interface AWSdmsReplicationSubnetGroup : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSdmsSubnet *> * _Nullable subnets;
 ...
 */
@interface AWSdmsReplicationTask : AWSModel
 ...
 */
@property (nonatomic, strong) AWSdmsReplicationTaskStats * _Nullable replicationTaskStats;
 ...
 */
@interface AWSdmsReplicationTaskAssessmentResult : AWSModel
 ...
 */
@interface AWSdmsReplicationTaskStats : AWSModel
 ...
 */
@interface AWSdmsResourcePendingMaintenanceActions : AWSModel


/**
 <p>Detailed information about the pending maintenance action.</p>
 */
@property (nonatomic, strong) NSArray<AWSdmsPendingMaintenanceAction *> * _Nullable pendingMaintenanceActionDetails;
 ...
 */
@interface AWSdmsS3Settings : AWSModel
 ...
 */
@property (nonatomic, assign) AWSdmsCompressionTypeValue compressionType;
 ...
 */
@property (nonatomic, assign) AWSdmsDataFormatValue dataFormat;
 ...
 */
@property (nonatomic, assign) AWSdmsEncodingTypeValue encodingType;
 ...
 */
@property (nonatomic, assign) AWSdmsParquetVersionValue parquetVersion;
...
/**
 ...
 Required parameters: [ReplicationTaskArn]
 */
@interface AWSdmsStartReplicationTaskAssessmentMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsStartReplicationTaskAssessmentResponse : AWSModel
 ...
 */
@interface AWSdmsStartReplicationTaskMessage : AWSRequest
 ...
 */
@property (nonatomic, assign) AWSdmsStartReplicationTaskTypeValue startReplicationTaskType;
...
/**
 <p/>
 */
@interface AWSdmsStartReplicationTaskResponse : AWSModel
...
/**
 ...
 Required parameters: [ReplicationTaskArn]
 */
@interface AWSdmsStopReplicationTaskMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsStopReplicationTaskResponse : AWSModel
 ...
 */
@interface AWSdmsSubnet : AWSModel


/**
 <p>The Availability Zone of the subnet.</p>
 */
@property (nonatomic, strong) AWSdmsAvailabilityZone * _Nullable subnetAvailabilityZone;
 ...
 */
@interface AWSdmsSupportedEndpointType : AWSModel
 ...
 */
@interface AWSdmsTableStatistics : AWSModel
 ...
 */
@interface AWSdmsTableToReload : AWSModel
 ...
 */
@interface AWSdmsTestConnectionMessage : AWSRequest
...
/**
 <p/>
 */
@interface AWSdmsTestConnectionResponse : AWSModel
 ...
 */
@interface AWSdmsVpcSecurityGroupMembership : AWSModel
