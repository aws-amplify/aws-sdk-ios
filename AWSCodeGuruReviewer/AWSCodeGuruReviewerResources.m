...
@interface AWSCodeGuruReviewerResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSCodeGuruReviewerResources

+ (instancetype)sharedInstance {
    static AWSCodeGuruReviewerResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSCodeGuruReviewerResources new];
    });
