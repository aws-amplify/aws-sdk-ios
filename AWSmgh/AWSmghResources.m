...
@interface AWSmghResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSmghResources

+ (instancetype)sharedInstance {
    static AWSmghResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSmghResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"PolicyErrorException\":{\
      ...
      \"documentation\":\"<p>Exception raised when there are problems accessing Application Discovery Service (Application Discovery Service); most likely due to a misconfigured policy or the <code>migrationhub-discovery</code> role is missing or not configured correctly.</p>\",\
      \"exception\":true\
    },\
    \"ProgressPercent\":{\
      \"type\":\"integer\",\
    ...
    \"ThrottlingException\":{\
      ...
      \"members\":{\
        \"Message\":{\
          \"shape\":\"ErrorMessage\",\
          \"documentation\":\"<p>A message that provides information about the exception.</p>\"\
        },\
        \"RetryAfterSeconds\":{\
