...
@interface AWSDirectconnectResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSDirectconnectResources

+ (instancetype)sharedInstance {
    static AWSDirectconnectResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSDirectconnectResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"DirectConnectServerException\":{\
      ...
      \"documentation\":\"<p>A server-side error occurred.</p>\",\
      \"exception\":true\
    },\
