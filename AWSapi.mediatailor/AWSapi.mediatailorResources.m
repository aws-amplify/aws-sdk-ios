...
@interface AWSapi.mediatailorResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSapi.mediatailorResources

+ (instancetype)sharedInstance {
    static AWSapi.mediatailorResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSapi.mediatailorResources new];
    });
