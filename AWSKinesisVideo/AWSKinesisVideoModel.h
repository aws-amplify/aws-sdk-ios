...
/**
 <p>The Uniform Resource Identifier (Uri) type. The <code>FILE_URI</code> value can be used to stream local media files.</p>
 */
...
/**
 <p>The configuration that consists of the <code>ScheduleConfig</code> attribute that's required, to schedule the jobs to upload the recorded media files onto the Edge Agent in a Kinesis Video Stream. </p>
