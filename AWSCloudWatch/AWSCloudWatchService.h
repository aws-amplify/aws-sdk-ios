...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSCloudWatchListTagsForResourceOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSCloudWatchErrorDomain` domain and the following error code: `AWSCloudWatchErrorInvalidParameterValue`, `AWSCloudWatchErrorResourceNotFound`, `AWSCloudWatchErrorInternalService`.
 
 @see AWSCloudWatchListTagsForResourceInput
 @see AWSCloudWatchListTagsForResourceOutput
 */
...
/**
 ...
 @see AWSCloudWatchListTagsForResourceOutput
 */
- (void)listTagsForResource:(AWSCloudWatchListTagsForResourceInput *)request completionHandler:(void (^ _Nullable)(AWSCloudWatchListTagsForResourceOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSCloudWatchTagResourceOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSCloudWatchErrorDomain` domain and the following error code: `AWSCloudWatchErrorInvalidParameterValue`, `AWSCloudWatchErrorResourceNotFound`, `AWSCloudWatchErrorConcurrentModification`, `AWSCloudWatchErrorInternalService`.
 
 @see AWSCloudWatchTagResourceInput
 @see AWSCloudWatchTagResourceOutput
 */
...
/**
 ...
 @see AWSCloudWatchTagResourceOutput
 */
- (void)tagResource:(AWSCloudWatchTagResourceInput *)request completionHandler:(void (^ _Nullable)(AWSCloudWatchTagResourceOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSCloudWatchUntagResourceOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSCloudWatchErrorDomain` domain and the following error code: `AWSCloudWatchErrorInvalidParameterValue`, `AWSCloudWatchErrorResourceNotFound`, `AWSCloudWatchErrorConcurrentModification`, `AWSCloudWatchErrorInternalService`.
 
 @see AWSCloudWatchUntagResourceInput
 @see AWSCloudWatchUntagResourceOutput
 */
...
/**
 ...
 @see AWSCloudWatchUntagResourceOutput
 */
- (void)untagResource:(AWSCloudWatchUntagResourceInput *)request completionHandler:(void (^ _Nullable)(AWSCloudWatchUntagResourceOutput * _Nullable response, NSError * _Nullable error))completionHandler;
