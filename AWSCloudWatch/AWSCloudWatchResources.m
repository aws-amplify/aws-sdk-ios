  ...
  \"shapes\":{\
    ...
    \"GetMetricStatisticsInput\":{\
      ...
      \"members\":{\
        ...
        \"StartTime\":{\
          \"shape\":\"Timestamp\",\
          \"documentation\":\"<p> The time stamp to use for determining the first datapoint to return. The value specified is inclusive; results include datapoints with the time stamp specified. The time stamp must be in ISO 8601 UTC format (e.g., 2014-09-03T23:00:00Z). </p> <note> The specified start time is rounded down to the nearest value. Datapoints are returned for start times up to two weeks in the past. Specified start times that are more than two weeks in the past will not return datapoints for metrics that are older than two weeks. <p>Data that is timestamped 24 hours or more in the past may take in excess of 48 hours to become available from submission time using <code>GetMetricStatistics</code>.</p> </note>\"\
        },\
        \"EndTime\":{\
          \"shape\":\"Timestamp\",\
    ...
    \"MetricAlarm\":{\
      ...
      \"members\":{\
        ...
        \"InsufficientDataActions\":{\
          \"shape\":\"ResourceList\",\
          \"documentation\":\"<p> The list of actions to execute when this alarm transitions into an <code>INSUFFICIENT_DATA</code> state from any other state. Each action is specified as an Amazon Resource Name (ARN). </p> <important>The current WSDL lists this attribute as <code>UnknownActions</code>.</important>\"\
        },\
        \"StateValue\":{\
          \"shape\":\"StateValue\",\
