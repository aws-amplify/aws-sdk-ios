...
@interface AWSKendraFrontendServiceResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSKendraFrontendServiceResources

+ (instancetype)sharedInstance {
    static AWSKendraFrontendServiceResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSKendraFrontendServiceResources new];
    });
    ...
    \"CreateIndexRequest\":{\
      ...
      \"members\":{\
        ...
        \"ClientToken\":{\
          ...
          \"documentation\":\"<p>A token that you provide to identify the request to create an index. Multiple calls to the <code>CreateIndex</code> operation with the same client token will create only one index.â</p>\",\
