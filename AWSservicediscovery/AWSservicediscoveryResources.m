...
@interface AWSservicediscoveryResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSservicediscoveryResources

+ (instancetype)sharedInstance {
    static AWSservicediscoveryResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSservicediscoveryResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"CustomHealthNotFound\":{\
      ...
      \"documentation\":\"<p>The health check for the instance that is specified by <code>ServiceId</code> and <code>InstanceId</code> is not a custom health check. </p>\",\
      \"exception\":true\
    },\
    \"CustomHealthStatus\":{\
      \"type\":\"string\",\
    ...
    \"DuplicateRequest\":{\
      ...
      \"members\":{\
        ...
        \"DuplicateOperationId\":{\
          \"shape\":\"ResourceId\",\
          \"documentation\":\"<p>The ID of the operation that is already in progress.</p>\"\
        }\
      },\
    ...
    \"InvalidInput\":{\
      ...
      \"documentation\":\"<p>One or more specified values aren't valid. For example, a required value might be missing, a numeric value might be outside the allowed range, or a string value might exceed length constraints.</p>\",\
      \"exception\":true\
    },\
