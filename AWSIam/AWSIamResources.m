...
@interface AWSIamResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSIamResources

+ (instancetype)sharedInstance {
    static AWSIamResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSIamResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"ConcurrentModificationException\":{\
      ...
      \"documentation\":\"<p>The request was rejected because multiple requests to change this object were submitted simultaneously. Wait a few minutes and submit your request again.</p>\",\
      \"error\":{\
    ...
    \"EntityDetails\":{\
      ...
      \"members\":{\
        \"EntityInfo\":{\
          \"shape\":\"EntityInfo\",\
          \"documentation\":\"<p>TheÂ <code>EntityInfo</code> object that contains details about the entity (user or role).</p>\"\
        },\
        \"LastAuthenticated\":{\
          \"shape\":\"dateType\",\
    ...
    \"GetAccountSummaryResponse\":{\
      ...
      \"members\":{\
        \"SummaryMap\":{\
          ...
          \"documentation\":\"<p>A set of keyâvalue pairs containing information about IAM entity usage and IAM quotas.</p>\"\
        }\
      },\
    ...
    \"GetOrganizationsAccessReportResponse\":{\
      ...
      \"members\":{\
        ...
        \"JobCreationDate\":{\
          \"shape\":\"dateType\",\
          \"documentation\":\"<p>The date and time, inÂ <a href=\\\"http://www.iso.org/iso/iso8601\\\">ISO 8601 date-time format</a>, when the report job was created.</p>\"\
        },\
        \"JobCompletionDate\":{\
          \"shape\":\"dateType\",\
          \"documentation\":\"<p>The date and time, inÂ <a href=\\\"http://www.iso.org/iso/iso8601\\\">ISO 8601 date-time format</a>, when the generated report job was completed or failed.</p> <p>This field is null if the job is still in progress, as indicated by a job status value of <code>IN_PROGRESS</code>.</p>\"\
        },\
        ...
        \"AccessDetails\":{\
          \"shape\":\"AccessDetails\",\
          \"documentation\":\"<p>AnÂ object that contains details about the most recent attempt to access the service.</p>\"\
        },\
        \"IsTruncated\":{\
          \"shape\":\"booleanType\",\
          \"documentation\":\"<p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>\"\
    ...
    \"GetServiceLastAccessedDetailsResponse\":{\
      ...
      \"members\":{\
        ...
        \"ServicesLastAccessed\":{\
          ...
          \"documentation\":\"<p> AÂ <code>ServiceLastAccessed</code> object that contains details about the most recent attempt to access the service.</p>\"\
        },\
        \"JobCompletionDate\":{\
          \"shape\":\"dateType\",\
          \"documentation\":\"<p>The date and time, inÂ <a href=\\\"http://www.iso.org/iso/iso8601\\\">ISO 8601 date-time format</a>, when the generated report job was completed or failed.</p> <p>This field is null if the job is still in progress, as indicated by a job status value of <code>IN_PROGRESS</code>.</p>\"\
    ...
    \"GetServiceLastAccessedDetailsWithEntitiesResponse\":{\
      ...
      \"members\":{\
        ...
        \"EntityDetailsList\":{\
          ...
          \"documentation\":\"<p>AnÂ <code>EntityDetailsList</code> object that contains details about when an IAM entity (user or role) used group or policy permissions in an attempt to access the specified AWS service.</p>\"\
        },\
        \"IsTruncated\":{\
          \"shape\":\"booleanType\",\
          \"documentation\":\"<p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>\"\
    ...
    \"ListEntitiesForPolicyRequest\":{\
      ...
      \"members\":{\
        ...
        \"PolicyUsageFilter\":{\
          ...
          \"documentation\":\"<p>The policy usage method to use for filtering the results.</p> <p>To list only permissions policies, setÂ <code>PolicyUsageFilter</code>Â toÂ <code>PermissionsPolicy</code>. To list only the policies used to set permissions boundaries, setÂ the value toÂ <code>PermissionsBoundary</code>.</p> <p>This parameter is optional. If it is not included, all policies are returned. </p>\"\
        },\
        \"Marker\":{\
          \"shape\":\"markerType\",\
          \"documentation\":\"<p>Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.</p>\"\
    ...
    \"ListPoliciesGrantingServiceAccessEntry\":{\
      ...
      \"members\":{\
        ...
        \"Policies\":{\
          ...
          \"documentation\":\"<p>TheÂ <code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>\"\
        }\
      },\
    ...
    \"ListPoliciesGrantingServiceAccessResponse\":{\
      ...
      \"members\":{\
        \"PoliciesGrantingServiceAccess\":{\
          ...
          \"documentation\":\"<p>AÂ <code>ListPoliciesGrantingServiceAccess</code> object that contains details about the permissions policies attached to the specified identity (user, group, or role).</p>\"\
        },\
        \"IsTruncated\":{\
          \"shape\":\"booleanType\",\
    ...
    \"NoSuchEntityException\":{\
      ...
      \"documentation\":\"<p>The request was rejected because it referenced a resource entity that does not exist. The error message describes the resource.</p>\",\
      \"error\":{\
        \"code\":\"NoSuchEntity\",\
        \"httpStatusCode\":404,\
        \"senderFault\":true\
    ...
    \"PolicyEvaluationException\":{\
      ...
      \"documentation\":\"<p>The request failed because a provided policy could not be successfully evaluated. An additional detailed message indicates the source of the failure.</p>\",\
      \"error\":{\
    ...
    \"PolicyNotAttachableException\":{\
      ...
      \"documentation\":\"<p>The request failed because AWS service role policies can only be attached to the service-linked role for that service.</p>\",\
      \"error\":{\
    ...
    \"ReportGenerationLimitExceededException\":{\
      ...
      \"documentation\":\"<p>The request failed because the maximum number of concurrent requests for this account are already running.</p>\",\
      \"error\":{\
    ...
    \"ServiceNotSupportedException\":{\
      ...
      \"documentation\":\"<p>The specified service does not support service-specific credentials.</p>\",\
      \"error\":{\
    ...
    \"UnmodifiableEntityException\":{\
      ...
      \"documentation\":\"<p>The request was rejected because only the service that depends on the service-linked role can modify or delete the role on your behalf. The error message includes the name of the service that depends on this service-linked role. You must request the change through that service.</p>\",\
      \"error\":{\
