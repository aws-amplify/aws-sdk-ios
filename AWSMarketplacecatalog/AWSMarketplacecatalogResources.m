...
@interface AWSMarketplacecatalogResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSMarketplacecatalogResources

+ (instancetype)sharedInstance {
    static AWSMarketplacecatalogResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSMarketplacecatalogResources new];
    });
