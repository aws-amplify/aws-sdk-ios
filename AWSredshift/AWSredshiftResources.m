...
@interface AWSredshiftResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSredshiftResources

+ (instancetype)sharedInstance {
    static AWSredshiftResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSredshiftResources new];
    });
