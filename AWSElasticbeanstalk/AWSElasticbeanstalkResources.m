...
@interface AWSElasticbeanstalkResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSElasticbeanstalkResources

+ (instancetype)sharedInstance {
    static AWSElasticbeanstalkResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSElasticbeanstalkResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DescribeAccountAttributes\":{\
      ...
      \"documentation\":\"<p>Returns attributes related to AWS Elastic Beanstalk that are associated with the calling AWS account.</p> <p>The result currently has one set of attributesâresource quotas.</p>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"ApplicationVersionDescription\":{\
      ...
      \"members\":{\
        ...
        \"Status\":{\
          ...
          \"documentation\":\"<p>The processing status of the application version. Reflects the state of the application version during its creation. Many of the values are only applicable if you specified <code>True</code> for the <code>Process</code> parameter of the <code>CreateApplicationVersion</code> action. The following list describes the possible values.</p> <ul> <li> <p> <code>Unprocessed</code> â Application version wasn't pre-processed or validated. Elastic Beanstalk will validate configuration files during deployment of the application version to an environment.</p> </li> <li> <p> <code>Processing</code> â Elastic Beanstalk is currently processing the application version.</p> </li> <li> <p> <code>Building</code> â Application version is currently undergoing an AWS CodeBuild build.</p> </li> <li> <p> <code>Processed</code> â Elastic Beanstalk was successfully pre-processed and validated.</p> </li> <li> <p> <code>Failed</code> â Either the AWS CodeBuild build failed or configuration files didn't pass validation. This application version isn't usable.</p> </li> </ul>\"\
        }\
      },\
    ...
    \"ConfigurationOptionSetting\":{\
      ...
      \"members\":{\
        \"ResourceName\":{\
          \"shape\":\"ResourceName\",\
          \"documentation\":\"<p>A unique resource name for the option setting. Use it for a timeâbased scaling configuration option.</p>\"\
        },\
        \"Namespace\":{\
          \"shape\":\"OptionNamespace\",\
    ...
    \"ElasticBeanstalkServiceException\":{\
      ...
      \"documentation\":\"<p>A generic service exception has occurred.</p>\",\
      \"exception\":true\
    },\
    ...
    \"EnvironmentTier\":{\
      ...
      \"members\":{\
        \"Name\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The name of this environment tier.</p> <p>Valid values:</p> <ul> <li> <p>For <i>Web server tier</i> â <code>WebServer</code> </p> </li> <li> <p>For <i>Worker tier</i> â <code>Worker</code> </p> </li> </ul>\"\
        },\
        \"Type\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The type of this environment tier.</p> <p>Valid values:</p> <ul> <li> <p>For <i>Web server tier</i> â <code>Standard</code> </p> </li> <li> <p>For <i>Worker tier</i> â <code>SQS/HTTP</code> </p> </li> </ul>\"\
        },\
        \"Version\":{\
          \"shape\":\"String\",\
