 ...
 */
@property (nonatomic, strong) AWSDynamoDBCreateGlobalSecondaryIndexAction *create;

/**
 <p>The name of an existing global secondary index to be removed.</p>
 */
@property (nonatomic, strong) AWSDynamoDBDeleteGlobalSecondaryIndexAction *remove;
 ...
 */
@property (nonatomic, strong) NSNumber *streamEnabled;
 ...
 */
@property (nonatomic, strong) NSString *latestStreamArn;

/**
 
 */
@property (nonatomic, strong) NSString *latestStreamLabel;
 ...
 */
@property (nonatomic, strong) NSString *tableArn;
