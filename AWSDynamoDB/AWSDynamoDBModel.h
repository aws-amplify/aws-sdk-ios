 ...
 */
@property (nonatomic, strong) NSArray * _Nullable SS;
 ...
 */
@property (nonatomic, strong) NSDictionary * _Nullable unprocessedKeys;
 ...
 */
@property (nonatomic, strong) NSDictionary * _Nullable unprocessedItems;
 ...
 */
@property (nonatomic, strong) NSArray * _Nullable sizeEstimateRangeGB;
 ...
 */
@property (nonatomic, strong) NSArray * _Nullable tableNames;
