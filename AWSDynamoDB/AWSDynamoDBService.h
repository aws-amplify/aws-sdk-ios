...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSDynamoDBDeleteResourcePolicyOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSDynamoDBErrorDomain` domain and the following error code: `AWSDynamoDBErrorResourceNotFound`, `AWSDynamoDBErrorInternalServer`, `AWSDynamoDBErrorPolicyNotFound`, `AWSDynamoDBErrorResourceInUse`, `AWSDynamoDBErrorLimitExceeded`.
 
 @see AWSDynamoDBDeleteResourcePolicyInput
 @see AWSDynamoDBDeleteResourcePolicyOutput
 */
- (AWSTask<AWSDynamoDBDeleteResourcePolicyOutput *> *)deleteResourcePolicy:(AWSDynamoDBDeleteResourcePolicyInput *)request;
...
/**
 ...
 @see AWSDynamoDBDeleteResourcePolicyOutput
 */
- (void)deleteResourcePolicy:(AWSDynamoDBDeleteResourcePolicyInput *)request completionHandler:(void (^ _Nullable)(AWSDynamoDBDeleteResourcePolicyOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 <p>Describes auto scaling settings across replicas of the global table at once.</p><important><p>For global tables, this operation only applies to global tables using Version 2019.11.21 (Current version).</p></important>
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSDynamoDBGetResourcePolicyOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSDynamoDBErrorDomain` domain and the following error code: `AWSDynamoDBErrorResourceNotFound`, `AWSDynamoDBErrorInternalServer`, `AWSDynamoDBErrorPolicyNotFound`.
 
 @see AWSDynamoDBGetResourcePolicyInput
 @see AWSDynamoDBGetResourcePolicyOutput
 */
- (AWSTask<AWSDynamoDBGetResourcePolicyOutput *> *)getResourcePolicy:(AWSDynamoDBGetResourcePolicyInput *)request;
...
/**
 ...
 @see AWSDynamoDBGetResourcePolicyOutput
 */
- (void)getResourcePolicy:(AWSDynamoDBGetResourcePolicyInput *)request completionHandler:(void (^ _Nullable)(AWSDynamoDBGetResourcePolicyOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSDynamoDBPutResourcePolicyOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSDynamoDBErrorDomain` domain and the following error code: `AWSDynamoDBErrorResourceNotFound`, `AWSDynamoDBErrorInternalServer`, `AWSDynamoDBErrorLimitExceeded`, `AWSDynamoDBErrorPolicyNotFound`, `AWSDynamoDBErrorResourceInUse`.
 
 @see AWSDynamoDBPutResourcePolicyInput
 @see AWSDynamoDBPutResourcePolicyOutput
 */
- (AWSTask<AWSDynamoDBPutResourcePolicyOutput *> *)putResourcePolicy:(AWSDynamoDBPutResourcePolicyInput *)request;
...
/**
 ...
 @see AWSDynamoDBPutResourcePolicyOutput
 */
- (void)putResourcePolicy:(AWSDynamoDBPutResourcePolicyInput *)request completionHandler:(void (^ _Nullable)(AWSDynamoDBPutResourcePolicyOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 <p>Updates auto scaling settings on your global tables at once.</p><important><p>For global tables, this operation only applies to global tables using Version 2019.11.21 (Current version). </p></important>
