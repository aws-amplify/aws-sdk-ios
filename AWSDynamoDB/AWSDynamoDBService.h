...
/**
 <p>This operation allows you to perform batch reads or writes on data stored in DynamoDB, using PartiQL.</p><note><p>The entire batch must consist of either read statements or write statements, you cannot mix both in one batch.</p></note>
