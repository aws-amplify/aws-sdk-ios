      ...
      \"shapes\":{ \
        ...
        \"UpdateItemInput\":{ \
          ...
          \"members\":{ \
            ...
            \"Key\":{ \
              \"shape\":\"Key\", \
              \"documentation\":\"<p>The primary key of the item to be updated. Each element consists of an attribute name and a value for that attribute.</p> <p>For the primary key, you must provide all of the attributes. For example, with a hash type primary key, you only need to provide the hash attribute. For a hash-and-range type primary key, you must provide both the hash attribute and the range attribute.</p>\" \
            }, \
            \"AttributeUpdates\":{ \
