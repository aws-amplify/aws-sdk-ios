...
/**
 ...
 @see AWSSageMakerRuntimeInvokeEndpointWithResponseStreamOutput
 */
- (void)invokeEndpointWithResponseStream:(AWSSageMakerRuntimeInvokeEndpointWithResponseStreamInput *)request completionHandler:(void (^ _Nullable)(AWSSageMakerRuntimeInvokeEndpointWithResponseStreamOutput * _Nullable response, NSError * _Nullable error))completionHandler;
