...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeleteSMSSandboxPhoneNumber\":{\
      ...
      \"documentation\":\"<p>Deletes an AWS account's verified or pending phone number from the SMS sandbox.</p> <p>When you start using Amazon SNS to send SMS messages, your AWS account is in the <i>SMS sandbox</i>. The SMS sandbox provides a safe environment for you to try Amazon SNS features without risking your reputation as an SMS sender. While your account is in the SMS sandbox, you can use all of the features of Amazon SNS. However, you can send SMS messages only to verified destination phone numbers. For more information, including how to move out of the sandbox to send messages without restrictions, see <a href=\\\"https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html\\\">SMS sandbox</a> in the <i>Amazon SNS Developer Guide</i>.</p>\"\
    },\
    \"DeleteTopic\":{\
      \"name\":\"DeleteTopic\",\
      \"http\":{\
    ...
    \"ListSMSSandboxPhoneNumbers\":{\
      ...
      \"documentation\":\"<p>Lists the calling AWS account's current verified and pending destination phone numbers in the SMS sandbox.</p> <p>When you start using Amazon SNS to send SMS messages, your AWS account is in the <i>SMS sandbox</i>. The SMS sandbox provides a safe environment for you to try Amazon SNS features without risking your reputation as an SMS sender. While your account is in the SMS sandbox, you can use all of the features of Amazon SNS. However, you can send SMS messages only to verified destination phone numbers. For more information, including how to move out of the sandbox to send messages without restrictions, see <a href=\\\"https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html\\\">SMS sandbox</a> in the <i>Amazon SNS Developer Guide</i>.</p>\"\
    },\
    \"ListSubscriptions\":{\
  ...
  \"shapes\":{\
    ...
    \"OptedOutException\":{\
      ...
      \"documentation\":\"<p>Indicates that the specified phone number opted out of receiving SMS messages from your AWS account. You can't send SMS messages to phone numbers that opt out.</p>\",\
      \"error\":{\
        \"code\":\"OptedOut\",\
        \"httpStatusCode\":400,\
        \"senderFault\":true\
    ...
    \"SMSSandboxPhoneNumber\":{\
      ...
      \"documentation\":\"<p>A verified or pending destination phone number in the SMS sandbox.</p> <p>When you start using Amazon SNS to send SMS messages, your AWS account is in the <i>SMS sandbox</i>. The SMS sandbox provides a safe environment for you to try Amazon SNS features without risking your reputation as an SMS sender. While your account is in the SMS sandbox, you can use all of the features of Amazon SNS. However, you can send SMS messages only to verified destination phone numbers. For more information, including how to move out of the sandbox to send messages without restrictions, see <a href=\\\"https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html\\\">SMS sandbox</a> in the <i>Amazon SNS Developer Guide</i>.</p>\"\
    },\
