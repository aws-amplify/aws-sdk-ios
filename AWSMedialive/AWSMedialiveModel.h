...
typedef NS_ENUM(NSInteger, AWSMedialiveFeatureActivationsInputPrepareScheduleActions) {
    AWSMedialiveFeatureActivationsInputPrepareScheduleActionsUnknown,
    AWSMedialiveFeatureActivationsInputPrepareScheduleActionsDisabled,
    AWSMedialiveFeatureActivationsInputPrepareScheduleActionsEnabled,
};
...
@class AWSMedialiveFeatureActivations;
...
@class AWSMedialiveInputPrepareScheduleActionSettings;
...
/**
 Feature Activations
 */
@property (nonatomic, strong) AWSMedialiveFeatureActivations * _Nullable featureActivations;
...
/**
 Feature Activations
 */
@interface AWSMedialiveFeatureActivations : AWSModel
 ...
 */
@property (nonatomic, assign) AWSMedialiveFeatureActivationsInputPrepareScheduleActions inputPrepareScheduleActions;
 ...
 */
@interface AWSMedialiveInputPrepareScheduleActionSettings : AWSModel
...
/**
 Action to prepare an input for a future immediate input switch
 */
@property (nonatomic, strong) AWSMedialiveInputPrepareScheduleActionSettings * _Nullable inputPrepareSettings;
