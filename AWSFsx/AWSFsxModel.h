...
typedef NS_ENUM(NSInteger, AWSFsxFilterName) {
    ...
    AWSFsxFilterNameFileSystemType,
};
...
@class AWSFsxDeleteFileSystemLustreConfiguration;
@class AWSFsxDeleteFileSystemLustreResponse;
...
/**
 <p>The number of days to retain automatic backups. Setting this to 0 disables automatic backups. You can retain automatic backups for a maximum of 35 days. The default is 0.</p>
 */
 ...
 */
@interface AWSFsxDeleteFileSystemLustreConfiguration : AWSModel
 ...
 */
@interface AWSFsxDeleteFileSystemLustreResponse : AWSModel
...
/**
 <p>The configuration object for the Amazon FSx for Lustre file system being deleted in the <code>DeleteFileSystem</code> operation.</p>
 */
@property (nonatomic, strong) AWSFsxDeleteFileSystemLustreConfiguration * _Nullable lustreConfiguration;
...
/**
 <p>The response object for the Amazon FSx for Lustre file system being deleted in the <code>DeleteFileSystem</code> operation.</p>
 */
@property (nonatomic, strong) AWSFsxDeleteFileSystemLustreResponse * _Nullable lustreResponse;
