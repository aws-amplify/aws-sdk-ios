...
@implementation AWSFsxDeleteFileSystemLustreConfiguration
...
@implementation AWSFsxDeleteFileSystemLustreResponse
...
+ (NSValueTransformer *)lustreConfigurationJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSFsxDeleteFileSystemLustreConfiguration class]];
}
...
+ (NSValueTransformer *)lustreResponseJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSFsxDeleteFileSystemLustreResponse class]];
}
...
+ (NSValueTransformer *)nameJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"file-system-type"] == NSOrderedSame) {
            return @(AWSFsxFilterNameFileSystemType);
        }
        ...
        switch ([value integerValue]) {
            ...
            case AWSFsxFilterNameBackupType:
                return @"backup-type";
            case AWSFsxFilterNameFileSystemType:
