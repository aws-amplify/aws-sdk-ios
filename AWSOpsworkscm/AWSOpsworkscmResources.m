...
@interface AWSOpsworkscmResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSOpsworkscmResources

+ (instancetype)sharedInstance {
    static AWSOpsworkscmResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSOpsworkscmResources new];
    });
