...
@interface AWSSupportResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSSupportResources

+ (instancetype)sharedInstance {
    static AWSSupportResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSSupportResources new];
    });
