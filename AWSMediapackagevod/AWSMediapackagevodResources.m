...
@interface AWSMediapackagevodResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSMediapackagevodResources

+ (instancetype)sharedInstance {
    static AWSMediapackagevodResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSMediapackagevodResources new];
    });
