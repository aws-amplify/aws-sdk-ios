...
@interface AWSCloudfrontResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSCloudfrontResources

+ (instancetype)sharedInstance {
    static AWSCloudfrontResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSCloudfrontResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"BatchTooLarge\":{\
      ...
      \"documentation\":\"<p>Invalidation batch specified is too large.</p>\",\
    ...
    \"CNAMEAlreadyExists\":{\
      ...
      \"documentation\":\"<p>The CNAME specified is already defined for CloudFront.</p>\",\
    ...
    \"CacheBehavior\":{\
      ...
      \"members\":{\
        ...
        \"TrustedSigners\":{\
          ...
          \"documentation\":\"<p>A complex type that specifies the AWS accounts, if any, that you want to allow to create signed URLs for private content.</p> <p>If you want to require signed URLs in requests for objects in the target origin that match the <code>PathPattern</code> for this cache behavior, specify <code>true</code> for <code>Enabled</code>, and specify the applicable values for <code>Quantity</code> and <code>Items</code>. For more information, see <a href=\\\"https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html\\\">Serving Private Content with Signed URLs and Signed Cookies</a> in the <i>Amazon CloudFront Developer Guide</i>. </p> <p>If you donât want to require signed URLs in requests for objects that match <code>PathPattern</code>, specify <code>false</code> for <code>Enabled</code> and <code>0</code> for <code>Quantity</code>. Omit <code>Items</code>.</p> <p>To add, change, or remove one or more trusted signers, change <code>Enabled</code> to <code>true</code> (if itâs currently <code>false</code>), change <code>Quantity</code> as applicable, and specify all of the trusted signers that you want to include in the updated distribution.</p>\"\
        },\
        \"ViewerProtocolPolicy\":{\
    ...
    \"CloudFrontOriginAccessIdentityInUse\":{\
      ...
      \"documentation\":\"<p>The Origin Access Identity specified is already in use.</p>\",\
      \"error\":{\"httpStatusCode\":409},\
      \"exception\":true\
    },\
    ...
    \"CustomOriginConfig\":{\
      ...
      \"members\":{\
        ...
        \"OriginProtocolPolicy\":{\
          ...
          \"documentation\":\"<p>Specifies the protocol (HTTP or HTTPS) that CloudFront uses to connect to the origin. Valid values are:</p> <ul> <li> <p> <code>http-only</code> â CloudFront always uses HTTP to connect to the origin.</p> </li> <li> <p> <code>match-viewer</code> â CloudFront connects to the origin using the same protocol that the viewer used to connect to CloudFront.</p> </li> <li> <p> <code>https-only</code> â CloudFront always uses HTTPS to connect to the origin.</p> </li> </ul>\"\
        },\
        \"OriginSslProtocols\":{\
    ...
    \"DefaultCacheBehavior\":{\
      ...
      \"documentation\":\"<p>A complex type that describes the default cache behavior if you donât specify a <code>CacheBehavior</code> element or if request URLs donât match any of the values of <code>PathPattern</code> in <code>CacheBehavior</code> elements. You must create exactly one default cache behavior.</p>\"\
    },\
    ...
    \"DistributionConfig\":{\
      ...
      \"members\":{\
        ...
        \"ViewerCertificate\":{\
          ...
          \"documentation\":\"<p>A complex type that determines the distributionâs SSL/TLS configuration for communicating with viewers.</p>\"\
        },\
        \"Restrictions\":{\
          \"shape\":\"Restrictions\",\
    ...
    \"DistributionNotDisabled\":{\
      ...
      \"documentation\":\"<p>The specified CloudFront distribution is not disabled. You must disable the distribution before you can delete it.</p>\",\
      \"error\":{\"httpStatusCode\":409},\
      \"exception\":true\
    },\
    \"DistributionSummary\":{\
    ...
    \"InvalidErrorCode\":{\
      ...
      \"documentation\":\"<p>An invalid error code was specified.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    ...
    \"InvalidGeoRestrictionParameter\":{\
      ...
      \"documentation\":\"<p>The specified geo restriction parameter is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"InvalidHeadersForS3Origin\":{\
      ...
      \"documentation\":\"<p>The headers specified are not valid for an Amazon S3 origin.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    ...
    \"InvalidLocationCode\":{\
      ...
      \"documentation\":\"<p>The location code specified is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"InvalidMinimumProtocolVersion\":{\
      ...
      \"documentation\":\"<p>The minimum protocol version specified is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"InvalidOrigin\":{\
    ...
    \"InvalidOriginKeepaliveTimeout\":{\
      ...
      \"documentation\":\"<p>The keep alive timeout specified for the origin is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"InvalidOriginReadTimeout\":{\
      ...
      \"documentation\":\"<p>The read timeout specified for the origin is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    ...
    \"NoSuchResource\":{\
      ...
      \"documentation\":\"<p>A resource that was specified is not valid.</p>\",\
      \"error\":{\"httpStatusCode\":404},\
      \"exception\":true\
    },\
    ...
    \"Origin\":{\
      ...
      \"members\":{\
        \"Id\":{\
          \"shape\":\"string\",\
          \"documentation\":\"<p>A unique identifier for the origin. This value must be unique within the distribution.</p> <p>Use this value to specify the <code>TargetOriginId</code> in a <a>CacheBehavior</a> or <a>DefaultCacheBehavior</a>.</p>\"\
        },\
        \"DomainName\":{\
          \"shape\":\"string\",\
        ...
        \"ConnectionAttempts\":{\
          \"shape\":\"integer\",\
          \"documentation\":\"<p>The number of times that CloudFront attempts to connect to the origin. The minimum number is 1, the maximum is 3, and the default (if you donât specify otherwise) is 3.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#origin-connection-attempts\\\">Origin Connection Attempts</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>\"\
        },\
        \"ConnectionTimeout\":{\
          \"shape\":\"integer\",\
          \"documentation\":\"<p>The number of seconds that CloudFront waits when trying to establish a connection to the origin. The minimum timeout is 1 second, the maximum is 10 seconds, and the default (if you donât specify otherwise) is 10 seconds.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#origin-connection-timeout\\\">Origin Connection Timeout</a> in the <i>Amazon CloudFront Developer Guide</i>.</p>\"\
        }\
      },\
    ...
    \"StreamingDistributionAlreadyExists\":{\
      ...
      \"documentation\":\"<p>The caller reference you attempted to create the streaming distribution with is associated with another distribution</p>\",\
      \"error\":{\"httpStatusCode\":409},\
      \"exception\":true\
    },\
    \"StreamingDistributionConfig\":{\
    ...
    \"TooManyHeadersInForwardedValues\":{\
      ...
      \"documentation\":\"<p>Your request contains too many headers in forwarded values.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    ...
    \"TooManyOriginCustomHeaders\":{\
      ...
      \"documentation\":\"<p>Your request contains too many origin custom headers.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"TooManyOriginGroupsPerDistribution\":{\
      ...
      \"documentation\":\"<p>Processing your request would cause you to exceed the maximum number of origin groups allowed.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    \"TooManyOrigins\":{\
    ...
    \"TooManyQueryStringParameters\":{\
      ...
      \"documentation\":\"<p>Your request contains too many query string parameters.</p>\",\
      \"error\":{\"httpStatusCode\":400},\
      \"exception\":true\
    },\
    ...
    \"ViewerCertificate\":{\
      ...
      \"members\":{\
        ...
        \"SSLSupportMethod\":{\
          ...
          \"documentation\":\"<p>If the distribution uses <code>Aliases</code> (alternate domain names or CNAMEs), specify which viewers the distribution accepts HTTPS connections from.</p> <ul> <li> <p> <code>sni-only</code> â The distribution accepts HTTPS connections from only viewers that support <a href=\\\"https://en.wikipedia.org/wiki/Server_Name_Indication\\\">server name indication (SNI)</a>. This is recommended. Most browsers and clients released after 2010 support SNI.</p> </li> <li> <p> <code>vip</code> â The distribution accepts HTTPS connections from all viewers including those that donât support SNI. This is not recommended, and results in additional monthly charges from CloudFront.</p> </li> </ul> <p>If the distribution uses the CloudFront domain name such as <code>d111111abcdef8.cloudfront.net</code>, donât set a value for this field.</p>\"\
        },\
        \"MinimumProtocolVersion\":{\
          \"shape\":\"MinimumProtocolVersion\",\
          \"documentation\":\"<p>If the distribution uses <code>Aliases</code> (alternate domain names or CNAMEs), specify the security policy that you want CloudFront to use for HTTPS connections with viewers. The security policy determines two settings:</p> <ul> <li> <p>The minimum SSL/TLS protocol that CloudFront can use to communicate with viewers.</p> </li> <li> <p>The ciphers that CloudFront can use to encrypt the content that it returns to viewers.</p> </li> </ul> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValues-security-policy\\\">Security Policy</a> and <a href=\\\"https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/secure-connections-supported-viewer-protocols-ciphers.html#secure-connections-supported-ciphers\\\">Supported Protocols and Ciphers Between Viewers and CloudFront</a> in the <i>Amazon CloudFront Developer Guide</i>.</p> <note> <p>On the CloudFront console, this setting is called <b>Security Policy</b>.</p> </note> <p>We recommend that you specify <code>TLSv1.2_2018</code> unless your viewers are using browsers or devices that donât support TLSv1.2.</p> <p>When youâre using SNI only (you set <code>SSLSupportMethod</code> to <code>sni-only</code>), you must specify <code>TLSv1</code> or higher. </p> <p>If the distribution uses the CloudFront domain name such as <code>d111111abcdef8.cloudfront.net</code> (you set <code>CloudFrontDefaultCertificate</code> to <code>true</code>), CloudFront automatically sets the security policy to <code>TLSv1</code> regardless of the value that you set here.</p>\"\
        },\
        \"Certificate\":{\
          \"shape\":\"string\",\
