...
@interface AWSwaf-regionalResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSwaf-regionalResources

+ (instancetype)sharedInstance {
    static AWSwaf-regionalResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSwaf-regionalResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"WAFInvalidRegexPatternException\":{\
      ...
      \"documentation\":\"<p>The regular expression (regex) you specified in <code>RegexPatternString</code> is invalid.</p>\",\
      \"exception\":true\
    },\
    \"WAFLimitsExceededException\":{\
      ...
      \"documentation\":\"<p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\\\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\\\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>\",\
      \"exception\":true\
    },\
