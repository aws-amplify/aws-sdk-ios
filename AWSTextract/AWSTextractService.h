...
/**
 ...
 @param request A container for the necessary parameters to execute the GetLendingAnalysis service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSTextractGetLendingAnalysisResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSTextractErrorDomain` domain and the following error code: `AWSTextractErrorInvalidParameter`, `AWSTextractErrorAccessDenied`, `AWSTextractErrorProvisionedThroughputExceeded`, `AWSTextractErrorInvalidJobId`, `AWSTextractErrorInternalServer`, `AWSTextractErrorThrottling`, `AWSTextractErrorInvalidS3Object`, `AWSTextractErrorInvalidKMSKey`.
 
 @see AWSTextractGetLendingAnalysisRequest
 @see AWSTextractGetLendingAnalysisResponse
 */
...
/**
 ...
 @see AWSTextractGetLendingAnalysisResponse
 */
- (void)getLendingAnalysis:(AWSTextractGetLendingAnalysisRequest *)request completionHandler:(void (^ _Nullable)(AWSTextractGetLendingAnalysisResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @param request A container for the necessary parameters to execute the GetLendingAnalysisSummary service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSTextractGetLendingAnalysisSummaryResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSTextractErrorDomain` domain and the following error code: `AWSTextractErrorInvalidParameter`, `AWSTextractErrorAccessDenied`, `AWSTextractErrorProvisionedThroughputExceeded`, `AWSTextractErrorInvalidJobId`, `AWSTextractErrorInternalServer`, `AWSTextractErrorThrottling`, `AWSTextractErrorInvalidS3Object`, `AWSTextractErrorInvalidKMSKey`.
 
 @see AWSTextractGetLendingAnalysisSummaryRequest
 @see AWSTextractGetLendingAnalysisSummaryResponse
 */
...
/**
 ...
 @param request A container for the necessary parameters to execute the StartLendingAnalysis service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSTextractStartLendingAnalysisResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSTextractErrorDomain` domain and the following error code: `AWSTextractErrorInvalidParameter`, `AWSTextractErrorInvalidS3Object`, `AWSTextractErrorInvalidKMSKey`, `AWSTextractErrorUnsupportedDocument`, `AWSTextractErrorDocumentTooLarge`, `AWSTextractErrorBadDocument`, `AWSTextractErrorAccessDenied`, `AWSTextractErrorProvisionedThroughputExceeded`, `AWSTextractErrorInternalServer`, `AWSTextractErrorIdempotentParameterMismatch`, `AWSTextractErrorThrottling`, `AWSTextractErrorLimitExceeded`.
 
 @see AWSTextractStartLendingAnalysisRequest
