...
@interface AWSelasticmapreduceResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSelasticmapreduceResources

+ (instancetype)sharedInstance {
    static AWSelasticmapreduceResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSelasticmapreduceResources new];
    });
