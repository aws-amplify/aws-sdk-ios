...
typedef NS_ENUM(NSInteger, AWSGlueColumnStatisticsType) {
    AWSGlueColumnStatisticsTypeUnknown,
    AWSGlueColumnStatisticsTypeBoolean,
    AWSGlueColumnStatisticsTypeDate,
    AWSGlueColumnStatisticsTypeDecimal,
    AWSGlueColumnStatisticsTypeDouble,
    AWSGlueColumnStatisticsTypeLong,
    AWSGlueColumnStatisticsTypeString,
    AWSGlueColumnStatisticsTypeBinary,
};
...
@class AWSGlueBinaryColumnStatisticsData;
@class AWSGlueBooleanColumnStatisticsData;
...
@class AWSGlueColumn;
@class AWSGlueColumnError;
@class AWSGlueColumnStatistics;
@class AWSGlueColumnStatisticsData;
@class AWSGlueColumnStatisticsError;
...
@class AWSGlueDateColumnStatisticsData;
@class AWSGlueDecimalColumnStatisticsData;
@class AWSGlueDecimalNumber;
@class AWSGlueDeleteClassifierRequest;
@class AWSGlueDeleteClassifierResponse;
@class AWSGlueDeleteColumnStatisticsForPartitionRequest;
@class AWSGlueDeleteColumnStatisticsForPartitionResponse;
@class AWSGlueDeleteColumnStatisticsForTableRequest;
@class AWSGlueDeleteColumnStatisticsForTableResponse;
...
@class AWSGlueDoubleColumnStatisticsData;
...
@class AWSGlueGetColumnStatisticsForPartitionRequest;
@class AWSGlueGetColumnStatisticsForPartitionResponse;
@class AWSGlueGetColumnStatisticsForTableRequest;
@class AWSGlueGetColumnStatisticsForTableResponse;
...
@class AWSGlueLongColumnStatisticsData;
...
@class AWSGlueStringColumnStatisticsData;
@class AWSGlueTable;
...
@class AWSGlueUpdateColumnStatisticsForPartitionRequest;
@class AWSGlueUpdateColumnStatisticsForPartitionResponse;
@class AWSGlueUpdateColumnStatisticsForTableRequest;
@class AWSGlueUpdateColumnStatisticsForTableResponse;
...
/**
 ...
 Required parameters: [MaximumLength, AverageLength, NumberOfNulls]
 */
@interface AWSGlueBinaryColumnStatisticsData : AWSModel


/**
 <p>Average length of the column.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable averageLength;
...
/**
 <p>Number of nulls.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable numberOfNulls;

@end

/**
 <p>Defines a boolean column statistics.</p>
 Required parameters: [NumberOfTrues, NumberOfFalses, NumberOfNulls]
 */
@interface AWSGlueBooleanColumnStatisticsData : AWSModel


/**
 <p>Number of false value.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable numberOfFalses;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable numberOfTrues;
 ...
 */
@interface AWSGlueColumnError : AWSModel
 ...
 */
@property (nonatomic, strong) AWSGlueErrorDetail * _Nullable error;

@end

/**
 <p>Defines a column statistics.</p>
 Required parameters: [ColumnName, ColumnType, AnalyzedTime, StatisticsData]
 */
@interface AWSGlueColumnStatistics : AWSModel


/**
 <p>The analyzed time of the column statistics.</p>
 */
@property (nonatomic, strong) NSDate * _Nullable analyzedTime;
 ...
 */
@property (nonatomic, strong) NSString * _Nullable columnType;

/**
 <p>The statistics of the column.</p>
 */
@property (nonatomic, strong) AWSGlueColumnStatisticsData * _Nullable statisticsData;
 ...
 */
@interface AWSGlueColumnStatisticsData : AWSModel


/**
 <p>Binary Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueBinaryColumnStatisticsData * _Nullable binaryColumnStatisticsData;

/**
 <p>Boolean Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueBooleanColumnStatisticsData * _Nullable booleanColumnStatisticsData;

/**
 <p>Date Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueDateColumnStatisticsData * _Nullable dateColumnStatisticsData;

/**
 <p>Decimal Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueDecimalColumnStatisticsData * _Nullable decimalColumnStatisticsData;

/**
 <p>Double Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueDoubleColumnStatisticsData * _Nullable doubleColumnStatisticsData;

/**
 <p>Long Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueLongColumnStatisticsData * _Nullable longColumnStatisticsData;

/**
 <p>String Column Statistics Data.</p>
 */
@property (nonatomic, strong) AWSGlueStringColumnStatisticsData * _Nullable stringColumnStatisticsData;

/**
 <p>The name of the column.</p>
 */
@property (nonatomic, assign) AWSGlueColumnStatisticsType types;
...
/**
 <p>Defines a column containing error.</p>
 */
@interface AWSGlueColumnStatisticsError : AWSModel


/**
 <p>The ColumnStatistics of the column.</p>
 */
@property (nonatomic, strong) AWSGlueColumnStatistics * _Nullable columnStatistics;
...
/**
 ...
 Required parameters: [NumberOfNulls, NumberOfDistinctValues]
 */
@interface AWSGlueDateColumnStatisticsData : AWSModel


/**
 <p>Maximum value of the column.</p>
 */
@property (nonatomic, strong) NSDate * _Nullable maximumValue;

/**
 <p>Minimum value of the column.</p>
 */
@property (nonatomic, strong) NSDate * _Nullable minimumValue;

/**
 <p>Number of distinct values.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable numberOfDistinctValues;
...
/**
 ...
 Required parameters: [NumberOfNulls, NumberOfDistinctValues]
 */
@interface AWSGlueDecimalColumnStatisticsData : AWSModel


/**
 <p>Maximum value of the column.</p>
 */
@property (nonatomic, strong) AWSGlueDecimalNumber * _Nullable maximumValue;

/**
 <p>Minimum value of the column.</p>
 */
@property (nonatomic, strong) AWSGlueDecimalNumber * _Nullable minimumValue;
...
/**
 ...
 Required parameters: [UnscaledValue, Scale]
 */
@interface AWSGlueDecimalNumber : AWSModel
 ...
 */
@property (nonatomic, strong) NSData * _Nullable unscaledValue;
 ...
 */
@interface AWSGlueDeleteColumnStatisticsForPartitionRequest : AWSRequest
 ...
 */
@interface AWSGlueDeleteColumnStatisticsForPartitionResponse : AWSModel
 ...
 */
@interface AWSGlueDeleteColumnStatisticsForTableRequest : AWSRequest
 ...
 */
@interface AWSGlueDeleteColumnStatisticsForTableResponse : AWSModel
...
/**
 ...
 Required parameters: [NumberOfNulls, NumberOfDistinctValues]
 */
@interface AWSGlueDoubleColumnStatisticsData : AWSModel


/**
 <p>Maximum value of the column.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable maximumValue;

/**
 <p>Minimum value of the column.</p>
 */
@property (nonatomic, strong) NSNumber * _Nullable minimumValue;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable scanAll;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable scanRate;
 ...
 */
@interface AWSGlueGetColumnStatisticsForPartitionRequest : AWSRequest
 ...
 */
@property (nonatomic, strong) NSArray<NSString *> * _Nullable columnNames;
 ...
 */
@interface AWSGlueGetColumnStatisticsForPartitionResponse : AWSModel


/**
 <p>List of ColumnStatistics that failed to be retrieved.</p>
 */
@property (nonatomic, strong) NSArray<AWSGlueColumnStatistics *> * _Nullable columnStatisticsList;

/**
 <p>Error occurred during retrieving column statistics data.</p>
 */
@property (nonatomic, strong) NSArray<AWSGlueColumnError *> * _Nullable errors;
 ...
 */
@interface AWSGlueGetColumnStatisticsForTableRequest : AWSRequest
 ...
 */
@interface AWSGlueGetColumnStatisticsForTableResponse : AWSModel
...
/**
 ...
 Required parameters: [NumberOfNulls, NumberOfDistinctValues]
 */
@interface AWSGlueLongColumnStatisticsData : AWSModel
...
/**
 ...
 Required parameters: [MaximumLength, AverageLength, NumberOfNulls, NumberOfDistinctValues]
 */
@interface AWSGlueStringColumnStatisticsData : AWSModel
 ...
 */
@interface AWSGlueUpdateColumnStatisticsForPartitionRequest : AWSRequest
 ...
 */
@interface AWSGlueUpdateColumnStatisticsForPartitionResponse : AWSModel


/**
 <p>Error occurred during updating column statistics data.</p>
 */
@property (nonatomic, strong) NSArray<AWSGlueColumnStatisticsError *> * _Nullable errors;
 ...
 */
@interface AWSGlueUpdateColumnStatisticsForTableRequest : AWSRequest
 ...
 */
@interface AWSGlueUpdateColumnStatisticsForTableResponse : AWSModel
