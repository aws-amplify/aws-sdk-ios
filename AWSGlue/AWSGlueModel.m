...
@implementation AWSGlueBinaryColumnStatisticsData
...
@implementation AWSGlueBooleanColumnStatisticsData
...
@implementation AWSGlueColumnError
...
@implementation AWSGlueColumnStatistics
...
+ (NSValueTransformer *)analyzedTimeJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^id(NSNumber *number) {
        return [NSDate dateWithTimeIntervalSince1970:[number doubleValue]];
    } reverseBlock:^id(NSDate *date) {
        return [NSString stringWithFormat:@"%f", [date timeIntervalSince1970]];
...
+ (NSValueTransformer *)statisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueColumnStatisticsData class]];
}

@end

@implementation AWSGlueColumnStatisticsData
...
+ (NSValueTransformer *)binaryColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueBinaryColumnStatisticsData class]];
}

+ (NSValueTransformer *)booleanColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueBooleanColumnStatisticsData class]];
}

+ (NSValueTransformer *)dateColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueDateColumnStatisticsData class]];
}

+ (NSValueTransformer *)decimalColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueDecimalColumnStatisticsData class]];
}

+ (NSValueTransformer *)doubleColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueDoubleColumnStatisticsData class]];
}

+ (NSValueTransformer *)longColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueLongColumnStatisticsData class]];
}

+ (NSValueTransformer *)stringColumnStatisticsDataJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueStringColumnStatisticsData class]];
}

+ (NSValueTransformer *)typesJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"BOOLEAN"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeBoolean);
        }
        if ([value caseInsensitiveCompare:@"DATE"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeDate);
        }
        if ([value caseInsensitiveCompare:@"DECIMAL"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeDecimal);
        }
        if ([value caseInsensitiveCompare:@"DOUBLE"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeDouble);
        }
        if ([value caseInsensitiveCompare:@"LONG"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeLong);
        }
        if ([value caseInsensitiveCompare:@"STRING"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeString);
        }
        if ([value caseInsensitiveCompare:@"BINARY"] == NSOrderedSame) {
            return @(AWSGlueColumnStatisticsTypeBinary);
        }
        return @(AWSGlueColumnStatisticsTypeUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSGlueColumnStatisticsTypeBoolean:
                return @"BOOLEAN";
            case AWSGlueColumnStatisticsTypeDate:
                return @"DATE";
            case AWSGlueColumnStatisticsTypeDecimal:
                return @"DECIMAL";
            case AWSGlueColumnStatisticsTypeDouble:
                return @"DOUBLE";
            case AWSGlueColumnStatisticsTypeLong:
                return @"LONG";
            case AWSGlueColumnStatisticsTypeString:
                return @"STRING";
            case AWSGlueColumnStatisticsTypeBinary:
                return @"BINARY";
            default:
                return nil;
        }
...
@implementation AWSGlueColumnStatisticsError
...
+ (NSValueTransformer *)columnStatisticsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueColumnStatistics class]];
}
...
@implementation AWSGlueDateColumnStatisticsData
...
+ (NSValueTransformer *)maximumValueJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^id(NSNumber *number) {
        return [NSDate dateWithTimeIntervalSince1970:[number doubleValue]];
    } reverseBlock:^id(NSDate *date) {
        return [NSString stringWithFormat:@"%f", [date timeIntervalSince1970]];
...
+ (NSValueTransformer *)minimumValueJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^id(NSNumber *number) {
        return [NSDate dateWithTimeIntervalSince1970:[number doubleValue]];
    } reverseBlock:^id(NSDate *date) {
        return [NSString stringWithFormat:@"%f", [date timeIntervalSince1970]];
...
@implementation AWSGlueDecimalColumnStatisticsData
...
+ (NSValueTransformer *)maximumValueJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSGlueDecimalNumber class]];
}
...
@implementation AWSGlueDecimalNumber
...
@implementation AWSGlueDeleteColumnStatisticsForPartitionRequest
...
@implementation AWSGlueDeleteColumnStatisticsForPartitionResponse

@end

@implementation AWSGlueDeleteColumnStatisticsForTableRequest
...
@implementation AWSGlueDeleteColumnStatisticsForTableResponse
...
@implementation AWSGlueDoubleColumnStatisticsData
...
@implementation AWSGlueGetColumnStatisticsForPartitionRequest
...
@implementation AWSGlueGetColumnStatisticsForPartitionResponse
...
+ (NSValueTransformer *)columnStatisticsListJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSGlueColumnStatistics class]];
}

+ (NSValueTransformer *)errorsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSGlueColumnError class]];
}

@end

@implementation AWSGlueGetColumnStatisticsForTableRequest
...
@implementation AWSGlueGetColumnStatisticsForTableResponse
...
@implementation AWSGlueLongColumnStatisticsData
...
@implementation AWSGlueStringColumnStatisticsData
...
@implementation AWSGlueUpdateColumnStatisticsForPartitionRequest
...
@implementation AWSGlueUpdateColumnStatisticsForPartitionResponse
...
+ (NSValueTransformer *)errorsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSGlueColumnStatisticsError class]];
}

@end

@implementation AWSGlueUpdateColumnStatisticsForTableRequest
...
@implementation AWSGlueUpdateColumnStatisticsForTableResponse
