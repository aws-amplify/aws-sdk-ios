...
+ (NSValueTransformer *)itemsJSONTransformer {
	return [NSValueTransformer mtl_JSONArrayTransformerWithModelClass:[AWSSimpleDBDeletableItem class]];
}
...
+ (NSValueTransformer *)itemsJSONTransformer {
	return [NSValueTransformer mtl_JSONArrayTransformerWithModelClass:[AWSSimpleDBReplaceableItem class]];
}
...
+ (NSValueTransformer *)expectedJSONTransformer {
	return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[AWSSimpleDBUpdateCondition class]];
}
...
+ (NSValueTransformer *)attributesJSONTransformer {
	return [NSValueTransformer mtl_JSONArrayTransformerWithModelClass:[AWSSimpleDBReplaceableAttribute class]];
}
...
+ (NSValueTransformer *)itemsJSONTransformer {
	return [NSValueTransformer mtl_JSONArrayTransformerWithModelClass:[AWSSimpleDBItem class]];
}
