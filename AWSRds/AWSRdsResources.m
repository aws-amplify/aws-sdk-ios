...
@interface AWSRdsResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSRdsResources

+ (instancetype)sharedInstance {
    static AWSRdsResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSRdsResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DescribeEventCategories\":{\
      ...
      \"documentation\":\"<p>Displays a list of categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in the <a href=\\\"https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html\\\"> Events</a> topic in the <i>Amazon RDS User Guide.</i> </p>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"CustomAvailabilityZoneAlreadyExistsFault\":{\
      ...
      \"documentation\":\"<p> <code>CustomAvailabilityZoneName</code> is already used by an existing custom Availability Zone.</p>\",\
      \"error\":{\
    ...
    \"CustomAvailabilityZoneQuotaExceededFault\":{\
      ...
      \"documentation\":\"<p>You have exceeded the maximum number of custom Availability Zones.</p>\",\
      \"error\":{\
    ...
    \"DBClusterEndpoint\":{\
      ...
      \"members\":{\
        ...
        \"Status\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The current status of the endpoint. One of: <code>creating</code>, <code>available</code>, <code>deleting</code>, <code>modifying</code>.</p>\"\
        },\
        \"EndpointType\":{\
          \"shape\":\"String\",\
    ...
    \"DBInstanceRoleQuotaExceededFault\":{\
      ...
      \"documentation\":\"<p>You can't associate any more AWS Identity and Access Management (IAM) roles with the DB instance because the quota has been reached.</p>\",\
      \"error\":{\
    ...
    \"DBProxyNotFoundFault\":{\
      ...
      \"documentation\":\"<p>The specified proxy name doesn't correspond to a proxy owned by your AWS accoutn in the specified AWS Region.</p>\",\
      \"error\":{\
    ...
    \"DBProxyQuotaExceededFault\":{\
      ...
      \"documentation\":\"<p>Your AWS account already has the maximum number of proxies in the specified AWS Region.</p>\",\
      \"error\":{\
    ...
    \"DBProxyTargetGroupNotFoundFault\":{\
      ...
      \"documentation\":\"<p>The specified target group isn't available for a proxy owned by your AWS account in the specified AWS Region.</p>\",\
      \"error\":{\
    ...
    \"DBProxyTargetNotFoundFault\":{\
      ...
      \"documentation\":\"<p>The specified RDS DB instance or Aurora DB cluster isn't available for a proxy owned by your AWS account in the specified AWS Region.</p>\",\
      \"error\":{\
    ...
    \"EventCategoriesMap\":{\
      ...
      \"documentation\":\"<p>Contains the results of a successful invocation of the <code>DescribeEventCategories</code> action.</p>\",\
      \"wrapper\":true\
    },\
    ...
    \"InstallationMediaAlreadyExistsFault\":{\
      ...
      \"documentation\":\"<p>The specified installation medium has already been imported.</p>\",\
      \"error\":{\
    ...
    \"InstallationMediaNotFoundFault\":{\
      ...
      \"documentation\":\"<p> <code>InstallationMediaID</code> doesn't refer to an existing installation medium.</p>\",\
      \"error\":{\
