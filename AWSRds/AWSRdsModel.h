...
typedef NS_ENUM(NSInteger, AWSRdsWriteForwardingStatus) {
    AWSRdsWriteForwardingStatusUnknown,
    AWSRdsWriteForwardingStatusEnabled,
    AWSRdsWriteForwardingStatusDisabled,
    AWSRdsWriteForwardingStatusEnabling,
    AWSRdsWriteForwardingStatusDisabling,
};
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable enableGlobalWriteForwarding;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable globalWriteForwardingRequested;
 ...
 */
@property (nonatomic, assign) AWSRdsWriteForwardingStatus globalWriteForwardingStatus;
...
/**
 <p>The name of the DB cluster snapshot attribute to modify.</p><p>To manage authorization for other AWS accounts to copy or restore a manual DB cluster snapshot, set this value to <code>restore</code>.</p><note><p>To view the list of attributes available to modify, use the <a>DescribeDBClusterSnapshotAttributes</a> API action.</p></note>
 */
@property (nonatomic, strong) NSString * _Nullable attributeName;
...
/**
 <p>The name of the DB snapshot attribute to modify.</p><p>To manage authorization for other AWS accounts to copy or restore a manual DB snapshot, set this value to <code>restore</code>.</p><note><p>To view the list of attributes available to modify, use the <a>DescribeDBSnapshotAttributes</a> API action.</p></note>
 */
@property (nonatomic, strong) NSString * _Nullable attributeName;
...
/**
 <p>The version of the database that the backup files were created from.</p><p>MySQL versions 5.5, 5.6, and 5.7 are supported. </p><p>Example: <code>5.6.40</code></p>
 */
