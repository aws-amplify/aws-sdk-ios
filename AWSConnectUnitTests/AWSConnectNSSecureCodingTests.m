...
- (void) test_AWSConnectInstanceReference API_AVAILABLE(ios(11));
...
- (void) test_AWSConnectInstanceReference {
    [self validateSecureCodingForClass:[AWSConnectInstanceReference class]];
}
