...
+ (NSValueTransformer *)filtersJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSCloudformationStackInstanceFilter class]];
}
...
+ (NSValueTransformer *)stackInstanceStatusJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSCloudformationStackInstanceComprehensiveStatus class]];
}
...
@implementation AWSCloudformationStackInstanceComprehensiveStatus
...
+ (NSValueTransformer *)detailedStatusJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"PENDING"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusPending);
        }
        if ([value caseInsensitiveCompare:@"RUNNING"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusRunning);
        }
        if ([value caseInsensitiveCompare:@"SUCCEEDED"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusSucceeded);
        }
        if ([value caseInsensitiveCompare:@"FAILED"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusFailed);
        }
        if ([value caseInsensitiveCompare:@"CANCELLED"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusCancelled);
        }
        if ([value caseInsensitiveCompare:@"INOPERABLE"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceDetailedStatusInoperable);
        }
        return @(AWSCloudformationStackInstanceDetailedStatusUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSCloudformationStackInstanceDetailedStatusPending:
                return @"PENDING";
            case AWSCloudformationStackInstanceDetailedStatusRunning:
                return @"RUNNING";
            case AWSCloudformationStackInstanceDetailedStatusSucceeded:
                return @"SUCCEEDED";
            case AWSCloudformationStackInstanceDetailedStatusFailed:
                return @"FAILED";
            case AWSCloudformationStackInstanceDetailedStatusCancelled:
                return @"CANCELLED";
            case AWSCloudformationStackInstanceDetailedStatusInoperable:
                return @"INOPERABLE";
            default:
                return nil;
        }
...
@implementation AWSCloudformationStackInstanceFilter
...
+ (NSValueTransformer *)nameJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"DETAILED_STATUS"] == NSOrderedSame) {
            return @(AWSCloudformationStackInstanceFilterNameDetailedStatus);
        }
        return @(AWSCloudformationStackInstanceFilterNameUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSCloudformationStackInstanceFilterNameDetailedStatus:
