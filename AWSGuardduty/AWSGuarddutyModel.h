 ...
 */
@interface AWSGuarddutyAccountLevelPermissions : AWSModel


/**
 <p>Describes the S3 Block Public Access settings of the bucket's parent account.</p>
 */
@property (nonatomic, strong) AWSGuarddutyBlockPublicAccess * _Nullable blockPublicAccess;
 ...
 */
@interface AWSGuarddutyBlockPublicAccess : AWSModel
 ...
 */
@interface AWSGuarddutyBucketLevelPermissions : AWSModel


/**
 <p>Contains information on how Access Control Policies are applied to the bucket.</p>
 */
@property (nonatomic, strong) AWSGuarddutyAccessControlList * _Nullable accessControlList;
 ...
 */
@property (nonatomic, strong) AWSGuarddutyBucketPolicy * _Nullable bucketPolicy;
 ...
 */
@interface AWSGuarddutyBucketPolicy : AWSModel
 ...
 */
@interface AWSGuarddutyDefaultServerSideEncryption : AWSModel
 ...
 */
@interface AWSGuarddutyOwner : AWSModel
 ...
 */
@interface AWSGuarddutyPermissionConfiguration : AWSModel


/**
 <p>Contains information about the account level permissions on the S3 bucket.</p>
 */
@property (nonatomic, strong) AWSGuarddutyAccountLevelPermissions * _Nullable accountLevelPermissions;

/**
 <p>Contains information about the bucket level permissions for the S3 bucket.</p>
 */
@property (nonatomic, strong) AWSGuarddutyBucketLevelPermissions * _Nullable bucketLevelPermissions;
 ...
 */
@interface AWSGuarddutyPublicAccess : AWSModel


/**
 <p>Describes the effective permission on this bucket after factoring all attached policies.</p>
 */
@property (nonatomic, strong) NSString * _Nullable effectivePermission;

/**
 <p>Contains information about how permissions are configured for the S3 bucket.</p>
 */
@property (nonatomic, strong) AWSGuarddutyPermissionConfiguration * _Nullable permissionConfiguration;
 ...
 */
@property (nonatomic, strong) NSArray<AWSGuarddutyS3BucketDetail *> * _Nullable s3BucketDetails;
 ...
 */
@interface AWSGuarddutyS3BucketDetail : AWSModel
 ...
 */
@property (nonatomic, strong) AWSGuarddutyDefaultServerSideEncryption * _Nullable defaultServerSideEncryption;
 ...
 */
@property (nonatomic, strong) AWSGuarddutyOwner * _Nullable owner;

/**
 <p>Describes the public access policies that apply to the S3 bucket.</p>
 */
@property (nonatomic, strong) AWSGuarddutyPublicAccess * _Nullable publicAccess;
