...
@interface AWSioteventsResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSioteventsResources

+ (instancetype)sharedInstance {
    static AWSioteventsResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSioteventsResources new];
    });
