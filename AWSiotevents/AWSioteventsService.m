...
+ (void)initialize {
    errorCodeDictionary = @{
                            ...
                            @"TagrisAccessDeniedException" : @(AWSioteventsErrorTagrisAccessDenied),
                            @"TagrisInternalServiceException" : @(AWSioteventsErrorTagrisInternalService),
                            @"TagrisInvalidArnException" : @(AWSioteventsErrorTagrisInvalidArn),
                            @"TagrisInvalidParameterException" : @(AWSioteventsErrorTagrisInvalidParameter),
                            @"TagrisPartialResourcesExistResultsException" : @(AWSioteventsErrorTagrisPartialResourcesExistResults),
                            @"TagrisThrottledException" : @(AWSioteventsErrorTagrisThrottled),
...
- (AWSTask<AWSioteventsTagrisVerifyResourcesExistOutput *> *)verifyResourcesExistForTagris:(AWSioteventsTagrisVerifyResourcesExistInput *)request {
    return [self invokeRequest:request
                    HTTPMethod:AWSHTTPMethodGET
                     URLString:@"/internal/tags/resource-status"
                  targetPrefix:@""
                 operationName:@"VerifyResourcesExistForTagris"
                   outputClass:[AWSioteventsTagrisVerifyResourcesExistOutput class]];
}

- (void)verifyResourcesExistForTagris:(AWSioteventsTagrisVerifyResourcesExistInput *)request
     completionHandler:(void (^)(AWSioteventsTagrisVerifyResourcesExistOutput *response, NSError *error))completionHandler {
    [[self verifyResourcesExistForTagris:request] continueWithBlock:^id _Nullable(AWSTask<AWSioteventsTagrisVerifyResourcesExistOutput *> * _Nonnull task) {
        AWSioteventsTagrisVerifyResourcesExistOutput *result = task.result;
        NSError *error = task.error;
