...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSWorkmailDeleteRetentionPolicyResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSWorkmailErrorDomain` domain and the following error code: `AWSWorkmailErrorInvalidParameter`, `AWSWorkmailErrorOrganizationNotFound`, `AWSWorkmailErrorOrganizationState`.
 
 @see AWSWorkmailDeleteRetentionPolicyRequest
 @see AWSWorkmailDeleteRetentionPolicyResponse
 */
...
/**
 ...
 @see AWSWorkmailDeleteRetentionPolicyResponse
 */
- (void)deleteRetentionPolicy:(AWSWorkmailDeleteRetentionPolicyRequest *)request completionHandler:(void (^ _Nullable)(AWSWorkmailDeleteRetentionPolicyResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @param request A container for the necessary parameters to execute the GetDefaultRetentionPolicy service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSWorkmailGetDefaultRetentionPolicyResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSWorkmailErrorDomain` domain and the following error code: `AWSWorkmailErrorInvalidParameter`, `AWSWorkmailErrorOrganizationNotFound`, `AWSWorkmailErrorOrganizationState`, `AWSWorkmailErrorEntityNotFound`.
 
 @see AWSWorkmailGetDefaultRetentionPolicyRequest
 @see AWSWorkmailGetDefaultRetentionPolicyResponse
 */
...
/**
 ...
 @see AWSWorkmailGetDefaultRetentionPolicyResponse
 */
- (void)getDefaultRetentionPolicy:(AWSWorkmailGetDefaultRetentionPolicyRequest *)request completionHandler:(void (^ _Nullable)(AWSWorkmailGetDefaultRetentionPolicyResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSWorkmailPutRetentionPolicyResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSWorkmailErrorDomain` domain and the following error code: `AWSWorkmailErrorInvalidParameter`, `AWSWorkmailErrorOrganizationNotFound`, `AWSWorkmailErrorOrganizationState`, `AWSWorkmailErrorLimitExceeded`.
 
 @see AWSWorkmailPutRetentionPolicyRequest
 @see AWSWorkmailPutRetentionPolicyResponse
 */
...
/**
 ...
 @see AWSWorkmailPutRetentionPolicyResponse
 */
- (void)putRetentionPolicy:(AWSWorkmailPutRetentionPolicyRequest *)request completionHandler:(void (^ _Nullable)(AWSWorkmailPutRetentionPolicyResponse * _Nullable response, NSError * _Nullable error))completionHandler;
