...
@implementation AWSWorkmailDeleteRetentionPolicyRequest
...
@implementation AWSWorkmailDeleteRetentionPolicyResponse
...
@implementation AWSWorkmailFolderConfiguration
...
+ (NSValueTransformer *)actionJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"NONE"] == NSOrderedSame) {
            return @(AWSWorkmailRetentionActionNone);
        }
        if ([value caseInsensitiveCompare:@"DELETE"] == NSOrderedSame) {
            return @(AWSWorkmailRetentionActionDelete);
        }
        if ([value caseInsensitiveCompare:@"PERMANENTLY_DELETE"] == NSOrderedSame) {
            return @(AWSWorkmailRetentionActionPermanentlyDelete);
        }
        return @(AWSWorkmailRetentionActionUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSWorkmailRetentionActionNone:
                return @"NONE";
            case AWSWorkmailRetentionActionDelete:
                return @"DELETE";
            case AWSWorkmailRetentionActionPermanentlyDelete:
...
+ (NSValueTransformer *)nameJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"INBOX"] == NSOrderedSame) {
            return @(AWSWorkmailFolderNameInbox);
        }
        if ([value caseInsensitiveCompare:@"DELETED_ITEMS"] == NSOrderedSame) {
            return @(AWSWorkmailFolderNameDeletedItems);
        }
        if ([value caseInsensitiveCompare:@"SENT_ITEMS"] == NSOrderedSame) {
            return @(AWSWorkmailFolderNameSentItems);
        }
        if ([value caseInsensitiveCompare:@"DRAFTS"] == NSOrderedSame) {
            return @(AWSWorkmailFolderNameDrafts);
        }
        if ([value caseInsensitiveCompare:@"JUNK_EMAIL"] == NSOrderedSame) {
            return @(AWSWorkmailFolderNameJunkEmail);
        }
        return @(AWSWorkmailFolderNameUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSWorkmailFolderNameInbox:
                return @"INBOX";
            case AWSWorkmailFolderNameDeletedItems:
                return @"DELETED_ITEMS";
            case AWSWorkmailFolderNameSentItems:
                return @"SENT_ITEMS";
            case AWSWorkmailFolderNameDrafts:
                return @"DRAFTS";
            case AWSWorkmailFolderNameJunkEmail:
                return @"JUNK_EMAIL";
            default:
                return nil;
        }
...
@implementation AWSWorkmailGetDefaultRetentionPolicyRequest
...
@implementation AWSWorkmailGetDefaultRetentionPolicyResponse
...
+ (NSValueTransformer *)folderConfigurationsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSWorkmailFolderConfiguration class]];
}
...
@implementation AWSWorkmailPutRetentionPolicyRequest
...
@implementation AWSWorkmailPutRetentionPolicyResponse
