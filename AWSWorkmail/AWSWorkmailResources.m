...
@interface AWSWorkmailResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSWorkmailResources

+ (instancetype)sharedInstance {
    static AWSWorkmailResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSWorkmailResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"DirectoryUnavailableException\":{\
      ...
      \"documentation\":\"<p>The directory on which you are trying to perform operations isn't available.</p>\",\
      \"exception\":true\
    },\
    ...
    \"OrganizationStateException\":{\
      ...
      \"documentation\":\"<p>The organization must have a valid state (Active or Synchronizing) to perform certain operations on the organization or its members.</p>\",\
      \"exception\":true\
    },\
    \"OrganizationSummaries\":{\
      \"type\":\"list\",\
