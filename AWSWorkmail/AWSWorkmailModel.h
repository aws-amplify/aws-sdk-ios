...
typedef NS_ENUM(NSInteger, AWSWorkmailFolderName) {
    AWSWorkmailFolderNameUnknown,
    AWSWorkmailFolderNameInbox,
    AWSWorkmailFolderNameDeletedItems,
    AWSWorkmailFolderNameSentItems,
    AWSWorkmailFolderNameDrafts,
    AWSWorkmailFolderNameJunkEmail,
};
...
typedef NS_ENUM(NSInteger, AWSWorkmailRetentionAction) {
    AWSWorkmailRetentionActionUnknown,
    AWSWorkmailRetentionActionNone,
    AWSWorkmailRetentionActionDelete,
    AWSWorkmailRetentionActionPermanentlyDelete,
};
...
@class AWSWorkmailDeleteRetentionPolicyRequest;
@class AWSWorkmailDeleteRetentionPolicyResponse;
...
@class AWSWorkmailFolderConfiguration;
@class AWSWorkmailGetAccessControlEffectRequest;
@class AWSWorkmailGetAccessControlEffectResponse;
@class AWSWorkmailGetDefaultRetentionPolicyRequest;
@class AWSWorkmailGetDefaultRetentionPolicyResponse;
...
@class AWSWorkmailPutRetentionPolicyRequest;
@class AWSWorkmailPutRetentionPolicyResponse;
 ...
 */
@interface AWSWorkmailDeleteRetentionPolicyRequest : AWSRequest
 ...
 */
@interface AWSWorkmailDeleteRetentionPolicyResponse : AWSModel
 ...
 */
@interface AWSWorkmailFolderConfiguration : AWSModel


/**
 <p>The action to take on the folder contents at the end of the folder configuration period.</p>
 */
@property (nonatomic, assign) AWSWorkmailRetentionAction action;

/**
 <p>The folder name.</p>
 */
@property (nonatomic, assign) AWSWorkmailFolderName name;
 ...
 */
@interface AWSWorkmailGetDefaultRetentionPolicyRequest : AWSRequest
 ...
 */
@interface AWSWorkmailGetDefaultRetentionPolicyResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSWorkmailFolderConfiguration *> * _Nullable folderConfigurations;
 ...
 */
@interface AWSWorkmailPutRetentionPolicyRequest : AWSRequest
 ...
 */
@interface AWSWorkmailPutRetentionPolicyResponse : AWSModel
