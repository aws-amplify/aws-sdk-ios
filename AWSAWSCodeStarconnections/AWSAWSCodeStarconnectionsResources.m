...
@interface AWSAWSCodeStarconnectionsResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSAWSCodeStarconnectionsResources

+ (instancetype)sharedInstance {
    static AWSAWSCodeStarconnectionsResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSAWSCodeStarconnectionsResources new];
    });
