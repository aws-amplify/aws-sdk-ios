Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.39.0'
   s.dependency 'AWSCognitoIdentityProvider', '2.39.0'
   ...
   s.dependency 'AWSCore', '2.39.0'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.39.0'
