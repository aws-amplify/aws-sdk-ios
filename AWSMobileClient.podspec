Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.27.11'
   s.dependency 'AWSCognitoIdentityProvider', '2.27.11'
   ...
   s.dependency 'AWSCore', '2.27.11'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.27.11'
