Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.24.4'
   s.dependency 'AWSCognitoIdentityProvider', '2.24.4'
   ...
   s.dependency 'AWSCore', '2.24.4'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.24.4'
