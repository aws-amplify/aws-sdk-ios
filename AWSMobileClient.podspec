Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.21.1'
   s.dependency 'AWSCognitoIdentityProvider', '2.21.1'
   ...
   s.dependency 'AWSCore', '2.21.1'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.21.1'
