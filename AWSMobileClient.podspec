Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.33.6'
   s.dependency 'AWSCognitoIdentityProvider', '2.33.6'
   ...
   s.dependency 'AWSCore', '2.33.6'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.33.6'
