Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.28.2'
   s.dependency 'AWSCognitoIdentityProvider', '2.28.2'
   ...
   s.dependency 'AWSCore', '2.28.2'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.28.2'
