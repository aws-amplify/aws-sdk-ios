Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.33.8'
   s.dependency 'AWSCognitoIdentityProvider', '2.33.8'
   ...
   s.dependency 'AWSCore', '2.33.8'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.33.8'
