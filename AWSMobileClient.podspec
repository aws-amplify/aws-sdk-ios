Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.23.4'
   s.dependency 'AWSCognitoIdentityProvider', '2.23.4'
   ...
   s.dependency 'AWSCore', '2.23.4'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.23.4'
