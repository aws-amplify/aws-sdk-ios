Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.27.2'
   s.dependency 'AWSCognitoIdentityProvider', '2.27.2'
   ...
   s.dependency 'AWSCore', '2.27.2'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.27.2'

   s.source_files = 'AWSAuthSDK/Sources/AWSMobileClient/*.{h,m}', 'AWSAuthSDK/Sources/AWSMobileClient/Internal/*.{h,m}', 'AWSAuthSDK/Sources/AWSMobileClient/*.swift', 'AWSCognitoAuth/**/*.{h,m,c}', 'AWSAuthSDK/Sources/AWSMobileClient/Internal/*.swift', 'AWSAuthSDK/Sources/AWSMobileClient/Models/*.swift'
