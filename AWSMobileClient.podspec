Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.23.5'
   s.dependency 'AWSCognitoIdentityProvider', '2.23.5'
   ...
   s.dependency 'AWSCore', '2.23.5'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.23.5'
