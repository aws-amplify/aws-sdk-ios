Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.29.1'
   s.dependency 'AWSCognitoIdentityProvider', '2.29.1'
   ...
   s.dependency 'AWSCore', '2.29.1'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.29.1'
