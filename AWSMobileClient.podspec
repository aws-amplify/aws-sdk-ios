Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.30.2'
   s.dependency 'AWSCognitoIdentityProvider', '2.30.2'
   ...
   s.dependency 'AWSCore', '2.30.2'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.30.2'
