Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.26.7'
   s.dependency 'AWSCognitoIdentityProvider', '2.26.7'
   ...
   s.dependency 'AWSCore', '2.26.7'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.26.7'
