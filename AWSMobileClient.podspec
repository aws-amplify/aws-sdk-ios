Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.36.4'
   s.dependency 'AWSCognitoIdentityProvider', '2.36.4'
   ...
   s.dependency 'AWSCore', '2.36.4'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.36.4'
