Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.38.2'
   s.dependency 'AWSCognitoIdentityProvider', '2.38.2'
   ...
   s.dependency 'AWSCore', '2.38.2'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.38.2'
