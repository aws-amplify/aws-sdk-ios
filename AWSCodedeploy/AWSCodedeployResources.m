...
@interface AWSCodedeployResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSCodedeployResources

+ (instancetype)sharedInstance {
    static AWSCodedeployResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSCodedeployResources new];
    });
  ...
  \"shapes\":{\
    ...
    \"CloudFormationTarget\":{\
      ...
      \"members\":{\
        ...
        \"targetId\":{\
          \"shape\":\"TargetId\",\
          \"documentation\":\"<p> The unique ID of a deployment target that has a type ofÂ <code>CloudFormationTarget</code>. </p>\"\
        },\
        \"lastUpdatedAt\":{\
          \"shape\":\"Time\",\
