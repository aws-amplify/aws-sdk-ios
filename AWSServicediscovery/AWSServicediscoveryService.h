...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSServicediscoveryListTagsForResourceResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSServicediscoveryErrorDomain` domain and the following error code: `AWSServicediscoveryErrorResourceNotFound`, `AWSServicediscoveryErrorInvalidInput`.
 
 @see AWSServicediscoveryListTagsForResourceRequest
 @see AWSServicediscoveryListTagsForResourceResponse
 */
...
/**
 ...
 @param completionHandler The completion handler to call when the load request is complete.
                          `response` - A response object, or `nil` if the request failed.
                          `error` - An error object that indicates why the request failed, or `nil` if the request was successful. On failed execution, `error` may contain an `NSError` with `AWSServicediscoveryErrorDomain` domain and the following error code: `AWSServicediscoveryErrorResourceNotFound`, `AWSServicediscoveryErrorInvalidInput`.
 
 @see AWSServicediscoveryListTagsForResourceRequest
 @see AWSServicediscoveryListTagsForResourceResponse
 */
- (void)listTagsForResource:(AWSServicediscoveryListTagsForResourceRequest *)request completionHandler:(void (^ _Nullable)(AWSServicediscoveryListTagsForResourceResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSServicediscoveryTagResourceResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSServicediscoveryErrorDomain` domain and the following error code: `AWSServicediscoveryErrorResourceNotFound`, `AWSServicediscoveryErrorTooManyTags`, `AWSServicediscoveryErrorInvalidInput`.
 
 @see AWSServicediscoveryTagResourceRequest
 @see AWSServicediscoveryTagResourceResponse
 */
...
/**
 ...
 @see AWSServicediscoveryTagResourceResponse
 */
- (void)tagResource:(AWSServicediscoveryTagResourceRequest *)request completionHandler:(void (^ _Nullable)(AWSServicediscoveryTagResourceResponse * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSServicediscoveryUntagResourceResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSServicediscoveryErrorDomain` domain and the following error code: `AWSServicediscoveryErrorResourceNotFound`, `AWSServicediscoveryErrorInvalidInput`.
 
 @see AWSServicediscoveryUntagResourceRequest
 @see AWSServicediscoveryUntagResourceResponse
 */
...
/**
 ...
 @see AWSServicediscoveryUntagResourceResponse
 */
- (void)untagResource:(AWSServicediscoveryUntagResourceRequest *)request completionHandler:(void (^ _Nullable)(AWSServicediscoveryUntagResourceResponse * _Nullable response, NSError * _Nullable error))completionHandler;
