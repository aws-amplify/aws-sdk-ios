 ...
 */
@property (nonatomic, strong) NSNumber *verbose;
 ...
 */
@property (nonatomic, strong) NSString *createdByIamUser;

/**
 <p>The current endpoint of the <code>MLModel</code></p>
 */
@property (nonatomic, strong) AWSMachineLearningRealtimeEndpointInfo *endpointInfo;

/**
 <p>The location of the data file or directory in Amazon Simple Storage Service (Amazon S3).</p>
 */
@property (nonatomic, strong) NSString *inputDataLocationS3;
 ...
 */
@property (nonatomic, strong) NSString *logUri;
 ...
 */
@property (nonatomic, strong) NSNumber *scoreThreshold;

/**
 <p>The time of the most recent edit to the <code>ScoreThreshold</code>. The time is expressed in epoch time.</p>
 */
@property (nonatomic, strong) NSDate *scoreThresholdLastUpdatedAt;
 ...
 */
@property (nonatomic, strong) NSString *trainingDataSourceId;
 ...
 */
@property (nonatomic, strong) NSDictionary *trainingParameters;
 ...
 */
@property (nonatomic, strong) AWSMachineLearningPrediction *prediction;
 ...
 */
@property (nonatomic, strong) NSString *predictedLabel;

/**
 Provides the raw classification score corresponding to each label.
 */
@property (nonatomic, strong) NSDictionary *predictedScores;

/**
 The prediction value for REGRESSION <code>MLModel</code>.
 */
@property (nonatomic, strong) NSNumber *predictedValue;
 ...
 */
@property (nonatomic, strong) NSNumber *peakRequestsPerSecond;
