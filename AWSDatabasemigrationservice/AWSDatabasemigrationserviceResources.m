...
@interface AWSDatabasemigrationserviceResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSDatabasemigrationserviceResources

+ (instancetype)sharedInstance {
    static AWSDatabasemigrationserviceResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSDatabasemigrationserviceResources new];
    });
  ...
  \"shapes\":{\
    ...
    \"ReplicationTask\":{\
      ...
      \"members\":{\
        ...
        \"StopReason\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The reason the replication task was stopped. This response parameter can return one of the following values:</p> <ul> <li> <p> <code>\\\"STOP_REASON_FULL_LOAD_COMPLETED\\\"</code> â Full-load migration completed.</p> </li> <li> <p> <code>\\\"STOP_REASON_CACHED_CHANGES_APPLIED\\\"</code> â Change data capture (CDC) load completed.</p> </li> <li> <p> <code>\\\"STOP_REASON_CACHED_CHANGES_NOT_APPLIED\\\"</code> â In a full-load and CDC migration, the full-load stopped as specified before starting the CDC migration.</p> </li> <li> <p> <code>\\\"STOP_REASON_SERVER_TIME\\\"</code> â The migration stopped at the specified server time.</p> </li> </ul>\"\
        },\
