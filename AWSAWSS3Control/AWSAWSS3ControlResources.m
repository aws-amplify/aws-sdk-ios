...
@interface AWSAWSS3ControlResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSAWSS3ControlResources

+ (instancetype)sharedInstance {
    static AWSAWSS3ControlResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSAWSS3ControlResources new];
    });
