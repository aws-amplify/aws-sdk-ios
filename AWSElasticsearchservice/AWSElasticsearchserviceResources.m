...
@interface AWSElasticsearchserviceResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSElasticsearchserviceResources

+ (instancetype)sharedInstance {
    static AWSElasticsearchserviceResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSElasticsearchserviceResources new];
    });
