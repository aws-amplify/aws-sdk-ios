...
@interface AWSAWSSupportResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSAWSSupportResources

+ (instancetype)sharedInstance {
    static AWSAWSSupportResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSAWSSupportResources new];
    });
