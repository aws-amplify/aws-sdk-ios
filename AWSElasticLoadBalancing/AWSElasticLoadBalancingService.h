...
/**
 <p>Describes the provisioned capacity of the specified load balancer.</p>
 
 @param request A container for the necessary parameters to execute the DescribeProvisionedCapacity service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSElasticLoadBalancingDescribeProvisionedCapacityOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSElasticLoadBalancingErrorDomain` domain and the following error code: `AWSElasticLoadBalancingErrorAccessPointNotFound`.
 
 @see AWSElasticLoadBalancingDescribeProvisionedCapacityInput
 @see AWSElasticLoadBalancingDescribeProvisionedCapacityOutput
 */
...
/**
 ...
 @see AWSElasticLoadBalancingDescribeProvisionedCapacityOutput
 */
- (void)describeProvisionedCapacity:(AWSElasticLoadBalancingDescribeProvisionedCapacityInput *)request completionHandler:(void (^ _Nullable)(AWSElasticLoadBalancingDescribeProvisionedCapacityOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 <p>Modifies the provisioned capacity of the specified load balancer.</p><p>There is a limit on the number of times that you can decrease the provisioned capacity of your load balancer in a day. To view the remaining number of times that you can decrease the provisioned capacity, call <a>DescribeProvisionedCapacity</a>.</p><p>For more information, see <a href="http://docs.aws.amazon.com/ElasticLoadBalancing/latest/DeveloperGuide/elb-provisioned-capacity.html">Configure Provisioned Capacity</a> in the <i>Elastic Load Balancing Developer Guide</i></p>
 
 @param request A container for the necessary parameters to execute the ModifyProvisionedCapacity service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSElasticLoadBalancingModifyProvisionedCapacityOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSElasticLoadBalancingErrorDomain` domain and the following error code: `AWSElasticLoadBalancingErrorAccessPointNotFound`, `AWSElasticLoadBalancingErrorInvalidConfigurationRequest`, `AWSElasticLoadBalancingErrorMinimumLBCapacityUnitsDecreaseThrottling`, `AWSElasticLoadBalancingErrorMinimumLBCapacityUnitsLimitExceeded`, `AWSElasticLoadBalancingErrorInsufficientCapacity`.
 
 @see AWSElasticLoadBalancingModifyProvisionedCapacityInput
 @see AWSElasticLoadBalancingModifyProvisionedCapacityOutput
 */
...
/**
 ...
 @see AWSElasticLoadBalancingModifyProvisionedCapacityOutput
 */
- (void)modifyProvisionedCapacity:(AWSElasticLoadBalancingModifyProvisionedCapacityInput *)request completionHandler:(void (^ _Nullable)(AWSElasticLoadBalancingModifyProvisionedCapacityOutput * _Nullable response, NSError * _Nullable error))completionHandler;
