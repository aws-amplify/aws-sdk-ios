...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"ModifyTargetGroup\":{\
      ...
      \"documentation\":\"<p>Modifies the health checks used when evaluating the health state of the targets in the specified target group.</p> <p>If the protocol of the target group is TCP, TLS, UDP, or TCP_UDP, you can't modify the health check protocol, interval, timeout, or success codes.</p>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"ModifyTargetGroupInput\":{\
      ...
      \"members\":{\
        ...
        \"HealthCheckIntervalSeconds\":{\
          \"shape\":\"HealthCheckIntervalSeconds\",\
          \"documentation\":\"<p>The approximate amount of time, in seconds, between health checks of an individual target. For TCP health checks, the supported values are 10 or 30 seconds.</p>\"\
        },\
        \"HealthCheckTimeoutSeconds\":{\
          \"shape\":\"HealthCheckTimeoutSeconds\",\
