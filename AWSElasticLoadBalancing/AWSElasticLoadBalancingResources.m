  ...
  \"shapes\":{\
    ...
    \"CreateListenerInput\":{\
      ...
      \"members\":{\
        ...
        \"Protocol\":{\
          \"shape\":\"ProtocolEnum\",\
          \"documentation\":\"<p>The protocol for connections from clients to the load balancer. For Application Load Balancers, the supported protocols are HTTP and HTTPS. For Network Load Balancers, the supported protocols are TCP, TLS, UDP, and TCP_UDP. You cannot specify a protocol for a Gateway Load Balancer.</p>\"\
        },\
        \"Port\":{\
          \"shape\":\"Port\",\
    ...
    \"ModifyListenerInput\":{\
      ...
      \"members\":{\
        ...
        \"Protocol\":{\
          \"shape\":\"ProtocolEnum\",\
          \"documentation\":\"<p>The protocol for connections from clients to the load balancer. Application Load Balancers support the HTTP and HTTPS protocols. Network Load Balancers support the TCP, TLS, UDP, and TCP_UDP protocols. You cannot specify a protocol for a Gateway Load Balancer.</p>\"\
        },\
        \"SslPolicy\":{\
          \"shape\":\"SslPolicyName\",\
          \"documentation\":\"<p>[HTTPS and TLS listeners] The security policy that defines which protocols and ciphers are supported.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/elasticloadbalancing/latest/application/create-https-listener.html#describe-ssl-policies\\\">Security policies</a> in the <i>Application Load Balancers Guide</i> or <a href=\\\"https://docs.aws.amazon.com/elasticloadbalancing/latest/network/create-tls-listener.html#describe-ssl-policies\\\">Security policies</a> in the <i>Network Load Balancers Guide</i>.</p>\"\
