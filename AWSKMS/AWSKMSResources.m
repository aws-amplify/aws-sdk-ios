  ...
  \"shapes\":{\
    ...
    \"DeriveSharedSecretRequest\":{\
      ...
      \"members\":{\
        ...
        \"KeyAgreementAlgorithm\":{\
          ...
          \"documentation\":\"<p>Specifies the key agreement algorithm used to derive the shared secret. The only valid value is <code>ECDH</code>.</p>\"\
        },\
        \"PublicKey\":{\
          \"shape\":\"PublicKeyType\",\
    ...
    \"DeriveSharedSecretResponse\":{\
      ...
      \"members\":{\
        \"KeyId\":{\
          \"shape\":\"KeyIdType\",\
          \"documentation\":\"<p>Identifies the KMS key used to derive the shared secret.</p>\"\
        },\
        \"SharedSecret\":{\
          \"shape\":\"PlaintextType\",\
          \"documentation\":\"<p>The raw secret derived from the specified key agreement algorithm, private key in the asymmetric KMS key, and your peer's public key.</p> <p>If the response includes the <code>CiphertextForRecipient</code> field, the <code>SharedSecret</code> field is null or empty.</p>\"\
        },\
        \"CiphertextForRecipient\":{\
          \"shape\":\"CiphertextType\",\
    ...
    \"GetPublicKeyResponse\":{\
      ...
      \"members\":{\
        ...
        \"KeyAgreementAlgorithms\":{\
          \"shape\":\"KeyAgreementAlgorithmSpecList\",\
          \"documentation\":\"<p>The key agreement algorithm used to derive a shared secret. This field is present only when the KMS key has a <code>KeyUsage</code> value of <code>KEY_AGREEMENT</code>.</p>\"\
        }\
      }\
    },\
    \"GrantConstraints\":{\
    ...
    \"KeyMetadata\":{\
      ...
      \"members\":{\
        ...
        \"KeyAgreementAlgorithms\":{\
          \"shape\":\"KeyAgreementAlgorithmSpecList\",\
          \"documentation\":\"<p>The key agreement algorithm used to derive a shared secret.</p>\"\
        },\
        \"MultiRegion\":{\
          \"shape\":\"NullableBooleanType\",\
