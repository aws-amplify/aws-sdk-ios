...
typedef NS_ENUM(NSInteger, AWSFirehoseErrorType) {
    ...
    AWSFirehoseErrorInvalidStreamType,
    ...
    AWSFirehoseErrorTagrisAccessDenied,
    AWSFirehoseErrorTagrisInternalService,
    AWSFirehoseErrorTagrisInvalidArn,
    AWSFirehoseErrorTagrisInvalidParameter,
    AWSFirehoseErrorTagrisPartialResourcesExistResults,
...
typedef NS_ENUM(NSInteger, AWSFirehoseTagrisStatus) {
    AWSFirehoseTagrisStatusUnknown,
    AWSFirehoseTagrisStatusActive,
    AWSFirehoseTagrisStatusNotActive,
};
...
@class AWSFirehoseGetKinesisStreamInput;
@class AWSFirehoseGetKinesisStreamOutput;
...
@class AWSFirehoseSessionCredentials;
...
@class AWSFirehoseTagrisSweepListItem;
@class AWSFirehoseTagrisVerifyResourcesExistInput;
@class AWSFirehoseTagrisVerifyResourcesExistOutput;
 ...
 */
@interface AWSFirehoseGetKinesisStreamInput : AWSRequest
 ...
 */
@interface AWSFirehoseGetKinesisStreamOutput : AWSModel


/**
 
 */
@property (nonatomic, strong) AWSFirehoseSessionCredentials * _Nullable credentialsForReadingKinesisStream;
 ...
 */
@interface AWSFirehoseSessionCredentials : AWSModel
 ...
 */
@interface AWSFirehoseTagrisSweepListItem : AWSModel
 ...
 */
@interface AWSFirehoseTagrisVerifyResourcesExistInput : AWSRequest


/**
 
 */
@property (nonatomic, strong) NSArray<AWSFirehoseTagrisSweepListItem *> * _Nullable tagrisSweepList;
 ...
 */
@interface AWSFirehoseTagrisVerifyResourcesExistOutput : AWSModel
