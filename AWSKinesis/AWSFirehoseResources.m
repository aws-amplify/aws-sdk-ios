  ...
  \"shapes\":{\
    ...
    \"AmazonopensearchserviceDestinationUpdate\":{\
      ...
      \"members\":{\
        ...
        \"TypeName\":{\
          \"shape\":\"AmazonopensearchserviceTypeName\",\
          \"documentation\":\"<p>The Amazon OpenSearch Service type name. For Elasticsearch 6.x, there can be only one type per index. If you try to specify a new type for an existing index that already has another type, Firehose returns an error during runtime. </p> <p>If you upgrade Elasticsearch from 6.x to 7.x and donât update your delivery stream, Firehose still delivers data to Elasticsearch with the old index name and type name. If you want to update your delivery stream with a new index name, provide an empty string for TypeName. </p>\"\
        },\
        \"IndexRotationPeriod\":{\
          \"shape\":\"AmazonopensearchserviceIndexRotationPeriod\",\
    ...
    \"ElasticsearchDestinationUpdate\":{\
      ...
      \"members\":{\
        ...
        \"TypeName\":{\
          \"shape\":\"ElasticsearchTypeName\",\
          \"documentation\":\"<p>The Elasticsearch type name. For Elasticsearch 6.x, there can be only one type per index. If you try to specify a new type for an existing index that already has another type, Firehose returns an error during runtime.</p> <p>If you upgrade Elasticsearch from 6.x to 7.x and donât update your delivery stream, Firehose still delivers data to Elasticsearch with the old index name and type name. If you want to update your delivery stream with a new index name, provide an empty string for <code>TypeName</code>. </p>\"\
        },\
        \"IndexRotationPeriod\":{\
          \"shape\":\"ElasticsearchIndexRotationPeriod\",\
    ...
    \"HttpEndpointDestinationConfiguration\":{\
      ...
      \"members\":{\
        ...
        \"RequestConfiguration\":{\
          ...
          \"documentation\":\"<p>The configuration of the request sent to the HTTP endpoint that is specified as the destination.</p>\"\
        },\
        \"ProcessingConfiguration\":{\"shape\":\"ProcessingConfiguration\"},\
        \"RoleARN\":{\
          \"shape\":\"RoleARN\",\
        ...
        \"SecretsManagerConfiguration\":{\
          ...
          \"documentation\":\"<p> The configuration that defines how you access secrets for HTTP Endpoint destination. </p>\"\
        }\
      },\
    ...
    \"ParquetSerDe\":{\
      ...
      \"documentation\":\"<p>A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see <a href=\\\"https://parquet.apache.org/docs/\\\">Apache Parquet</a>.</p>\"\
    },\
    ...
    \"Processor\":{\
      ...
      \"documentation\":\"<p>Describes a data processor.</p> <note> <p>If you want to add a new line delimiter between records in objects that are delivered to Amazon S3, choose <code>AppendDelimiterToRecord</code> as a processor type. You donât have to put a processor parameter when you select <code>AppendDelimiterToRecord</code>. </p> </note>\"\
    },\
    \"ProcessorList\":{\
      \"type\":\"list\",\
    ...
    \"RedshiftDestinationConfiguration\":{\
      ...
      \"members\":{\
        ...
        \"SecretsManagerConfiguration\":{\
          \"shape\":\"SecretsManagerConfiguration\",\
          \"documentation\":\"<p> The configuration that defines how you access secrets for Amazon Redshift. </p>\"\
        }\
      },\
    ...
    \"SecretsManagerConfiguration\":{\
      ...
      \"members\":{\
        \"SecretARN\":{\
          \"shape\":\"SecretARN\",\
          \"documentation\":\"<p>The ARN of the secret that stores your credentials. It must be in the same region as the Firehose stream and the role. The secret ARN can reside in a different account than the delivery stream and role as Firehose supports cross-account secret access. This parameter is required when <b>Enabled</b> is set to <code>True</code>.</p>\"\
        },\
        \"RoleARN\":{\
          \"shape\":\"RoleARN\",\
          \"documentation\":\"<p> Specifies the role that Firehose assumes when calling the Secrets Manager API operation. When you provide the role, it overrides any destination specific role defined in the destination configuration. If you do not provide the then we use the destination specific role. This parameter is required for Splunk. </p>\"\
        },\
        \"Enabled\":{\
          \"shape\":\"BooleanObject\",\
      ...
      \"documentation\":\"<p>The structure that defines how Firehose accesses the secret.</p>\"\
    },\
    \"SecurityGroupIdList\":{\
      \"type\":\"list\",\
      \"member\":{\"shape\":\"NonEmptyStringWithoutWhitespace\"},\
    ...
    \"SplunkDestinationConfiguration\":{\
      ...
      \"members\":{\
        ...
        \"SecretsManagerConfiguration\":{\
          \"shape\":\"SecretsManagerConfiguration\",\
          \"documentation\":\"<p> The configuration that defines how you access secrets for Splunk. </p>\"\
        }\
      },\
