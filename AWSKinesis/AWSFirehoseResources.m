    ...
    \"ExtendedS3DestinationConfiguration\":{\
      ...
      \"members\":{\
        ...
        \"ErrorOutputPrefix\":{\
          ...
          \"documentation\":\"<p>A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. </p>\"\
        },\
        \"BufferingHints\":{\
