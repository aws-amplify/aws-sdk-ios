...
/**
 <fullname>Amazon Data Firehose</fullname><p>Amazon Data Firehose is a fully managed service that delivers real-time streaming data to destinations such as Amazon Simple Storage Service (Amazon S3), Amazon OpenSearch Service, Amazon Redshift, Splunk, and various other supportd destinations.</p>
 */
...
/**
 ...
 @param request A container for the necessary parameters to execute the GetKinesisStream service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSFirehoseGetKinesisStreamOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSFirehoseErrorDomain` domain and the following error code: `AWSFirehoseErrorResourceNotFound`, `AWSFirehoseErrorInvalidArgument`, `AWSFirehoseErrorInvalidStreamType`, `AWSFirehoseErrorInvalidKMSResource`.
 
 @see AWSFirehoseGetKinesisStreamInput
 @see AWSFirehoseGetKinesisStreamOutput
 */
...
/**
 ...
 @see AWSFirehoseGetKinesisStreamOutput
 */
- (void)getKinesisStream:(AWSFirehoseGetKinesisStreamInput *)request completionHandler:(void (^ _Nullable)(AWSFirehoseGetKinesisStreamOutput * _Nullable response, NSError * _Nullable error))completionHandler;
...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSFirehoseTagrisVerifyResourcesExistOutput`. On failed execution, `task.error` may contain an `NSError` with `AWSFirehoseErrorDomain` domain and the following error code: `AWSFirehoseErrorTagrisAccessDenied`, `AWSFirehoseErrorTagrisInternalService`, `AWSFirehoseErrorTagrisInvalidArn`, `AWSFirehoseErrorTagrisInvalidParameter`, `AWSFirehoseErrorTagrisPartialResourcesExistResults`, `AWSFirehoseErrorTagrisThrottled`.
 
 @see AWSFirehoseTagrisVerifyResourcesExistInput
 @see AWSFirehoseTagrisVerifyResourcesExistOutput
 */
...
/**
 ...
 @see AWSFirehoseTagrisVerifyResourcesExistOutput
 */
- (void)verifyResourcesExistForTagris:(AWSFirehoseTagrisVerifyResourcesExistInput *)request completionHandler:(void (^ _Nullable)(AWSFirehoseTagrisVerifyResourcesExistOutput * _Nullable response, NSError * _Nullable error))completionHandler;
