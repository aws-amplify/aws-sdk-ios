...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeleteLanguageModel\":{\
      ...
      \"documentation\":\"<p>Deletes a custom language model. To use this operation, specify the name of the language model you want to delete using <code>ModelName</code>. Language model names are case sensitive.</p>\"\
    },\
    ...
    \"DeleteMedicalVocabulary\":{\
      ...
      \"documentation\":\"<p>Deletes a custom medical vocabulary. To use this operation, specify the name of the vocabulary you want to delete using <code>VocabularyName</code>. Vocabulary names are case sensitive.</p>\"\
    },\
    ...
    \"DeleteVocabulary\":{\
      ...
      \"documentation\":\"<p>Deletes a custom vocabulary. To use this operation, specify the name of the vocabulary you want to delete using <code>VocabularyName</code>. Vocabulary names are case sensitive.</p>\"\
    },\
    \"DeleteVocabularyFilter\":{\
      ...
      \"documentation\":\"<p>Deletes a vocabulary filter. To use this operation, specify the name of the vocabulary filter you want to delete using <code>VocabularyFilterName</code>. Vocabulary filter names are case sensitive.</p>\"\
    },\
    ...
    \"GetMedicalTranscriptionJob\":{\
      ...
      \"documentation\":\"<p>Provides information about the specified medical transcription job.</p> <p>To view the status of the specified medical transcription job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in <code>TranscriptFileUri</code>. If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your transcription job failed.</p> <p>To get a list of your medical transcription jobs, use the operation.</p>\"\
    },\
    ...
    \"GetTranscriptionJob\":{\
      ...
      \"documentation\":\"<p>Provides information about the specified transcription job.</p> <p>To view the status of the specified transcription job, check the <code>TranscriptionJobStatus</code> field. If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in <code>TranscriptFileUri</code>. If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your transcription job failed.</p> <p>If you enabled content redaction, the redacted transcript can be found at the location specified in <code>RedactedTranscriptFileUri</code>.</p> <p>To get a list of your transcription jobs, use the operation.</p>\"\
    },\
    \"GetVocabulary\":{\
      \"name\":\"GetVocabulary\",\
      \"http\":{\
      ...
      \"documentation\":\"<p>Provides information about the specified custom vocabulary.</p> <p>To view the status of the specified vocabulary, check the <code>VocabularyState</code> field. If the status is <code>READY</code>, your vocabulary is available to use. If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your vocabulary failed.</p> <p>To get a list of your custom vocabularies, use the operation.</p>\"\
    },\
    \"GetVocabularyFilter\":{\
      ...
      \"documentation\":\"<p>Provides information about the specified custom vocabulary filter.</p> <p>To view the status of the specified vocabulary filter, check the <code>VocabularyState</code> field. If the status is <code>READY</code>, your vocabulary is available to use. If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your vocabulary filter failed.</p> <p>To get a list of your custom vocabulary filters, use the operation.</p>\"\
    },\
    ...
    \"ListLanguageModels\":{\
      ...
      \"documentation\":\"<p>Provides a list of custom language models that match the specified criteria. If no criteria are specified, all language models are returned.</p> <p>To get detailed information about a specific custom language model, use the operation.</p>\"\
    },\
    ...
    \"UpdateMedicalVocabulary\":{\
      ...
      \"documentation\":\"<p>Updates an existing custom medical vocabulary with new values. This operation overwrites all existing information with your new values; you cannot append new terms onto an existing vocabulary.</p>\"\
    },\
    \"UpdateVocabulary\":{\
      ...
      \"documentation\":\"<p>Updates an existing custom vocabulary with new values. This operation overwrites all existing information with your new values; you cannot append new terms onto an existing vocabulary.</p>\"\
    },\
    \"UpdateVocabularyFilter\":{\
      ...
      \"documentation\":\"<p>Updates an existing custom vocabulary filter with a new list of words. The new list you provide overwrites all previous entries; you cannot append new terms onto an existing vocabulary filter.</p>\"\
    }\
  },\
  \"shapes\":{\
    \"AbsoluteTimeRange\":{\
      ...
      \"members\":{\
        ...
        \"First\":{\
          \"shape\":\"TimestampMilliseconds\",\
          \"documentation\":\"<p>The time, in milliseconds, from the start of your media file until the value you specify in which Amazon Transcribe searches for your specified criteria.</p>\"\
        },\
        \"Last\":{\
          \"shape\":\"TimestampMilliseconds\",\
          \"documentation\":\"<p>The time, in milliseconds, from the value you specify until the end of your media file in which Amazon Transcribe searches for your specified criteria.</p>\"\
        }\
      },\
    ...
    \"CallAnalyticsJob\":{\
      ...
      \"members\":{\
        ...
        \"Settings\":{\
          ...
          \"documentation\":\"<p>Allows additional optional settings in your request, including content redaction; allows you to apply custom language models, vocabulary filters, and custom vocabularies to your Call Analytics job.</p>\"\
        },\
        \"ChannelDefinitions\":{\
          \"shape\":\"ChannelDefinitions\",\
          \"documentation\":\"<p>Allows you to specify which speaker is on which channel in your Call Analytics job request. For example, if your agent is the first participant to speak, you would set <code>ChannelId</code> to <code>0</code> (to indicate the first channel) and <code>ParticipantRole</code> to <code>AGENT</code> (to indicate that it's the agent speaking).</p>\"\
        }\
      },\
    ...
    \"CallAnalyticsJobSettings\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          ...
          \"documentation\":\"<p>The name of the custom vocabulary you want to include in your Call Analytics transcription request. Vocabulary names are case sensitive.</p>\"\
        },\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the custom vocabulary filter you want to include in your Call Analytics transcription request. Vocabulary filter names are case sensitive.</p> <p>Note that if you include <code>VocabularyFilterName</code> in your request, you must also include <code>VocabularyFilterMethod</code>.</p>\"\
        },\
    ...
    \"ChannelDefinition\":{\
      ...
      \"documentation\":\"<p>Allows you to specify which speaker is on which channel. For example, if your agent is the first participant to speak, you would set <code>ChannelId</code> to <code>0</code> (to indicate the first channel) and <code>ParticipantRole</code> to <code>AGENT</code> (to indicate that it's the agent speaking).</p>\"\
    },\
    \"ChannelDefinitions\":{\
      \"type\":\"list\",\
    ...
    \"ContentRedaction\":{\
      ...
      \"documentation\":\"<p>Allows you to redact or flag specified personally identifiable information (PII) in your transcript. If you use <code>ContentRedaction</code>, you must also include the sub-parameters: <code>PiiEntityTypes</code>, <code>RedactionOutput</code>, and <code>RedactionType</code>.</p>\"\
    },\
    \"CreateCallAnalyticsCategoryRequest\":{\
      ...
      \"members\":{\
        ...
        \"Rules\":{\
          \"shape\":\"RuleList\",\
          \"documentation\":\"<p>Rules define a Call Analytics category. When creating a new Call Analytics category, you must create between 1 and 20 rules for that category. For each rule, you specify a filter you want applied to the attributes of a call. For example, you can choose a sentiment filter that detects if a customer's sentiment was positive during the last 30 seconds of the call.</p>\"\
        }\
      }\
    },\
    ...
    \"CreateMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>A unique name, chosen by you, for your new custom medical vocabulary.</p> <p>This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account. If you try to create a new medical vocabulary with the same name as an existing medical vocabulary, you get a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
        ...
        \"Tags\":{\
          \"shape\":\"TagList\",\
          \"documentation\":\"<p>Adds one or more custom tags, each in the form of a key:value pair, to a new medical vocabulary at the time you create this new vocabulary.</p> <p>To learn more about using tags with Amazon Transcribe, refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html\\\">Tagging resources</a>.</p>\"\
        }\
      }\
    },\
    \"CreateMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code you selected for your medical vocabulary. US English (<code>en-US</code>) is the only language supported with Amazon Transcribe Medical.</p>\"\
        },\
        \"VocabularyState\":{\
    ...
    \"CreateVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>A unique name, chosen by you, for your new custom vocabulary filter.</p> <p>This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account. If you try to create a new vocabulary filter with the same name as an existing vocabulary filter, you get a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
        ...
        \"Tags\":{\
          \"shape\":\"TagList\",\
          \"documentation\":\"<p>Adds one or more custom tags, each in the form of a key:value pair, to a new custom vocabulary filter at the time you create this new filter.</p> <p>To learn more about using tags with Amazon Transcribe, refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html\\\">Tagging resources</a>.</p>\"\
        }\
      }\
    },\
    \"CreateVocabularyFilterResponse\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code you selected for your vocabulary filter.</p>\"\
        },\
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time you created your vocabulary filter.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        }\
      }\
    },\
    \"CreateVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>A unique name, chosen by you, for your new custom vocabulary.</p> <p>This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account. If you try to create a new vocabulary with the same name as an existing vocabulary, you get a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code that represents the language of the entries in your custom vocabulary. Each vocabulary must contain terms in only one language.</p> <p>A custom vocabulary can only be used to transcribe files in the same language as the vocabulary. For example, if you create a vocabulary using US English (<code>en-US</code>), you can only apply this vocabulary to files that contain English audio.</p> <p>For a list of supported languages and their associated language codes, refer to the <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html\\\">Supported languages</a> table.</p>\"\
        },\
        \"Phrases\":{\
          \"shape\":\"Phrases\",\
        ...
        \"Tags\":{\
          \"shape\":\"TagList\",\
          \"documentation\":\"<p>Adds one or more custom tags, each in the form of a key:value pair, to a new custom vocabulary at the time you create this new vocabulary.</p> <p>To learn more about using tags with Amazon Transcribe, refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html\\\">Tagging resources</a>.</p>\"\
        }\
      }\
    },\
    \"CreateVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"VocabularyState\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>The processing state of your custom vocabulary. If the state is <code>READY</code>, you can use the vocabulary in a <code>StartTranscriptionJob</code> request.</p>\"\
        },\
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
        ...
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
          \"documentation\":\"<p>If <code>VocabularyState</code> is <code>FAILED</code>, <code>FailureReason</code> contains information about why the vocabulary request failed. See also: <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html\\\">Common Errors</a>.</p>\"\
        }\
      }\
    },\
    \"DataAccessRoleArn\":{\
    ...
    \"DeleteMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom medical vocabulary you want to delete. Vocabulary names are case sensitive.</p>\"\
        }\
      }\
    },\
    ...
    \"DeleteVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the custom vocabulary filter you want to delete. Vocabulary filter names are case sensitive.</p>\"\
        }\
      }\
    },\
    \"DeleteVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to delete. Vocabulary names are case sensitive.</p>\"\
        }\
      }\
    },\
    ...
    \"GetMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom medical vocabulary you want information about. Vocabulary names are case sensitive.</p>\"\
        }\
      }\
    },\
    \"GetMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
          \"documentation\":\"<p>If <code>VocabularyState</code> is <code>FAILED</code>, <code>FailureReason</code> contains information about why the medical vocabulary request failed. See also: <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html\\\">Common Errors</a>.</p>\"\
        },\
        \"DownloadUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The S3 location where the specified medical vocabulary is stored; use this URI to view or download the vocabulary.</p>\"\
        }\
      }\
    },\
    ...
    \"GetVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the custom vocabulary filter you want information about. Vocabulary filter names are case sensitive.</p>\"\
        }\
      }\
    },\
    \"GetVocabularyFilterResponse\":{\
      ...
      \"members\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified vocabulary filter was last modified.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"DownloadUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The Amazon S3 location where the vocabulary filter is stored; use this URI to view or download the vocabulary filter.</p>\"\
        }\
      }\
    },\
    \"GetVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want information about. Vocabulary names are case sensitive.</p>\"\
        }\
      }\
    },\
    \"GetVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified vocabulary was last modified.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
          \"documentation\":\"<p>If <code>VocabularyState</code> is <code>FAILED</code>, <code>FailureReason</code> contains information about why the vocabulary request failed. See also: <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html\\\">Common Errors</a>.</p>\"\
    ...
    \"InterruptionFilter\":{\
      ...
      \"members\":{\
        \"Threshold\":{\
          \"shape\":\"TimestampMilliseconds\",\
          \"documentation\":\"<p>Specify the duration of the interruptions in milliseconds. For example, you can flag speech that contains more than 10000 milliseconds of interruptions.</p>\"\
        },\
        \"ParticipantRole\":{\
          \"shape\":\"ParticipantRole\",\
          \"documentation\":\"<p>Specify the interrupter you want to flag. Omitting this parameter is equivalent to specifying both participants.</p>\"\
        },\
        \"AbsoluteTimeRange\":{\
          \"shape\":\"AbsoluteTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in milliseconds) in your audio, during which you want to search for an interruption. See for more detail.</p>\"\
        },\
        \"RelativeTimeRange\":{\
          \"shape\":\"RelativeTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in percentage) in your media file, during which you want to search for an interruption. See for more detail.</p>\"\
        },\
        \"Negate\":{\
          \"shape\":\"Boolean\",\
    ...
    \"JobExecutionSettings\":{\
      ...
      \"documentation\":\"<p>Allows you to control how your transcription job is processed. Currently, the only <code>JobExecutionSettings</code> modification you can choose is enabling job queueing using the <code>AllowDeferredExecution</code> sub-parameter.</p> <p>If you include <code>JobExecutionSettings</code> in your request, you must also include the sub-parameters: <code>AllowDeferredExecution</code> and <code>DataAccessRoleArn</code>.</p>\"\
    },\
    ...
    \"LanguageModel\":{\
      ...
      \"members\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified language model was last modified.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"CLMLanguageCode\",\
    ...
    \"ListCallAnalyticsCategoriesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of Call Analytics categories to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListCallAnalyticsJobsRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of Call Analytics jobs to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListLanguageModelsRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom language models to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListMedicalTranscriptionJobsRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of medical transcription jobs to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListMedicalVocabulariesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom medical vocabularies to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        },\
        \"StateEquals\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>Returns only custom medical vocabularies with the specified state. Vocabularies are ordered by creation date, with the newest vocabulary first. If you don't include <code>StateEquals</code>, all custom medical vocabularies are returned.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyName\",\
    ...
    \"ListMedicalVocabulariesResponse\":{\
      ...
      \"members\":{\
        \"Status\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>Lists all custom medical vocabularies that have the status specified in your request. Vocabularies are ordered by creation date, with the newest vocabulary first.</p>\"\
        },\
        \"NextToken\":{\
          \"shape\":\"NextToken\",\
          \"documentation\":\"<p>If <code>NextToken</code> is present in your response, it indicates that not all results are displayed. To view the next set of results, copy the string associated with the <code>NextToken</code> parameter in your results output, then run your request again including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>\"\
    ...
    \"ListTranscriptionJobsRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of transcription jobs to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListVocabulariesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom vocabularies to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        },\
        \"StateEquals\":{\
          \"shape\":\"VocabularyState\",\
    ...
    \"ListVocabularyFiltersRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom vocabulary filters to return in each page of results. If there are fewer results than the value you specify, only the actual results are returned. If you don't specify a value, a default of 5 is used.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyFilterName\",\
    ...
    \"MedicalTranscriptionJob\":{\
      ...
      \"members\":{\
        ...
        \"Settings\":{\
          ...
          \"documentation\":\"<p>Specify additional optional settings in your request, including channel identification, alternative transcriptions, and speaker labeling; allows you to apply custom vocabularies to your medical transcription job.</p>\"\
        },\
    ...
    \"MedicalTranscriptionSetting\":{\
      ...
      \"members\":{\
        ...
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to use when processing your medical transcription job. Vocabulary names are case sensitive.</p> <p>The language of the specified vocabulary must match the language code you specify in your transcription request. If the languages don't match, the vocabulary isn't applied. There are no errors or warnings associated with a language mismatch. US English (<code>en-US</code>) is the only valid language for Amazon Transcribe Medical.</p>\"\
        }\
      },\
      \"documentation\":\"<p>Allows additional optional settings in your request, including channel identification, alternative transcriptions, and speaker labeling; allows you to apply custom vocabularies to your medical transcription job.</p>\"\
    },\
    \"ModelName\":{\
      \"type\":\"string\",\
      \"max\":200,\
    ...
    \"NonTalkTimeFilter\":{\
      ...
      \"members\":{\
        \"Threshold\":{\
          \"shape\":\"TimestampMilliseconds\",\
          \"documentation\":\"<p>Specify the duration, in milliseconds, of the period of silence you want to flag. For example, you can flag a silent period that lasts 30000 milliseconds.</p>\"\
        },\
        \"AbsoluteTimeRange\":{\
          \"shape\":\"AbsoluteTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in milliseconds) in your audio, during which you want to search for a period of silence. See for more detail.</p>\"\
        },\
        \"RelativeTimeRange\":{\
          \"shape\":\"RelativeTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in percentage) in your media file, during which you want to search for a period of silence. See for more detail.</p>\"\
        },\
        \"Negate\":{\
          \"shape\":\"Boolean\",\
    ...
    \"RelativeTimeRange\":{\
      ...
      \"members\":{\
        ...
        \"First\":{\
          \"shape\":\"Percentage\",\
          \"documentation\":\"<p>The time, in percentage, from the start of your media file until the value you specify in which Amazon Transcribe searches for your specified criteria.</p>\"\
        },\
        \"Last\":{\
          \"shape\":\"Percentage\",\
          \"documentation\":\"<p>The time, in percentage, from the value you specify until the end of your media file in which Amazon Transcribe searches for your specified criteria.</p>\"\
        }\
      },\
    ...
    \"Rule\":{\
      ...
      \"documentation\":\"<p>A rule is a set of criteria you can specify to flag an attribute in your Call Analytics output. Rules define a Call Analytics category.</p> <p>Rules can include these parameters: , , , and . To learn more about these parameters, refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/call-analytics-create-categories.html#call-analytics-create-categories-rules\\\">Rule criteria</a>.</p> <p>To learn more about Call Analytics categories, see <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/call-analytics-create-categories.html\\\">Creating categories</a>.</p> <p>To learn more about Call Analytics, see <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/call-analytics.html\\\">Analyzing call center audio with Call Analytics</a>.</p>\",\
      \"union\":true\
    },\
    \"RuleList\":{\
      \"type\":\"list\",\
    ...
    \"SentimentFilter\":{\
      ...
      \"members\":{\
        \"Sentiments\":{\
          ...
          \"documentation\":\"<p>Specify the sentiments you want to flag.</p>\"\
        },\
        \"AbsoluteTimeRange\":{\
          \"shape\":\"AbsoluteTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in milliseconds) in your audio, during which you want to search for the specified sentiments. See for more detail.</p>\"\
        },\
        \"RelativeTimeRange\":{\
          \"shape\":\"RelativeTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in percentage) in your media file, during which you want to search for the specified sentiments. See for more detail.</p>\"\
        },\
        \"ParticipantRole\":{\
          \"shape\":\"ParticipantRole\",\
          \"documentation\":\"<p>Specify the participant you want to flag. Omitting this parameter is equivalent to specifying both participants.</p>\"\
        },\
        \"Negate\":{\
          \"shape\":\"Boolean\",\
          \"documentation\":\"<p>Set to <code>TRUE</code> to flag the sentiments you didn't include in your request. Set to <code>FALSE</code> to flag the sentiments you specified in your request.</p>\"\
        }\
      },\
    ...
    \"Settings\":{\
      ...
      \"documentation\":\"<p>Allows additional optional settings in your request, including channel identification, alternative transcriptions, and speaker labeling; allows you to apply custom vocabularies to your transcription job.</p>\"\
    },\
    \"Specialty\":{\
      \"type\":\"string\",\
      \"enum\":[\"PRIMARYCARE\"]\
    ...
    \"StartMedicalTranscriptionJobRequest\":{\
      ...
      \"members\":{\
        ...
        \"Settings\":{\
          \"shape\":\"MedicalTranscriptionSetting\",\
          \"documentation\":\"<p>Specify additional optional settings in your request, including channel identification, alternative transcriptions, and speaker labeling; allows you to apply custom vocabularies to your transcription job.</p>\"\
        },\
        \"ContentIdentificationType\":{\
          \"shape\":\"MedicalContentIdentificationType\",\
          \"documentation\":\"<p>Labels all personal health information (PHI) identified in your transcript. For more information, see <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/phi-id.html\\\">Identifying personal health information (PHI) in a transcription</a>.</p>\"\
    ...
    \"StartTranscriptionJobRequest\":{\
      ...
      \"members\":{\
        \"TranscriptionJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>A unique name, chosen by you, for your transcription job. The name you specify is also used as the default name of your transcription output file. If you want to specify a different name for your transcription output, use the <code>OutputKey</code> parameter.</p> <p>This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account. If you try to create a new job with the same name as an existing job, you get a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
        ...
        \"Settings\":{\
          \"shape\":\"Settings\",\
          \"documentation\":\"<p>Specify additional optional settings in your request, including channel identification, alternative transcriptions, speaker labeling; allows you to apply custom vocabularies and vocabulary filters.</p> <p>If you want to include a custom vocabulary or a custom vocabulary filter (or both) with your request but <b>do not</b> want to use automatic language identification, use <code>Settings</code> with the <code>VocabularyName</code> or <code>VocabularyFilterName</code> (or both) sub-parameter.</p> <p>If you're using automatic language identification with your request and want to include a custom language model, a custom vocabulary, or a custom vocabulary filter, use instead the <code/> parameter with the <code>LanguageModelName</code>, <code>VocabularyName</code> or <code>VocabularyFilterName</code> sub-parameters.</p>\"\
        },\
        \"ModelSettings\":{\
          \"shape\":\"ModelSettings\",\
    ...
    \"TranscriptFilter\":{\
      ...
      \"members\":{\
        \"TranscriptFilterType\":{\
          ...
          \"documentation\":\"<p>Flag the presence or absence of an exact match to the phrases you specify. For example, if you specify the phrase \\\"speak to a manager\\\" as your <code>Targets</code> value, only that exact phrase is flagged.</p> <p>Note that semantic matching is not supported. For example, if your customer says \\\"speak to <i>the</i> manager\\\", instead of \\\"speak to <i>a</i> manager\\\", your content is not flagged.</p>\"\
        },\
        \"AbsoluteTimeRange\":{\
          \"shape\":\"AbsoluteTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in milliseconds) in your audio, during which you want to search for the specified key words or phrases. See for more detail.</p>\"\
        },\
        \"RelativeTimeRange\":{\
          \"shape\":\"RelativeTimeRange\",\
          \"documentation\":\"<p>Allows you to specify a time range (in percentage) in your media file, during which you want to search for the specified key words or phrases. See for more detail.</p>\"\
        },\
        \"ParticipantRole\":{\
          \"shape\":\"ParticipantRole\",\
          \"documentation\":\"<p>Specify the participant you want to flag. Omitting this parameter is equivalent to specifying both participants.</p>\"\
        ...
        \"Negate\":{\
          \"shape\":\"Boolean\",\
          \"documentation\":\"<p>Set to <code>TRUE</code> to flag the absence of the phrase you specified in your request. Set to <code>FALSE</code> to flag the presence of the phrase you specified in your request.</p>\"\
        },\
        \"Targets\":{\
          \"shape\":\"StringTargetList\",\
          \"documentation\":\"<p>Specify the phrases you want to flag.</p>\"\
        }\
      },\
    ...
    \"TranscriptionJob\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code used to create your transcription job. For a list of supported languages and their associated language codes, refer to the <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html\\\">Supported languages</a> table.</p> <p>Note that you must include one of <code>LanguageCode</code>, <code>IdentifyLanguage</code>, or <code>IdentifyMultipleLanguages</code> in your request. If you include more than one of these parameters, your transcription job fails.</p>\"\
        },\
        \"MediaSampleRateHertz\":{\
          \"shape\":\"MediaSampleRateHertz\",\
          \"documentation\":\"<p>The sample rate, in Hertz, of the audio track in your input media file.</p>\"\
        ...
        \"ModelSettings\":{\
          \"shape\":\"ModelSettings\",\
          \"documentation\":\"<p>The custom language model you want to include with your transcription job. If you include <code>ModelSettings</code> in your request, you must include the <code>LanguageModelName</code> sub-parameter.</p>\"\
        },\
        \"JobExecutionSettings\":{\
          \"shape\":\"JobExecutionSettings\",\
          \"documentation\":\"<p>Provides information about how your transcription job is being processed. This parameter shows if your request is queued and what data access role is being used.</p>\"\
        },\
        \"ContentRedaction\":{\
          \"shape\":\"ContentRedaction\",\
          \"documentation\":\"<p>Redacts or flags specified personally identifiable information (PII) in your transcript.</p>\"\
        },\
        \"IdentifyLanguage\":{\
          \"shape\":\"Boolean\",\
        ...
        \"LanguageCodes\":{\
          ...
          \"documentation\":\"<p>The language codes used to create your transcription job. This parameter is used with multi-language identification. For single-language identification requests, refer to the singular version of this parameter, <code>LanguageCode</code>.</p> <p>For a list of supported languages and their associated language codes, refer to the <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html\\\">Supported languages</a> table.</p>\"\
        },\
        \"Tags\":{\
          \"shape\":\"TagList\",\
          \"documentation\":\"<p>Adds one or more custom tags, each in the form of a key:value pair, to a new transcription job at the time you start this new job.</p> <p>To learn more about using tags with Amazon Transcribe, refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html\\\">Tagging resources</a>.</p>\"\
        ...
        \"Subtitles\":{\
          ...
          \"documentation\":\"<p>Generate subtitles for your media file with your transcription request.</p>\"\
        },\
        \"LanguageIdSettings\":{\
          \"shape\":\"LanguageIdSettingsMap\",\
          \"documentation\":\"<p>If using automatic language identification (<code>IdentifyLanguage</code>) in your request and you want to apply a custom language model, a custom vocabulary, or a custom vocabulary filter, include <code>LanguageIdSettings</code> with the relevant sub-parameters (<code>VocabularyName</code>, <code>LanguageModelName</code>, and <code>VocabularyFilterName</code>).</p> <p>You can specify two or more language codes that represent the languages you think may be present in your media; including more than five is not recommended. Each language code you include can have an associated custom language model, custom vocabulary, and custom vocabulary filter. The languages you specify must match the languages of the specified custom language models, custom vocabularies, and custom vocabulary filters.</p> <p>To include language options using <code>IdentifyLanguage</code> <b>without</b> including a custom language model, a custom vocabulary, or a custom vocabulary filter, use <code>LanguageOptions</code> instead of <code>LanguageIdSettings</code>. Including language options can improve the accuracy of automatic language identification.</p> <p>If you want to include a custom language model with your request but <b>do not</b> want to use automatic language identification, use instead the <code/> parameter with the <code>LanguageModelName</code> sub-parameter.</p> <p>If you want to include a custom vocabulary or a custom vocabulary filter (or both) with your request but <b>do not</b> want to use automatic language identification, use instead the <code/> parameter with the <code>VocabularyName</code> or <code>VocabularyFilterName</code> (or both) sub-parameter.</p>\"\
    ...
    \"UpdateMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom medical vocabulary you want to update. Vocabulary names are case sensitive.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
    ...
    \"UpdateVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the custom vocabulary filter you want to update. Vocabulary filter names are case sensitive.</p>\"\
        },\
        \"Words\":{\
          \"shape\":\"Words\",\
          \"documentation\":\"<p>Use this parameter if you want to update your vocabulary filter by including all desired terms, as comma-separated values, within your request. The other option for updating your vocabulary filter is to save your entries in a text file and upload them to an Amazon S3 bucket, then specify the location of your file using the <code>VocabularyFilterFileUri</code> parameter.</p> <p>Note that if you include <code>Words</code> in your request, you cannot use <code>VocabularyFilterFileUri</code>; you must choose one or the other.</p> <p>Each language has a character set that contains all allowed characters for that specific language. If you use unsupported characters, your vocabulary filter request fails. Refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/charsets.html\\\">Character Sets for Custom Vocabularies</a> to get the character set for your language.</p>\"\
        },\
        \"VocabularyFilterFileUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The Amazon S3 location of the text file that contains your custom vocabulary filter terms. The URI must be located in the same Amazon Web Services Region as the resource you're calling.</p> <p>Here's an example URI path: <code>s3://DOC-EXAMPLE-BUCKET/my-vocab-filter-file.txt</code> </p> <p>Note that if you include <code>VocabularyFilterFileUri</code> in your request, you cannot use <code>Words</code>; you must choose one or the other.</p>\"\
    ...
    \"UpdateVocabularyFilterResponse\":{\
      ...
      \"members\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified vocabulary filter was last updated.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        }\
      }\
    },\
    \"UpdateVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to update. Vocabulary names are case sensitive.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code that represents the language of the entries in the custom vocabulary you want to update. Each vocabulary must contain terms in only one language.</p> <p>A custom vocabulary can only be used to transcribe files in the same language as the vocabulary. For example, if you create a vocabulary using US English (<code>en-US</code>), you can only apply this vocabulary to files that contain English audio.</p> <p>For a list of supported languages and their associated language codes, refer to the <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/supported-languages.html\\\">Supported languages</a> table.</p>\"\
        },\
        \"Phrases\":{\
          \"shape\":\"Phrases\",\
          \"documentation\":\"<p>Use this parameter if you want to update your vocabulary by including all desired terms, as comma-separated values, within your request. The other option for updating your vocabulary is to save your entries in a text file and upload them to an Amazon S3 bucket, then specify the location of your file using the <code>VocabularyFileUri</code> parameter.</p> <p>Note that if you include <code>Phrases</code> in your request, you cannot use <code>VocabularyFileUri</code>; you must choose one or the other.</p> <p>Each language has a character set that contains all allowed characters for that specific language. If you use unsupported characters, your vocabulary filter request fails. Refer to <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/charsets.html\\\">Character Sets for Custom Vocabularies</a> to get the character set for your language.</p>\"\
    ...
    \"UpdateVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified vocabulary was last updated.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"VocabularyState\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>The processing state of your custom vocabulary. If the state is <code>READY</code>, you can use the vocabulary in a <code>StartTranscriptionJob</code> request.</p>\"\
    ...
    \"VocabularyFilterInfo\":{\
      ...
      \"documentation\":\"<p>Provides information about a vocabulary filter, including the language of the filter, when it was last modified, and its name.</p>\"\
    },\
    \"VocabularyFilterMethod\":{\
      \"type\":\"string\",\
      \"enum\":[\
    ...
    \"VocabularyInfo\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code used to create your custom vocabulary. Each vocabulary must contain terms in only one language.</p> <p>A custom vocabulary can only be used to transcribe files in the same language as the vocabulary. For example, if you create a vocabulary using US English (<code>en-US</code>), you can only apply this vocabulary to files that contain English audio.</p>\"\
        },\
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified vocabulary was last modified.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents 12:32 PM UTC-7 on May 4, 2022.</p>\"\
      ...
      \"documentation\":\"<p>Provides information about a custom vocabulary, including the language of the vocabulary, when it was last modified, its name, and the processing state.</p>\"\
    },\
    \"VocabularyName\":{\
      \"type\":\"string\",\
      \"max\":200,\
