...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeleteMedicalScribeJob\":{\
      ...
      \"input\":{\"shape\":\"DeleteMedicalScribeJobRequest\"},\
      \"errors\":[\
        {\"shape\":\"LimitExceededException\"},\
        {\"shape\":\"BadRequestException\"},\
        {\"shape\":\"InternalFailureException\"}\
      ],\
      \"documentation\":\"<p>Deletes a Medical Scribe job. To use this operation, specify the name of the job you want to delete using <code>MedicalScribeJobName</code>. Job names are case sensitive.</p>\"\
    },\
    ...
    \"GetMedicalScribeJob\":{\
      ...
      \"input\":{\"shape\":\"GetMedicalScribeJobRequest\"},\
      \"output\":{\"shape\":\"GetMedicalScribeJobResponse\"},\
      \"errors\":[\
        {\"shape\":\"BadRequestException\"},\
        {\"shape\":\"LimitExceededException\"},\
        {\"shape\":\"InternalFailureException\"},\
    ...
    \"ListMedicalScribeJobs\":{\
      ...
      \"input\":{\"shape\":\"ListMedicalScribeJobsRequest\"},\
      \"output\":{\"shape\":\"ListMedicalScribeJobsResponse\"},\
      \"errors\":[\
        {\"shape\":\"BadRequestException\"},\
        {\"shape\":\"LimitExceededException\"},\
        {\"shape\":\"InternalFailureException\"}\
      ],\
      \"documentation\":\"<p>Provides a list of Medical Scribe jobs that match the specified criteria. If no criteria are specified, all Medical Scribe jobs are returned.</p> <p>To get detailed information about a specific Medical Scribe job, use the operation.</p>\"\
    },\
    ...
    \"StartMedicalScribeJob\":{\
      ...
      \"input\":{\"shape\":\"StartMedicalScribeJobRequest\"},\
      \"output\":{\"shape\":\"StartMedicalScribeJobResponse\"},\
      \"errors\":[\
        {\"shape\":\"BadRequestException\"},\
        {\"shape\":\"LimitExceededException\"},\
        {\"shape\":\"InternalFailureException\"},\
  ...
  \"shapes\":{\
    ...
    \"CallAnalyticsJobSettings\":{\
      ...
      \"members\":{\
        ...
        \"Summarization\":{\
          \"shape\":\"Summarization\",\
          \"documentation\":\"<p>Contains <code>GenerateAbstractiveSummary</code>, which is a required parameter if you want to enable Generative call summarization in your Call Analytics request.</p>\"\
        }\
      },\
    ...
    \"ContentRedaction\":{\
      ...
      \"members\":{\
        ...
        \"PiiEntityTypes\":{\
          ...
          \"documentation\":\"<p>Specify which types of personally identifiable information (PII) you want to redact in your transcript. You can include as many types as you'd like, or you can select <code>ALL</code>. If you do not include <code>PiiEntityTypes</code> in your request, all PII is redacted.</p>\"\
        }\
      },\
      \"documentation\":\"<p>Makes it possible to redact or flag specified personally identifiable information (PII) in your transcript. If you use <code>ContentRedaction</code>, you must also include the sub-parameters: <code>RedactionOutput</code> and <code>RedactionType</code>. You can optionally include <code>PiiEntityTypes</code> to choose which types of PII you want to redact.</p>\"\
    },\
    ...
    \"DeleteMedicalScribeJobRequest\":{\
      ...
      \"members\":{\
        \"MedicalScribeJobName\":{\
          ...
          \"documentation\":\"<p>The name of the Medical Scribe job you want to delete. Job names are case sensitive.</p>\"\
        }\
      }\
    },\
    ...
    \"GetMedicalScribeJobRequest\":{\
      ...
      \"members\":{\
        \"MedicalScribeJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>The name of the Medical Scribe job you want information about. Job names are case sensitive.</p>\"\
        }\
      }\
    },\
    \"GetMedicalScribeJobResponse\":{\
      ...
      \"members\":{\
        \"MedicalScribeJob\":{\
          \"shape\":\"MedicalScribeJob\",\
          \"documentation\":\"<p>Provides detailed information about the specified Medical Scribe job, including job status and, if applicable, failure reason</p>\"\
        }\
      }\
    },\
    ...
    \"GetMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"DownloadUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The Amazon S3 location where the specified custom medical vocabulary is stored; use this URI to view or download the custom vocabulary.</p>\"\
        }\
      }\
    },\
    ...
    \"GetVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"DownloadUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The Amazon S3 location where the custom vocabulary is stored; use this URI to view or download the custom vocabulary.</p>\"\
        }\
      }\
    },\
    ...
    \"LanguageIdSettings\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to use when processing your transcription job. Custom vocabulary names are case sensitive.</p> <p>The language of the specified custom vocabulary must match the language code that you specify in your transcription request. If the languages do not match, the custom vocabulary isn't applied. There are no errors or warnings associated with a language mismatch.</p>\"\
        },\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
    ...
    \"ListCallAnalyticsCategoriesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of Call Analytics categories to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListCallAnalyticsJobsRequest\":{\
      ...
      \"members\":{\
        \"Status\":{\
          \"shape\":\"CallAnalyticsJobStatus\",\
          \"documentation\":\"<p>Returns only Call Analytics jobs with the specified status. Jobs are ordered by creation date, with the newest job first. If you do not include <code>Status</code>, all Call Analytics jobs are returned.</p>\"\
        },\
        \"JobNameContains\":{\
          \"shape\":\"CallAnalyticsJobName\",\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of Call Analytics jobs to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListLanguageModelsRequest\":{\
      ...
      \"members\":{\
        \"StatusEquals\":{\
          \"shape\":\"ModelStatus\",\
          \"documentation\":\"<p>Returns only custom language models with the specified status. Language models are ordered by creation date, with the newest model first. If you do not include <code>StatusEquals</code>, all custom language models are returned.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"ModelName\",\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom language models to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListMedicalScribeJobsRequest\":{\
      ...
      \"members\":{\
        \"Status\":{\
          \"shape\":\"MedicalScribeJobStatus\",\
          \"documentation\":\"<p>Returns only Medical Scribe jobs with the specified status. Jobs are ordered by creation date, with the newest job first. If you do not include <code>Status</code>, all Medical Scribe jobs are returned.</p>\"\
        },\
        \"JobNameContains\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>Returns only the Medical Scribe jobs that contain the specified string. The search is not case sensitive.</p>\"\
        },\
        \"NextToken\":{\
          \"shape\":\"NextToken\",\
          \"documentation\":\"<p>If your <code>ListMedicalScribeJobs</code> request returns more results than can be displayed, <code>NextToken</code> is displayed in the response with an associated string. To get the next page of results, copy this string and repeat your request, including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>\"\
        },\
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of Medical Scribe jobs to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    \"ListMedicalScribeJobsResponse\":{\
      ...
      \"members\":{\
        \"Status\":{\
          \"shape\":\"MedicalScribeJobStatus\",\
          \"documentation\":\"<p>Lists all Medical Scribe jobs that have the status specified in your request. Jobs are ordered by creation date, with the newest job first.</p>\"\
        },\
        \"NextToken\":{\
          \"shape\":\"NextToken\",\
          \"documentation\":\"<p>If <code>NextToken</code> is present in your response, it indicates that not all results are displayed. To view the next set of results, copy the string associated with the <code>NextToken</code> parameter in your results output, then run your request again including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>\"\
        ...
        \"MedicalScribeJobSummaries\":{\
          \"shape\":\"MedicalScribeJobSummaries\",\
          \"documentation\":\"<p>Provides a summary of information about each result.</p>\"\
        }\
      }\
    },\
    \"ListMedicalTranscriptionJobsRequest\":{\
      ...
      \"members\":{\
        \"Status\":{\
          ...
          \"documentation\":\"<p>Returns only medical transcription jobs with the specified status. Jobs are ordered by creation date, with the newest job first. If you do not include <code>Status</code>, all medical transcription jobs are returned.</p>\"\
        },\
        \"JobNameContains\":{\
          \"shape\":\"TranscriptionJobName\",\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of medical transcription jobs to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListMedicalVocabulariesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom medical vocabularies to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        },\
        \"StateEquals\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>Returns only custom medical vocabularies with the specified state. Custom vocabularies are ordered by creation date, with the newest vocabulary first. If you do not include <code>StateEquals</code>, all custom medical vocabularies are returned.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyName\",\
    ...
    \"ListTranscriptionJobsRequest\":{\
      ...
      \"members\":{\
        \"Status\":{\
          \"shape\":\"TranscriptionJobStatus\",\
          \"documentation\":\"<p>Returns only transcription jobs with the specified status. Jobs are ordered by creation date, with the newest job first. If you do not include <code>Status</code>, all transcription jobs are returned.</p>\"\
        },\
        \"JobNameContains\":{\
          \"shape\":\"TranscriptionJobName\",\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of transcription jobs to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        }\
      }\
    },\
    ...
    \"ListVocabulariesRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom vocabularies to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        },\
        \"StateEquals\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>Returns only custom vocabularies with the specified state. Vocabularies are ordered by creation date, with the newest vocabulary first. If you do not include <code>StateEquals</code>, all custom medical vocabularies are returned.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyName\",\
    ...
    \"ListVocabularyFiltersRequest\":{\
      ...
      \"members\":{\
        ...
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
          \"documentation\":\"<p>The maximum number of custom vocabulary filters to return in each page of results. If there are fewer results than the value that you specify, only the actual results are returned. If you do not specify a value, a default of 5 is used.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyFilterName\",\
    ...
    \"MedicalScribeChannelDefinition\":{\
      ...
      \"members\":{\
        ...
        \"ParticipantRole\":{\
          ...
          \"documentation\":\"<p>Specify the participant that you want to flag. The options are <code>CLINICIAN</code> and <code>PATIENT</code> </p>\"\
        }\
      },\
      \"documentation\":\"<p>Indicates which speaker is on which channel. The options are <code>CLINICIAN</code> and <code>PATIENT</code> </p>\"\
    },\
    ...
    \"MedicalScribeJob\":{\
      ...
      \"members\":{\
        \"MedicalScribeJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>The name of the Medical Scribe job. Job names are case sensitive and must be unique within an Amazon Web Services account.</p>\"\
        },\
        \"MedicalScribeJobStatus\":{\
          \"shape\":\"MedicalScribeJobStatus\",\
          \"documentation\":\"<p>Provides the status of the specified Medical Scribe job.</p> <p>If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in <code>MedicalScribeOutput</code> If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your Medical Scribe job failed.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"MedicalScribeLanguageCode\",\
          \"documentation\":\"<p>The language code used to create your Medical Scribe job. US English (<code>en-US</code>) is the only supported language for Medical Scribe jobs. </p>\"\
        },\
        \"Media\":{\"shape\":\"Media\"},\
        \"MedicalScribeOutput\":{\
          \"shape\":\"MedicalScribeOutput\",\
          \"documentation\":\"<p>The location of the output of your Medical Scribe job. <code>ClinicalDocumentUri</code> holds the Amazon S3 URI for the Clinical Document and <code>TranscriptFileUri</code> holds the Amazon S3 URI for the Transcript.</p>\"\
        },\
        \"StartTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time your Medical Scribe job began processing.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.789000-07:00</code> represents a Medical Scribe job that started processing at 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"CreationTime\":{\
          \"shape\":\"DateTime\",\
        ...
        \"CompletionTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the specified Medical Scribe job finished processing.</p> <p>Timestamps are in the format <code>YYYY-MM-DD'T'HH:MM:SS.SSSSSS-UTC</code>. For example, <code>2022-05-04T12:32:58.761000-07:00</code> represents a Medical Scribe job that finished processing at 12:32 PM UTC-7 on May 4, 2022.</p>\"\
        },\
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
          \"documentation\":\"<p>If <code>MedicalScribeJobStatus</code> is <code>FAILED</code>, <code>FailureReason</code> contains information about why the transcription job failed. See also: <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/APIReference/CommonErrors.html\\\">Common Errors</a>.</p>\"\
        },\
        \"Settings\":{\
          \"shape\":\"MedicalScribeSettings\",\
        ...
        \"DataAccessRoleArn\":{\
          \"shape\":\"DataAccessRoleArn\",\
          \"documentation\":\"<p>The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon S3 bucket that contains your input files, write to the output bucket, and use your KMS key if supplied. If the role that you specify doesnât have the appropriate permissions your request fails.</p> <p>IAM role ARNs have the format <code>arn:partition:iam::account:role/role-name-with-path</code>. For example: <code>arn:aws:iam::111122223333:role/Admin</code>.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns\\\">IAM ARNs</a>.</p>\"\
        },\
        \"ChannelDefinitions\":{\
    ...
    \"MedicalScribeJobSummaries\":{\
      \"type\":\"list\",\
      \"member\":{\"shape\":\"MedicalScribeJobSummary\"}\
    },\
    \"MedicalScribeJobSummary\":{\
      ...
      \"documentation\":\"<p>Provides detailed information about a specific Medical Scribe job.</p>\"\
    },\
    ...
    \"MedicalScribeOutput\":{\
      ...
      \"members\":{\
        \"TranscriptFileUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>Holds the Amazon S3 URI for the Transcript.</p>\"\
        },\
        \"ClinicalDocumentUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>Holds the Amazon S3 URI for the Clinical Document.</p>\"\
        }\
      },\
      \"documentation\":\"<p>The location of the output of your Medical Scribe job. <code>ClinicalDocumentUri</code> holds the Amazon S3 URI for the Clinical Document and <code>TranscriptFileUri</code> holds the Amazon S3 URI for the Transcript.</p>\"\
    },\
    ...
    \"MedicalScribeSettings\":{\
      ...
      \"members\":{\
        ...
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to include in your Medical Scribe request. Custom vocabulary names are case sensitive.</p>\"\
        },\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the custom vocabulary filter you want to include in your Medical Scribe request. Custom vocabulary filter names are case sensitive.</p> <p>Note that if you include <code>VocabularyFilterName</code> in your request, you must also include <code>VocabularyFilterMethod</code>.</p>\"\
        },\
        \"VocabularyFilterMethod\":{\
          \"shape\":\"VocabularyFilterMethod\",\
          \"documentation\":\"<p>Specify how you want your custom vocabulary filter applied to your transcript.</p> <p>To replace words with <code>***</code>, choose <code>mask</code>.</p> <p>To delete words, choose <code>remove</code>.</p> <p>To flag words without changing them, choose <code>tag</code>.</p>\"\
    ...
    \"MedicalTranscriptionSetting\":{\
      ...
      \"members\":{\
        ...
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the custom vocabulary you want to use when processing your medical transcription job. Custom vocabulary names are case sensitive.</p> <p>The language of the specified custom vocabulary must match the language code that you specify in your transcription request. If the languages do not match, the custom vocabulary isn't applied. There are no errors or warnings associated with a language mismatch. US English (<code>en-US</code>) is the only valid language for Amazon Transcribe Medical.</p>\"\
        }\
      },\
    ...
    \"StartMedicalScribeJobRequest\":{\
      ...
      \"members\":{\
        \"MedicalScribeJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>A unique name, chosen by you, for your Medical Scribe job.</p> <p>This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account. If you try to create a new job with the same name as an existing job, you get a <code>ConflictException</code> error.</p>\"\
        },\
        \"Media\":{\"shape\":\"Media\"},\
        \"OutputBucketName\":{\
    ...
    \"StartMedicalScribeJobResponse\":{\
      ...
      \"members\":{\
        \"MedicalScribeJob\":{\
          \"shape\":\"MedicalScribeJob\",\
          \"documentation\":\"<p>Provides detailed information about the current Medical Scribe job, including job status and, if applicable, failure reason.</p>\"\
        }\
      }\
    },\
