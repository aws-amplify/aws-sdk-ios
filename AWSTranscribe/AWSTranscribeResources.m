  ...
  \"shapes\":{\
    ...
    \"StartMedicalTranscriptionJobRequest\":{\
      ...
      \"members\":{\
        \"MedicalTranscriptionJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>The name of the medical transcription job. You can't use the strings \\\".\\\" or \\\"..\\\" by themselves as the job name. The name must also be unique within an AWS account.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
        ...
        \"Type\":{\
          \"shape\":\"Type\",\
          \"documentation\":\"<p>The speech of clinician in the input audio. <code>CONVERSATION</code> refers to conversations clinicians have with patients. <code>DICTATION</code> refers to medical professionals dictating their notes about a patient encounter.</p>\"\
        }\
      }\
    },\
