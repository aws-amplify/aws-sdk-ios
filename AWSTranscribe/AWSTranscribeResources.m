...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"GetMedicalVocabulary\":{\
      ...
      \"documentation\":\"<p>Retrieve information about a medical vocabulary.</p>\"\
    },\
    \"GetTranscriptionJob\":{\
    ...
    \"ListMedicalVocabularies\":{\
      ...
      \"documentation\":\"<p>Returns a list of vocabularies that match the specified criteria. You get the entire list of vocabularies if you don't enter a value in any of the request parameters.</p>\"\
    },\
    ...
    \"StartMedicalTranscriptionJob\":{\
      ...
      \"documentation\":\"<p>Start a batch job to transcribe medical speech to text.</p>\"\
    },\
    ...
    \"UpdateMedicalVocabulary\":{\
      ...
      \"documentation\":\"<p>Updates an existing vocabulary with new values in a different text file. The <code>UpdateMedicalVocabulary</code> operation overwrites all of the existing information with the values that you provide in the request.</p>\"\
    },\
    \"UpdateVocabulary\":{\
  ...
  \"shapes\":{\
    ...
    \"ConflictException\":{\
      ...
      \"documentation\":\"<p>The resource name already exists.</p>\",\
      \"exception\":true\
    },\
    \"ContentRedaction\":{\
      \"type\":\"structure\",\
    ...
    \"CreateMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          ...
          \"documentation\":\"<p>The name of the custom vocabulary. This case-sensitive name must be unique within an AWS account. If you try to create a vocabulary with the same name as a previous vocabulary you will receive a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code used for the entries within your custom vocabulary. The language code of your custom vocabulary must match the language code of your transcription job. US English (en-US) is the only language code available for Amazon Transcribe Medical.</p>\"\
        },\
        \"VocabularyFileUri\":{\
          \"shape\":\"Uri\",\
    ...
    \"CreateMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the vocabulary. The name must be unique within an AWS account. It is also case-sensitive.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code you chose to describe the entries in your custom vocabulary. US English (en-US) is the only valid language code for Amazon Transcribe Medical.</p>\"\
        },\
        \"VocabularyState\":{\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time you created the vocabulary.</p>\"\
        },\
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
    ...
    \"CreateVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          ...
          \"documentation\":\"<p>The vocabulary filter name. The name must be unique within the account that contains it.If you try to create a vocabulary filter with the same name as a previous vocabulary filter you will receive a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
    ...
    \"DeleteMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the vocabulary you are choosing to delete.</p>\"\
        }\
      }\
    },\
    ...
    \"GetMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The name of the vocabulary you are trying to get information about. The value you enter for this request is case-sensitive. </p>\"\
        }\
      }\
    },\
    \"GetMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        \"VocabularyName\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>The valid name that Amazon Transcribe Medical returns.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The valid language code returned for your vocabulary entries.</p>\"\
        },\
        \"VocabularyState\":{\
          \"shape\":\"VocabularyState\",\
        ...
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the vocabulary was last modified with a text file different from what was previously used.</p>\"\
        },\
        \"FailureReason\":{\
          \"shape\":\"FailureReason\",\
        ...
        \"DownloadUri\":{\
          \"shape\":\"Uri\",\
          \"documentation\":\"<p>The Amazon S3 location where the vocabulary is stored. Use this URI to get the contents of the vocabulary. You can download your vocabulary from the URI for a limited time.</p>\"\
        }\
      }\
    },\
    ...
    \"ListMedicalVocabulariesRequest\":{\
      ...
      \"members\":{\
        \"NextToken\":{\
          \"shape\":\"NextToken\",\
          \"documentation\":\"<p>If the result of your previous request to <code>ListMedicalVocabularies</code> was truncated, include the <code>NextToken</code> to fetch the next set of jobs.</p>\"\
        },\
        \"MaxResults\":{\
          \"shape\":\"MaxResults\",\
        ...
        \"StateEquals\":{\
          \"shape\":\"VocabularyState\",\
          \"documentation\":\"<p>When specified, only returns vocabularies with the <code>VocabularyState</code> equal to the specified vocabulary state.</p>\"\
        },\
        \"NameContains\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>Returns vocabularies in the list whose name contains the specified string. The search is case-insensitive, <code>ListMedicalVocabularies</code> returns both \\\"vocabularyname\\\" and \\\"VocabularyName\\\" in the response list.</p>\"\
        }\
      }\
    },\
    ...
    \"ListVocabulariesRequest\":{\
      ...
      \"members\":{\
        ...
        \"NameContains\":{\
          \"shape\":\"VocabularyName\",\
          \"documentation\":\"<p>When specified, the vocabularies returned in the list are limited to vocabularies whose name contains the specified string. The search is case-insensitive, <code>ListVocabularies</code> returns both \\\"vocabularyname\\\" and \\\"VocabularyName\\\" in the response list.</p>\"\
        }\
      }\
    },\
    ...
    \"MedicalTranscriptionJob\":{\
      ...
      \"documentation\":\"<p>The data structure that containts the information for a medical transcription job.</p>\"\
    },\
    \"MedicalTranscriptionJobSummaries\":{\
      \"type\":\"list\",\
    ...
    \"StartTranscriptionJobRequest\":{\
      ...
      \"members\":{\
        \"TranscriptionJobName\":{\
          \"shape\":\"TranscriptionJobName\",\
          \"documentation\":\"<p>The name of the job. Note that you can't use the strings \\\".\\\" or \\\"..\\\" by themselves as the job name. The name must also be unique within an AWS account. If you try to create a transcription job with the same name as a previous transcription job you will receive a <code>ConflictException</code> error.</p>\"\
        },\
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
    ...
    \"UpdateMedicalVocabularyRequest\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code of the entries in the updated vocabulary. US English (en-US) is the only valid language code in Amazon Transcribe Medical.</p>\"\
        },\
        \"VocabularyFileUri\":{\
          \"shape\":\"Uri\",\
    ...
    \"UpdateMedicalVocabularyResponse\":{\
      ...
      \"members\":{\
        ...
        \"LanguageCode\":{\
          \"shape\":\"LanguageCode\",\
          \"documentation\":\"<p>The language code for the text file used to update the custom vocabulary. US English (en-US) is the only language supported in Amazon Transcribe Medical.</p>\"\
        },\
        \"LastModifiedTime\":{\
          \"shape\":\"DateTime\",\
          \"documentation\":\"<p>The date and time the vocabulary was updated.</p>\"\
        },\
        \"VocabularyState\":{\
          \"shape\":\"VocabularyState\",\
    ...
    \"UpdateVocabularyFilterRequest\":{\
      ...
      \"members\":{\
        \"VocabularyFilterName\":{\
          \"shape\":\"VocabularyFilterName\",\
          \"documentation\":\"<p>The name of the vocabulary filter to update. If you try to update a vocabulary filter with the same name as a previous vocabulary filter you will receive a <code>ConflictException</code> error.</p>\"\
        },\
        \"Words\":{\
          \"shape\":\"Words\",\
          \"documentation\":\"<p>The words to use in the vocabulary filter. Only use characters from the character set defined for custom vocabularies. For a list of character sets, see <a href=\\\"https://docs.aws.amazon.com/transcribe/latest/dg/how-vocabulary.html#charsets\\\">Character Sets for Custom Vocabularies</a>.</p> <p>If you provide a list of words in the <code>Words</code> parameter, you can't use the <code>VocabularyFilterFileUri</code> parameter.</p>\"\
