...
+ (NSValueTransformer *)onDemandSpecificationJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSEmrOnDemandProvisioningSpecification class]];
}
...
@implementation AWSEmrOnDemandProvisioningSpecification
...
+ (NSValueTransformer *)allocationStrategyJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"lowest-price"] == NSOrderedSame) {
            return @(AWSEmrOnDemandProvisioningAllocationStrategyLowestPrice);
        }
        return @(AWSEmrOnDemandProvisioningAllocationStrategyUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSEmrOnDemandProvisioningAllocationStrategyLowestPrice:
                return @"lowest-price";
            default:
                return nil;
        }
...
+ (NSValueTransformer *)allocationStrategyJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"capacity-optimized"] == NSOrderedSame) {
            return @(AWSEmrSpotProvisioningAllocationStrategyCapacityOptimized);
        }
        return @(AWSEmrSpotProvisioningAllocationStrategyUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSEmrSpotProvisioningAllocationStrategyCapacityOptimized:
