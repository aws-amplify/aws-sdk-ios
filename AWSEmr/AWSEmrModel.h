...
typedef NS_ENUM(NSInteger, AWSEmrOnDemandProvisioningAllocationStrategy) {
    AWSEmrOnDemandProvisioningAllocationStrategyUnknown,
    AWSEmrOnDemandProvisioningAllocationStrategyLowestPrice,
};
...
typedef NS_ENUM(NSInteger, AWSEmrSpotProvisioningAllocationStrategy) {
    AWSEmrSpotProvisioningAllocationStrategyUnknown,
    AWSEmrSpotProvisioningAllocationStrategyCapacityOptimized,
};
...
@class AWSEmrOnDemandProvisioningSpecification;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable maximumCoreCapacityUnits;
 ...
 */
@property (nonatomic, strong) AWSEmrOnDemandProvisioningSpecification * _Nullable onDemandSpecification;
...
/**
 <p> The launch specification for On-Demand instances in the instance fleet, which determines the allocation strategy. </p><note><p>The instance fleet configuration is available only in Amazon EMR versions 4.8.0 and later, excluding 5.0.x versions. On-Demand instances allocation strategy is available in Amazon EMR version 5.12.1 and later.</p></note>
 Required parameters: [AllocationStrategy]
 */
@interface AWSEmrOnDemandProvisioningSpecification : AWSModel
 ...
 */
@property (nonatomic, assign) AWSEmrOnDemandProvisioningAllocationStrategy allocationStrategy;
 ...
 */
@property (nonatomic, assign) AWSEmrSpotProvisioningAllocationStrategy allocationStrategy;
