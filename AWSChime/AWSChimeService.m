...
NSString *const AWSChimeSDKVersion = @"2.13.4";
...
- (AWSTask<AWSChimeCreateMeetingWithAttendeesResponse *> *)createMeetingWithAttendees:(AWSChimeCreateMeetingWithAttendeesRequest *)request {
    return [self invokeRequest:request
                    HTTPMethod:AWSHTTPMethodPOST
                     URLString:@"/meetings?operation=create-attendees"
                  targetPrefix:@""
                 operationName:@"CreateMeetingWithAttendees"
                   outputClass:[AWSChimeCreateMeetingWithAttendeesResponse class]];
}

- (void)createMeetingWithAttendees:(AWSChimeCreateMeetingWithAttendeesRequest *)request
     completionHandler:(void (^)(AWSChimeCreateMeetingWithAttendeesResponse *response, NSError *error))completionHandler {
    [[self createMeetingWithAttendees:request] continueWithBlock:^id _Nullable(AWSTask<AWSChimeCreateMeetingWithAttendeesResponse *> * _Nonnull task) {
        AWSChimeCreateMeetingWithAttendeesResponse *result = task.result;
        NSError *error = task.error;
