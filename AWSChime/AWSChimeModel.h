...
@class AWSChimeConversationRetentionSettings;
...
@class AWSChimeCreateMeetingWithAttendeesRequest;
@class AWSChimeCreateMeetingWithAttendeesResponse;
...
@class AWSChimeGetRetentionSettingsRequest;
@class AWSChimeGetRetentionSettingsResponse;
...
@class AWSChimePutRetentionSettingsRequest;
@class AWSChimePutRetentionSettingsResponse;
...
@class AWSChimeRetentionSettings;
@class AWSChimeRoom;
@class AWSChimeRoomMembership;
@class AWSChimeRoomRetentionSettings;
 ...
 */
@interface AWSChimeConversationRetentionSettings : AWSModel
 ...
 */
@interface AWSChimeCreateMeetingWithAttendeesRequest : AWSRequest
 ...
 */
@interface AWSChimeCreateMeetingWithAttendeesResponse : AWSModel
 ...
 */
@interface AWSChimeGetRetentionSettingsRequest : AWSRequest
 ...
 */
@interface AWSChimeGetRetentionSettingsResponse : AWSModel
 ...
 */
@property (nonatomic, strong) AWSChimeRetentionSettings * _Nullable retentionSettings;
 ...
 */
@interface AWSChimePutRetentionSettingsRequest : AWSRequest
 ...
 */
@interface AWSChimePutRetentionSettingsResponse : AWSModel
 ...
 */
@interface AWSChimeRetentionSettings : AWSModel


/**
 <p>The chat conversation retention settings.</p>
 */
@property (nonatomic, strong) AWSChimeConversationRetentionSettings * _Nullable conversationRetentionSettings;

/**
 <p>The chat room retention settings.</p>
 */
@property (nonatomic, strong) AWSChimeRoomRetentionSettings * _Nullable roomRetentionSettings;
 ...
 */
@interface AWSChimeRoomRetentionSettings : AWSModel
