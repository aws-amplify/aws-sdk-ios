...
@implementation AWSChimeConversationRetentionSettings
...
@implementation AWSChimeCreateMeetingWithAttendeesRequest
...
@implementation AWSChimeCreateMeetingWithAttendeesResponse
...
@implementation AWSChimeGetRetentionSettingsRequest
...
@implementation AWSChimeGetRetentionSettingsResponse
...
+ (NSValueTransformer *)retentionSettingsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSChimeRetentionSettings class]];
}
...
@implementation AWSChimePutRetentionSettingsRequest
...
@implementation AWSChimePutRetentionSettingsResponse
...
@implementation AWSChimeRetentionSettings
...
+ (NSValueTransformer *)conversationRetentionSettingsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSChimeConversationRetentionSettings class]];
}

+ (NSValueTransformer *)roomRetentionSettingsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSChimeRoomRetentionSettings class]];
}
...
@implementation AWSChimeRoomRetentionSettings
...
+ (NSValueTransformer *)streamingNotificationTargetsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSChimeStreamingNotificationTarget class]];
}

@end

@implementation AWSChimeStreamingNotificationTarget
...
+ (NSValueTransformer *)notificationTargetJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"EventBridge"] == NSOrderedSame) {
            return @(AWSChimeNotificationTargetEventBridge);
        }
        if ([value caseInsensitiveCompare:@"SNS"] == NSOrderedSame) {
            return @(AWSChimeNotificationTargetSns);
        }
        if ([value caseInsensitiveCompare:@"SQS"] == NSOrderedSame) {
            return @(AWSChimeNotificationTargetSqs);
        }
        return @(AWSChimeNotificationTargetUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSChimeNotificationTargetEventBridge:
                return @"EventBridge";
            case AWSChimeNotificationTargetSns:
                return @"SNS";
            case AWSChimeNotificationTargetSqs:
                return @"SQS";
            default:
                return nil;
        }
