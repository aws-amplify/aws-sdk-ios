...
- (void)testCreateMeetingWithAttendees {
    NSString *key = @"testCreateMeetingWithAttendees";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSChime ChimeForKey:key] createMeetingWithAttendees:[AWSChimeCreateMeetingWithAttendeesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCreateMeetingWithAttendeesCompletionHandler {
    NSString *key = @"testCreateMeetingWithAttendees";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
	...
	[[AWSChime ChimeForKey:key] createMeetingWithAttendees:[AWSChimeCreateMeetingWithAttendeesRequest new] completionHandler:^(AWSChimeCreateMeetingWithAttendeesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testGetRetentionSettings {
    NSString *key = @"testGetRetentionSettings";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSChime ChimeForKey:key] getRetentionSettings:[AWSChimeGetRetentionSettingsRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetRetentionSettingsCompletionHandler {
    NSString *key = @"testGetRetentionSettings";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
	...
	[[AWSChime ChimeForKey:key] getRetentionSettings:[AWSChimeGetRetentionSettingsRequest new] completionHandler:^(AWSChimeGetRetentionSettingsResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testPutRetentionSettings {
    NSString *key = @"testPutRetentionSettings";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSChime ChimeForKey:key] putRetentionSettings:[AWSChimePutRetentionSettingsRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testPutRetentionSettingsCompletionHandler {
    NSString *key = @"testPutRetentionSettings";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSChime registerChimeWithConfiguration:configuration forKey:key];
	...
	[[AWSChime ChimeForKey:key] putRetentionSettings:[AWSChimePutRetentionSettingsRequest new] completionHandler:^(AWSChimePutRetentionSettingsResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
