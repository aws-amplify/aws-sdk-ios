...
@interface AWSAWSComprehendMedicalResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSAWSComprehendMedicalResources

+ (instancetype)sharedInstance {
    static AWSAWSComprehendMedicalResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSAWSComprehendMedicalResources new];
    });
