...
+ (NSValueTransformer *)modelClientConfigJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSSagemakerModelClientConfig class]];
}
...
@implementation AWSSagemakerModelClientConfig
