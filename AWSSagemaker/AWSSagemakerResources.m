...
@interface AWSSagemakerResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSSagemakerResources

+ (instancetype)sharedInstance {
    static AWSSagemakerResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSSagemakerResources new];
    });
  ...
  \"shapes\":{\
    ...
    \"RenderUiTemplateRequest\":{\
      ...
      \"members\":{\
        ...
        \"HumanTaskUiArn\":{\
          \"shape\":\"HumanTaskUiArn\",\
          \"documentation\":\"<p>The <code>HumanTaskUiArn</code> of the worker UI that you want to render. Do not provide a <code>HumanTaskUiArn</code> if you use the <code>UiTemplate</code> parameter.</p>\"\
        }\
      }\
    },\
    ...
    \"UiConfig\":{\
      ...
      \"members\":{\
        ...
        \"HumanTaskUiArn\":{\
          \"shape\":\"HumanTaskUiArn\",\
          \"documentation\":\"<p>The ARN of the worker task template used to render the worker UI and tools for labeling job tasks. Do not use this parameter if you use UiTemplateS3Uri.</p>\"\
        }\
      },\
