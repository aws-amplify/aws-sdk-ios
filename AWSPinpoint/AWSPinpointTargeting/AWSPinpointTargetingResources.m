...
\
  ...
  \"shapes\": {\
    ...
    \"JourneyExecutionMetricsResponse\": {\
      ...
      \"documentation\": \"<p>Provides the results of a query that retrieved the data for a standard execution metric that applies to a journey.</p>\",\
      \"required\": [\
        \"Metrics\",\
        \"JourneyId\",\
        \"LastEvaluatedTime\",\
    ...
    \"TemplateConfiguration\": {\
      ...
      \"documentation\": \"<p>Specifies the message template for each type of channel.</p>\"\
    },\
    \"TemplateResponse\": {\
      \"type\": \"structure\",\
      \"members\": {\
    ...
    \"WaitTime\": {\
      ...
      \"members\": {\
        \"WaitFor\": {\
          \"shape\": \"__string\",\
          \"documentation\": \"<p>The amount of time, as a duration in ISO 8601 format, to wait before determining whether the activity's conditions have been met or moving participants to the next activity in the journey.</p>\"\
        },\
        \"WaitUntil\": {\
          \"shape\": \"__string\",\
