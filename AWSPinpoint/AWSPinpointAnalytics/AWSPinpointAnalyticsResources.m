...
@implementation AWSPinpointAnalyticsResources

+ (instancetype)sharedInstance {
    static AWSPinpointAnalyticsResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSPinpointAnalyticsResources new];
    });
