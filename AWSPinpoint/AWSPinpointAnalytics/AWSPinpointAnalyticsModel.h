...
@class AWSPinpointAnalyticsEvent;
@class AWSPinpointAnalyticsPutEventsInput;
@class AWSPinpointAnalyticsSession;
 ...
 */
@interface AWSPinpointAnalyticsEvent : AWSModel
 ...
 */
@property (nonatomic, strong) AWSPinpointAnalyticsSession * _Nullable session;
 ...
 */
@interface AWSPinpointAnalyticsPutEventsInput : AWSRequest
 ...
 */
@property (nonatomic, strong) NSArray<AWSPinpointAnalyticsEvent *> * _Nullable events;
 ...
 */
@interface AWSPinpointAnalyticsSession : AWSModel
