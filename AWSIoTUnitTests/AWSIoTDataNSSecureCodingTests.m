...
- (void) test_AWSIoTDataDeleteThingShadowResponse {
    [self validateSecureCodingForClass:[AWSIoTDataDeleteThingShadowResponse class]];
}
...
- (void) test_AWSIoTDataGetThingShadowResponse {
    [self validateSecureCodingForClass:[AWSIoTDataGetThingShadowResponse class]];
}
...
- (void) test_AWSIoTDataPublishRequest {
    [self validateSecureCodingForClass:[AWSIoTDataPublishRequest class]];
}

- (void) test_AWSIoTDataUpdateThingShadowRequest {
    [self validateSecureCodingForClass:[AWSIoTDataUpdateThingShadowRequest class]];
}

- (void) test_AWSIoTDataUpdateThingShadowResponse {
    [self validateSecureCodingForClass:[AWSIoTDataUpdateThingShadowResponse class]];
}
