...
@interface AWSopsworks-cmResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSopsworks-cmResources

+ (instancetype)sharedInstance {
    static AWSopsworks-cmResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSopsworks-cmResources new];
    });
