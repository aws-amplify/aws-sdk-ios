...
- (void)testDeleteColumnStatisticsForPartition {
    NSString *key = @"testDeleteColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] deleteColumnStatisticsForPartition:[AWSGlueDeleteColumnStatisticsForPartitionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteColumnStatisticsForPartitionCompletionHandler {
    NSString *key = @"testDeleteColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] deleteColumnStatisticsForPartition:[AWSGlueDeleteColumnStatisticsForPartitionRequest new] completionHandler:^(AWSGlueDeleteColumnStatisticsForPartitionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDeleteColumnStatisticsForTable {
    NSString *key = @"testDeleteColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] deleteColumnStatisticsForTable:[AWSGlueDeleteColumnStatisticsForTableRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteColumnStatisticsForTableCompletionHandler {
    NSString *key = @"testDeleteColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] deleteColumnStatisticsForTable:[AWSGlueDeleteColumnStatisticsForTableRequest new] completionHandler:^(AWSGlueDeleteColumnStatisticsForTableResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testGetColumnStatisticsForPartition {
    NSString *key = @"testGetColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] getColumnStatisticsForPartition:[AWSGlueGetColumnStatisticsForPartitionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetColumnStatisticsForPartitionCompletionHandler {
    NSString *key = @"testGetColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] getColumnStatisticsForPartition:[AWSGlueGetColumnStatisticsForPartitionRequest new] completionHandler:^(AWSGlueGetColumnStatisticsForPartitionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testGetColumnStatisticsForTable {
    NSString *key = @"testGetColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] getColumnStatisticsForTable:[AWSGlueGetColumnStatisticsForTableRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetColumnStatisticsForTableCompletionHandler {
    NSString *key = @"testGetColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] getColumnStatisticsForTable:[AWSGlueGetColumnStatisticsForTableRequest new] completionHandler:^(AWSGlueGetColumnStatisticsForTableResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUpdateColumnStatisticsForPartition {
    NSString *key = @"testUpdateColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] updateColumnStatisticsForPartition:[AWSGlueUpdateColumnStatisticsForPartitionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUpdateColumnStatisticsForPartitionCompletionHandler {
    NSString *key = @"testUpdateColumnStatisticsForPartition";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] updateColumnStatisticsForPartition:[AWSGlueUpdateColumnStatisticsForPartitionRequest new] completionHandler:^(AWSGlueUpdateColumnStatisticsForPartitionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUpdateColumnStatisticsForTable {
    NSString *key = @"testUpdateColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSGlue GlueForKey:key] updateColumnStatisticsForTable:[AWSGlueUpdateColumnStatisticsForTableRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUpdateColumnStatisticsForTableCompletionHandler {
    NSString *key = @"testUpdateColumnStatisticsForTable";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSGlue registerGlueWithConfiguration:configuration forKey:key];
	...
	[[AWSGlue GlueForKey:key] updateColumnStatisticsForTable:[AWSGlueUpdateColumnStatisticsForTableRequest new] completionHandler:^(AWSGlueUpdateColumnStatisticsForTableResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
