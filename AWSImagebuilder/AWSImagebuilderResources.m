...
@interface AWSImagebuilderResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSImagebuilderResources

+ (instancetype)sharedInstance {
    static AWSImagebuilderResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSImagebuilderResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"documentation\":\"<p>EC2 Image Builder is a fully managed AWS service that makes it easier to automate the creation, management, and deployment of customized, secure, and up-to-date âgoldenâ server images that are pre-installed and pre-configured with software and settings to meet specific IT standards.</p>\"\
}\
";
}
