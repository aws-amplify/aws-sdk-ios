  ...
  \"shapes\":{\
    ...
    \"PutAccountPolicyRequest\":{\
      ...
      \"members\":{\
        ...
        \"scope\":{\
          \"shape\":\"Scope\",\
          \"documentation\":\"<p>Currently the only valid value for this parameter is <code>GLOBAL</code>, which specifies that the data protection policy applies to all log groups in the account. If you omit this parameter, the default of <code>GLOBAL</code> is used.</p>\"\
        }\
      }\
    },\
