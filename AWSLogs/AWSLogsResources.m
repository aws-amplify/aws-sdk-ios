...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DisassociateKmsKey\":{\
      ...
      \"documentation\":\"<p>Disassociates the associated Key Management Service customer master key (CMK) from the specified log group.</p> <p>After the KMS CMK is disassociated from the log group, CloudWatch Logs stops encrypting newly ingested data for the log group. All previously ingested data remains encrypted, and CloudWatch Logs requires permissions for the CMK whenever the encrypted data is requested.</p> <p>Note that it can take up to 5 minutes for this operation to take effect.</p>\"\
    },\
    \"FilterLogEvents\":{\
    ...
    \"PutRetentionPolicy\":{\
      ...
      \"documentation\":\"<p>Sets the retention of the specified log group. A retention policy allows you to configure the number of days for which to retain log events in the specified log group.</p> <note> <p>CloudWatch Logs doesnât immediately delete log events when they reach their retention setting. It typically takes up to 72 hours after that before log events are deleted, but in rare situations might take longer.</p> <p>This means that if you change a log group to have a longer retention setting when it contains log events that are past the expiration date, but havenât been actually deleted, those log events will take up to 72 hours to be deleted after the new retention date is reached. To make sure that log data is deleted permanently, keep a log group at its lower retention setting until 72 hours has passed after the end of the previous retention period, or you have confirmed that the older log events are deleted. </p> </note>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"CreateExportTaskRequest\":{\
      ...
      \"members\":{\
        ...
        \"to\":{\
          \"shape\":\"Timestamp\",\
          \"documentation\":\"<p>The end time of the range for the request, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. Events with a timestamp later than this time are not exported.</p> <p>You must specify a time that is not earlier than when this log group was created.</p>\"\
        },\
        \"destination\":{\
    ...
    \"CreateLogGroupRequest\":{\
      ...
      \"members\":{\
        ...
        \"kmsKeyId\":{\
          \"shape\":\"KmsKeyId\",\
          \"documentation\":\"<p>The Amazon Resource Name (ARN) of the CMK to use when encrypting log data. For more information, see <a href=\\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms\\\">Amazon Resource Names - Key Management Service</a>.</p>\"\
        },\
        \"tags\":{\
          \"shape\":\"Tags\",\
          \"documentation\":\"<p>The key-value pairs to use for the tags.</p> <p>CloudWatch Logs doesnât support IAM policies that prevent users from assigning specified tags to log groups using the <code>aws:Resource/<i>key-name</i> </code> or <code>aws:TagKeys</code> condition keys. For more information about using tags to control access, see <a href=\\\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html\\\">Controlling access to Amazon Web Services resources using tags</a>.</p>\"\
        }\
      }\
    },\
    ...
    \"UnrecognizedClientException\":{\
      ...
      \"documentation\":\"<p>The most likely cause is an invalid Amazon Web Services access key ID or secret key.</p>\",\
      \"exception\":true\
    },\
