...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeleteAccountPolicy\":{\
      ...
      \"documentation\":\"<p>Deletes a CloudWatch Logs account policy.</p> <p>To use this operation, you must be signed on with the <code>logs:DeleteDataProtectionPolicy</code> and <code>logs:DeleteAccountPolicy</code> permissions.</p>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"DeleteAccountPolicyRequest\":{\
      ...
      \"members\":{\
        ...
        \"policyType\":{\
          \"shape\":\"PolicyType\",\
          \"documentation\":\"<p>The type of policy to delete. Currently, the only valid value is <code>DATA_PROTECTION_POLICY</code>.</p>\"\
        }\
      }\
    },\
    ...
    \"DescribeAccountPoliciesRequest\":{\
      ...
      \"members\":{\
        \"policyType\":{\
          \"shape\":\"PolicyType\",\
          \"documentation\":\"<p>Use this parameter to limit the returned policies to only the policies that match the policy type that you specify. Currently, the only valid value is <code>DATA_PROTECTION_POLICY</code>.</p>\"\
        },\
        \"policyName\":{\
          \"shape\":\"PolicyName\",\
    ...
    \"PutAccountPolicyRequest\":{\
      ...
      \"members\":{\
        ...
        \"policyType\":{\
          \"shape\":\"PolicyType\",\
          \"documentation\":\"<p>Currently the only valid value for this parameter is <code>DATA_PROTECTION_POLICY</code>.</p>\"\
        },\
        \"scope\":{\
          \"shape\":\"Scope\",\
    ...
    \"StartLiveTailRequest\":{\
      ...
      \"members\":{\
        ...
        \"logStreamNames\":{\
          \"shape\":\"InputLogStreamNames\",\
          \"documentation\":\"<p>If you specify this parameter, then only log events in the log streams that you specify here are included in the Live Tail session.</p> <note> <p>You can specify this parameter only if you specify only one log group in <code>logGroupIdentifiers</code>.</p> </note>\"\
        },\
        \"logStreamNamePrefixes\":{\
          \"shape\":\"InputLogStreamNames\",\
          \"documentation\":\"<p>If you specify this parameter, then only log events in the log streams that have names that start with the prefixes that you specify here are included in the Live Tail session.</p> <note> <p>You can specify this parameter only if you specify only one log group in <code>logGroupIdentifiers</code>.</p> </note>\"\
        },\
        \"logEventFilterPattern\":{\
          \"shape\":\"FilterPattern\",\
