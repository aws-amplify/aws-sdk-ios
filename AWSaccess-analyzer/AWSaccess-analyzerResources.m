...
@interface AWSaccess-analyzerResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSaccess-analyzerResources

+ (instancetype)sharedInstance {
    static AWSaccess-analyzerResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSaccess-analyzerResources new];
    });
