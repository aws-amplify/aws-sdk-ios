  ...
  \"shapes\":{\
    ...
    \"SetUserPoolMfaConfigRequest\":{\
      ...
      \"members\":{\
        ...
        \"MfaConfiguration\":{\
          \"shape\":\"UserPoolMfaType\",\
          \"documentation\":\"<p>The MFA configuration. If you set the MfaConfiguration value to âONâ, only users with an MFA factor set up can sign in. To learn more, see <a href=\\\"cognito/latest/developerguide/user-pool-settings-mfa.html\\\">Adding Multi-Factor Authentication (MFA) to a User Pool</a>. Valid values include:</p> <ul> <li> <p> <code>OFF</code> MFA won't be used for any users.</p> </li> <li> <p> <code>ON</code> MFA is required for all users to sign in.</p> </li> <li> <p> <code>OPTIONAL</code> MFA will be required only for individual users who have an MFA factor activated.</p> </li> </ul>\"\
        }\
      }\
    },\
    ...
    \"UsernameConfigurationType\":{\
      ...
      \"members\":{\
        \"CaseSensitive\":{\
          \"shape\":\"WrappedBooleanType\",\
          \"documentation\":\"<p>Specifies whether username case sensitivity will be applied for all users in the user pool through Amazon Cognito APIs.</p> <p>Valid values include:</p> <ul> <li> <p> <b> <code>True</code> </b>: Enables case sensitivity for all username input. When this option is set to <code>True</code>, users must sign in using the exact capitalization of their given username, such as âUserNameâ. This is the default value.</p> </li> <li> <p> <b> <code>False</code> </b>: Enables case insensitivity for all username input. For example, when this option is set to <code>False</code>, users can sign in using either \\\"username\\\" or \\\"Username\\\". This option also enables both <code>preferred_username</code> and <code>email</code> alias to be case insensitive, in addition to the <code>username</code> attribute.</p> </li> </ul>\"\
        }\
      },\
