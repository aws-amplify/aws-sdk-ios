Pod::Spec.new do |s|
   ...
   s.source       = { :git => 'https://github.com/aws/aws-sdk-ios.git',
                      :tag => s.version}
   s.requires_arc = true
   s.dependency 'AWSCore', '2.6.1'
   s.dependency 'AWSAuthCore', '2.6.1'
   s.source_files = 'AWSAuthSDK/Sources/AWSAuthUI/*.{h,m}', 'AWSAuthSDK/Sources/AWSAuthUI/**/*.{h,m}'
   ...
   s.private_header_files = 'AWSAuthSDK/Sources/AWSUserPoolsSignIn/**/AWSFormTableCell.h', 'AWSAuthSDK/Sources/AWSAuthUI/AWSSignInViewController.h', 'AWSAuthSDK/Sources/AWSUserPoolsSignIn/**/AWSTableInputCell.h', 'AWSAuthSDK/Sources/AWSUserPoolsSignIn/**/AWSFormTableDelegate.h', 'AWSAuthSDK/Sources/AWSUserPoolsSignIn/**/AWSUserPoolsUIHelper.h'
