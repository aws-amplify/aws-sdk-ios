...
@interface AWSmediapackage-vodResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSmediapackage-vodResources

+ (instancetype)sharedInstance {
    static AWSmediapackage-vodResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSmediapackage-vodResources new];
    });
