...
@implementation AWSAppconfigCreateHostedConfigurationVersionRequest
...
@implementation AWSAppconfigDeleteHostedConfigurationVersionRequest
...
@implementation AWSAppconfigGetHostedConfigurationVersionRequest
...
@implementation AWSAppconfigHostedConfigurationVersion
...
@implementation AWSAppconfigHostedConfigurationVersionSummary
...
@implementation AWSAppconfigHostedConfigurationVersions
...
+ (NSValueTransformer *)itemsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSAppconfigHostedConfigurationVersionSummary class]];
}
...
@implementation AWSAppconfigListHostedConfigurationVersionsRequest
