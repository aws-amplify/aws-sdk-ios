...
typedef NS_ENUM(NSInteger, AWSAppconfigErrorType) {
    ...
    AWSAppconfigErrorPayloadTooLarge,
    AWSAppconfigErrorResourceNotFound,
    AWSAppconfigErrorServiceQuotaExceeded,
};

typedef NS_ENUM(NSInteger, AWSAppconfigBytesMeasure) {
    AWSAppconfigBytesMeasureUnknown,
    AWSAppconfigBytesMeasureKilobytes,
};
...
@class AWSAppconfigCreateHostedConfigurationVersionRequest;
...
@class AWSAppconfigDeleteHostedConfigurationVersionRequest;
...
@class AWSAppconfigGetHostedConfigurationVersionRequest;
@class AWSAppconfigHostedConfigurationVersion;
@class AWSAppconfigHostedConfigurationVersionSummary;
@class AWSAppconfigHostedConfigurationVersions;
...
@class AWSAppconfigListHostedConfigurationVersionsRequest;
 ...
 */
@interface AWSAppconfigCreateHostedConfigurationVersionRequest : AWSRequest
 ...
 */
@interface AWSAppconfigDeleteHostedConfigurationVersionRequest : AWSRequest
 ...
 */
@interface AWSAppconfigGetHostedConfigurationVersionRequest : AWSRequest
 ...
 */
@interface AWSAppconfigHostedConfigurationVersion : AWSModel
 ...
 */
@interface AWSAppconfigHostedConfigurationVersionSummary : AWSModel
 ...
 */
@interface AWSAppconfigHostedConfigurationVersions : AWSModel


/**
 <p>The elements from this collection.</p>
 */
@property (nonatomic, strong) NSArray<AWSAppconfigHostedConfigurationVersionSummary *> * _Nullable items;
 ...
 */
@interface AWSAppconfigListHostedConfigurationVersionsRequest : AWSRequest
