  ...
  \"shapes\":{\
    ...
    \"AssumeRoleWithWebIdentityRequest\":{\
      ...
      \"members\":{\
        ...
        \"WebIdentityToken\":{\
          ...
          \"documentation\":\"<p>The OAuth 2.0 access token or OpenID Connect ID token that is provided by the identity provider. Your application must get this token by authenticating the user who is using your application with a web identity provider before the application makes an <code>AssumeRoleWithWebIdentity</code> call. Only tokens with RSA algorithms (RS256) are supported.</p>\"\
        },\
        \"ProviderId\":{\
          \"shape\":\"urlType\",\
    ...
    \"ProvidedContext\":{\
      ...
      \"members\":{\
        \"ProviderArn\":{\
          \"shape\":\"arnType\",\
          \"documentation\":\"<p>The context provider ARN from which the trusted context assertion was generated.</p>\"\
        },\
        \"ContextAssertion\":{\
          \"shape\":\"contextAssertionType\",\
          \"documentation\":\"<p>The signed and encrypted trusted context assertion generated by the context provider. The trusted context assertion is signed and encrypted by Amazon Web Services STS.</p>\"\
        }\
      },\
      \"documentation\":\"<p>Contains information about the provided context. This includes the signed and encrypted trusted context assertion and the context provider ARN from which the trusted context assertion was generated.</p>\"\
    },\
