...
typedef NS_ENUM(NSInteger, AWSkinesisvideoErrorType) {
    ...
    AWSkinesisvideoErrorInvalidCodecPrivateData,
    AWSkinesisvideoErrorInvalidMediaFrame,
    AWSkinesisvideoErrorMissingCodecPrivateData,
    AWSkinesisvideoErrorNoDataRetention,
    AWSkinesisvideoErrorNotAuthorized,
    AWSkinesisvideoErrorResourceNotFound,
    AWSkinesisvideoErrorUnsupportedStreamMediaType,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoClipFragmentSelectorType) {
    AWSkinesisvideoClipFragmentSelectorTypeUnknown,
    AWSkinesisvideoClipFragmentSelectorTypeProducerTimestamp,
    AWSkinesisvideoClipFragmentSelectorTypeServerTimestamp,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoContainerFormat) {
    AWSkinesisvideoContainerFormatUnknown,
    AWSkinesisvideoContainerFormatFragmentedMp4,
    AWSkinesisvideoContainerFormatMpegTs,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoDASHDisplayFragmentNumber) {
    AWSkinesisvideoDASHDisplayFragmentNumberUnknown,
    AWSkinesisvideoDASHDisplayFragmentNumberAlways,
    AWSkinesisvideoDASHDisplayFragmentNumberNever,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoDASHDisplayFragmentTimestamp) {
    AWSkinesisvideoDASHDisplayFragmentTimestampUnknown,
    AWSkinesisvideoDASHDisplayFragmentTimestampAlways,
    AWSkinesisvideoDASHDisplayFragmentTimestampNever,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoDASHFragmentSelectorType) {
    AWSkinesisvideoDASHFragmentSelectorTypeUnknown,
    AWSkinesisvideoDASHFragmentSelectorTypeProducerTimestamp,
    AWSkinesisvideoDASHFragmentSelectorTypeServerTimestamp,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoDASHPlaybackMode) {
    AWSkinesisvideoDASHPlaybackModeUnknown,
    AWSkinesisvideoDASHPlaybackModeLive,
    AWSkinesisvideoDASHPlaybackModeLiveReplay,
    AWSkinesisvideoDASHPlaybackModeOnDemand,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoFragmentSelectorType) {
    AWSkinesisvideoFragmentSelectorTypeUnknown,
    AWSkinesisvideoFragmentSelectorTypeProducerTimestamp,
    AWSkinesisvideoFragmentSelectorTypeServerTimestamp,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoHLSDiscontinuityMode) {
    AWSkinesisvideoHLSDiscontinuityModeUnknown,
    AWSkinesisvideoHLSDiscontinuityModeAlways,
    AWSkinesisvideoHLSDiscontinuityModeNever,
    AWSkinesisvideoHLSDiscontinuityModeOnDiscontinuity,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoHLSDisplayFragmentTimestamp) {
    AWSkinesisvideoHLSDisplayFragmentTimestampUnknown,
    AWSkinesisvideoHLSDisplayFragmentTimestampAlways,
    AWSkinesisvideoHLSDisplayFragmentTimestampNever,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoHLSFragmentSelectorType) {
    AWSkinesisvideoHLSFragmentSelectorTypeUnknown,
    AWSkinesisvideoHLSFragmentSelectorTypeProducerTimestamp,
    AWSkinesisvideoHLSFragmentSelectorTypeServerTimestamp,
};

typedef NS_ENUM(NSInteger, AWSkinesisvideoHLSPlaybackMode) {
    AWSkinesisvideoHLSPlaybackModeUnknown,
    AWSkinesisvideoHLSPlaybackModeLive,
    AWSkinesisvideoHLSPlaybackModeLiveReplay,
    AWSkinesisvideoHLSPlaybackModeOnDemand,
};

@class AWSkinesisvideoClipFragmentSelector;
@class AWSkinesisvideoClipTimestampRange;
@class AWSkinesisvideoDASHFragmentSelector;
@class AWSkinesisvideoDASHTimestampRange;
@class AWSkinesisvideoFragment;
@class AWSkinesisvideoFragmentSelector;
@class AWSkinesisvideoGetClipInput;
@class AWSkinesisvideoGetClipOutput;
@class AWSkinesisvideoGetDASHStreamingSessionURLInput;
@class AWSkinesisvideoGetDASHStreamingSessionURLOutput;
@class AWSkinesisvideoGetHLSStreamingSessionURLInput;
@class AWSkinesisvideoGetHLSStreamingSessionURLOutput;
@class AWSkinesisvideoGetMediaForFragmentListInput;
@class AWSkinesisvideoGetMediaForFragmentListOutput;
@class AWSkinesisvideoHLSFragmentSelector;
@class AWSkinesisvideoHLSTimestampRange;
@class AWSkinesisvideoListFragmentsInput;
@class AWSkinesisvideoListFragmentsOutput;
@class AWSkinesisvideoTimestampRange;
 ...
 */
@interface AWSkinesisvideoClipFragmentSelector : AWSModel


/**
 <p>The origin of the timestamps to use (Server or Producer).</p>
 */
@property (nonatomic, assign) AWSkinesisvideoClipFragmentSelectorType fragmentSelectorType;

/**
 <p>The range of timestamps to return.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoClipTimestampRange * _Nullable timestampRange;
 ...
 */
@interface AWSkinesisvideoDASHFragmentSelector : AWSModel
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoDASHFragmentSelectorType fragmentSelectorType;
 ...
 */
@property (nonatomic, strong) AWSkinesisvideoDASHTimestampRange * _Nullable timestampRange;
 ...
 */
@interface AWSkinesisvideoDASHTimestampRange : AWSModel
 ...
 */
@interface AWSkinesisvideoFragment : AWSModel
...
/**
 ...
 Required parameters: [FragmentSelectorType, TimestampRange]
 */
@interface AWSkinesisvideoFragmentSelector : AWSModel


/**
 <p>The origin of the timestamps to use (Server or Producer).</p>
 */
@property (nonatomic, assign) AWSkinesisvideoFragmentSelectorType fragmentSelectorType;

/**
 <p>The range of timestamps to return.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoTimestampRange * _Nullable timestampRange;
 ...
 */
@interface AWSkinesisvideoGetClipInput : AWSRequest


/**
 <p>The time range of the requested clip and the source of the timestamps.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoClipFragmentSelector * _Nullable clipFragmentSelector;
 ...
 */
@interface AWSkinesisvideoGetClipOutput : AWSModel
...
/**
 <p>Traditional MP4 file that contains the media clip from the specified video stream. The output will contain the first 100 MB or the first 200 fragments from the specified start timestamp. For more information, see <a href="Kinesis Video Streams Limits">Kinesis Video Streams Limits</a>. </p>
 */
 ...
 */
@interface AWSkinesisvideoGetDASHStreamingSessionURLInput : AWSRequest
 ...
 */
@property (nonatomic, strong) AWSkinesisvideoDASHFragmentSelector * _Nullable DASHFragmentSelector;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoDASHDisplayFragmentNumber displayFragmentNumber;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoDASHDisplayFragmentTimestamp displayFragmentTimestamp;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoDASHPlaybackMode playbackMode;
 ...
 */
@interface AWSkinesisvideoGetDASHStreamingSessionURLOutput : AWSModel
 ...
 */
@interface AWSkinesisvideoGetHLSStreamingSessionURLInput : AWSRequest
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoContainerFormat containerFormat;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoHLSDiscontinuityMode discontinuityMode;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoHLSDisplayFragmentTimestamp displayFragmentTimestamp;
...
/**
 <p>The time range of the requested fragment and the source of the timestamps.</p><p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code/><code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoHLSFragmentSelector * _Nullable HLSFragmentSelector;
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoHLSPlaybackMode playbackMode;
 ...
 */
@interface AWSkinesisvideoGetHLSStreamingSessionURLOutput : AWSModel
 ...
 */
@interface AWSkinesisvideoGetMediaForFragmentListInput : AWSRequest
 ...
 */
@interface AWSkinesisvideoGetMediaForFragmentListOutput : AWSModel
...
/**
 <p>Contains the range of timestamps for the requested media, and the source of the timestamps.</p>
 */
@interface AWSkinesisvideoHLSFragmentSelector : AWSModel
 ...
 */
@property (nonatomic, assign) AWSkinesisvideoHLSFragmentSelectorType fragmentSelectorType;

/**
 <p>The start and end of the timestamp range for the requested media.</p><p>This value should not be present if <code>PlaybackType</code> is <code>LIVE</code>.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoHLSTimestampRange * _Nullable timestampRange;
 ...
 */
@interface AWSkinesisvideoHLSTimestampRange : AWSModel
 ...
 */
@interface AWSkinesisvideoListFragmentsInput : AWSRequest


/**
 <p>Describes the timestamp range and timestamp origin for the range of fragments to return.</p>
 */
@property (nonatomic, strong) AWSkinesisvideoFragmentSelector * _Nullable fragmentSelector;
 ...
 */
@interface AWSkinesisvideoListFragmentsOutput : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSkinesisvideoFragment *> * _Nullable fragments;
...
/**
 ...
 Required parameters: [StartTimestamp, EndTimestamp]
 */
@interface AWSkinesisvideoTimestampRange : AWSModel
