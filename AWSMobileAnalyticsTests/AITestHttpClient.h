...
@interface AITestHttpClient : AWSMobileAnalyticsDefaultHttpClient


+(AITestHttpClient *) httpClient;
+(AITestHttpClient *) httpClientWithResponse:(id<AWSMobileAnalyticsResponse>)response;

@property (nonatomic, readwrite) id<AWSMobileAnalyticsRequest> request;

@property (nonatomic, readwrite) AWSMobileAnalyticsDefaultResponse *response;
