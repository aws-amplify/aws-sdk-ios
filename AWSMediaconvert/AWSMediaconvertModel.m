...
@implementation AWSMediaconvertNexGuardFileMarkerSettings
...
+ (NSValueTransformer *)strengthJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        if ([value caseInsensitiveCompare:@"LIGHTEST"] == NSOrderedSame) {
            return @(AWSMediaconvertWatermarkingStrengthLightest);
        }
        if ([value caseInsensitiveCompare:@"LIGHTER"] == NSOrderedSame) {
            return @(AWSMediaconvertWatermarkingStrengthLighter);
        }
        if ([value caseInsensitiveCompare:@"DEFAULT"] == NSOrderedSame) {
            return @(AWSMediaconvertWatermarkingStrengthDefault);
        }
        if ([value caseInsensitiveCompare:@"STRONGER"] == NSOrderedSame) {
            return @(AWSMediaconvertWatermarkingStrengthStronger);
        }
        if ([value caseInsensitiveCompare:@"STRONGEST"] == NSOrderedSame) {
            return @(AWSMediaconvertWatermarkingStrengthStrongest);
        }
        return @(AWSMediaconvertWatermarkingStrengthUnknown);
    } reverseBlock:^NSString *(NSNumber *value) {
        switch ([value integerValue]) {
            case AWSMediaconvertWatermarkingStrengthLightest:
                return @"LIGHTEST";
            case AWSMediaconvertWatermarkingStrengthLighter:
                return @"LIGHTER";
            case AWSMediaconvertWatermarkingStrengthDefault:
                return @"DEFAULT";
            case AWSMediaconvertWatermarkingStrengthStronger:
                return @"STRONGER";
            case AWSMediaconvertWatermarkingStrengthStrongest:
                return @"STRONGEST";
            default:
                return nil;
        }
...
@implementation AWSMediaconvertPartnerWatermarking
...
+ (NSValueTransformer *)nexguardFileMarkerSettingsJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSMediaconvertNexGuardFileMarkerSettings class]];
}
...
+ (NSValueTransformer *)partnerWatermarkingJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSMediaconvertPartnerWatermarking class]];
}
