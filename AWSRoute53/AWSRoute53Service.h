...
/**
 ...
 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSRoute53AssociateVPCWithHostedZoneResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSRoute53ErrorDomain` domain and the following error code: `AWSRoute53ErrorNoSuchHostedZone`, `AWSRoute53ErrorNotAuthorized`, `AWSRoute53ErrorInvalidVPCId`, `AWSRoute53ErrorInvalidInput`, `AWSRoute53ErrorPublicZoneVPCAssociation`, `AWSRoute53ErrorConflictingDomainExists`, `AWSRoute53ErrorLimitsExceeded`, `AWSRoute53ErrorPriorRequestNotComplete`.
...
/**
 ...
 @param request A container for the necessary parameters to execute the ListHostedZonesByVPC service method.

 @return An instance of `AWSTask`. On successful execution, `task.result` will contain an instance of `AWSRoute53ListHostedZonesByVPCResponse`. On failed execution, `task.error` may contain an `NSError` with `AWSRoute53ErrorDomain` domain and the following error code: `AWSRoute53ErrorInvalidInput`, `AWSRoute53ErrorInvalidPaginationToken`.
 
 @see AWSRoute53ListHostedZonesByVPCRequest
 @see AWSRoute53ListHostedZonesByVPCResponse
 */
...
/**
 ...
 @param completionHandler The completion handler to call when the load request is complete.
                          `response` - A response object, or `nil` if the request failed.
                          `error` - An error object that indicates why the request failed, or `nil` if the request was successful. On failed execution, `error` may contain an `NSError` with `AWSRoute53ErrorDomain` domain and the following error code: `AWSRoute53ErrorInvalidInput`, `AWSRoute53ErrorInvalidPaginationToken`.
 
 @see AWSRoute53ListHostedZonesByVPCRequest
 @see AWSRoute53ListHostedZonesByVPCResponse
 */
- (void)listHostedZonesByVPC:(AWSRoute53ListHostedZonesByVPCRequest *)request completionHandler:(void (^ _Nullable)(AWSRoute53ListHostedZonesByVPCResponse * _Nullable response, NSError * _Nullable error))completionHandler;
