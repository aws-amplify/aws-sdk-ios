...
@implementation AWSRoute53HostedZoneOwner
...
@implementation AWSRoute53HostedZoneSummary
...
+ (NSValueTransformer *)ownerJSONTransformer {
    return [NSValueTransformer awsmtl_JSONDictionaryTransformerWithModelClass:[AWSRoute53HostedZoneOwner class]];
}
...
@implementation AWSRoute53ListHostedZonesByVPCRequest
...
@implementation AWSRoute53ListHostedZonesByVPCResponse
...
+ (NSValueTransformer *)hostedZoneSummariesJSONTransformer {
    return [NSValueTransformer awsmtl_JSONArrayTransformerWithModelClass:[AWSRoute53HostedZoneSummary class]];
}
