...
@class AWSRoute53HostedZoneOwner;
@class AWSRoute53HostedZoneSummary;
...
@class AWSRoute53ListHostedZonesByVPCRequest;
@class AWSRoute53ListHostedZonesByVPCResponse;
 ...
 */
@interface AWSRoute53HostedZoneOwner : AWSModel
 ...
 */
@property (nonatomic, strong) NSString * _Nullable owningAccount;
...
/**
 ...
 Required parameters: [HostedZoneId, Name, Owner]
 */
@interface AWSRoute53HostedZoneSummary : AWSModel
 ...
 */
@property (nonatomic, strong) AWSRoute53HostedZoneOwner * _Nullable owner;
...
/**
 ...
 Required parameters: [VPCId, VPCRegion]
 */
@interface AWSRoute53ListHostedZonesByVPCRequest : AWSRequest
 ...
 */
@interface AWSRoute53ListHostedZonesByVPCResponse : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<AWSRoute53HostedZoneSummary *> * _Nullable hostedZoneSummaries;
