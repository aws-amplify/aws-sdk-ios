...
{
    AWSMobileAnalyticsDefaultEventClient* target = [AWSMobileAnalyticsDefaultEventClient eventClientWithContext:mockContext
...
{
    AWSMobileAnalyticsDefaultEventClient* target = [AWSMobileAnalyticsDefaultEventClient eventClientWithContext:mockContext withDeliveryClient:mockDelivery allowsEventCollection:YES];
...
{
    AWSMobileAnalyticsDefaultEventClient* target = [AWSMobileAnalyticsDefaultEventClient eventClientWithContext:mockContext withDeliveryClient:mockDelivery allowsEventCollection:NO];
    TestEventObserver* interceptor = [self buildObserver];
    [target addEventObserver:interceptor];
