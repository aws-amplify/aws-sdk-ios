...
- (void)testCreateHostedConfigurationVersion {
    NSString *key = @"testCreateHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSAppconfig AppconfigForKey:key] createHostedConfigurationVersion:[AWSAppconfigCreateHostedConfigurationVersionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCreateHostedConfigurationVersionCompletionHandler {
    NSString *key = @"testCreateHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
	...
	[[AWSAppconfig AppconfigForKey:key] createHostedConfigurationVersion:[AWSAppconfigCreateHostedConfigurationVersionRequest new] completionHandler:^(AWSAppconfigHostedConfigurationVersion* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDeleteHostedConfigurationVersion {
    NSString *key = @"testDeleteHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSAppconfig AppconfigForKey:key] deleteHostedConfigurationVersion:[AWSAppconfigDeleteHostedConfigurationVersionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteHostedConfigurationVersionCompletionHandler {
    NSString *key = @"testDeleteHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
	...
	[[AWSAppconfig AppconfigForKey:key] deleteHostedConfigurationVersion:[AWSAppconfigDeleteHostedConfigurationVersionRequest new] completionHandler:^(NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        dispatch_semaphore_signal(semaphore);
...
- (void)testGetHostedConfigurationVersion {
    NSString *key = @"testGetHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSAppconfig AppconfigForKey:key] getHostedConfigurationVersion:[AWSAppconfigGetHostedConfigurationVersionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetHostedConfigurationVersionCompletionHandler {
    NSString *key = @"testGetHostedConfigurationVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
	...
	[[AWSAppconfig AppconfigForKey:key] getHostedConfigurationVersion:[AWSAppconfigGetHostedConfigurationVersionRequest new] completionHandler:^(AWSAppconfigHostedConfigurationVersion* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListHostedConfigurationVersions {
    NSString *key = @"testListHostedConfigurationVersions";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSAppconfig AppconfigForKey:key] listHostedConfigurationVersions:[AWSAppconfigListHostedConfigurationVersionsRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListHostedConfigurationVersionsCompletionHandler {
    NSString *key = @"testListHostedConfigurationVersions";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSAppconfig registerAppconfigWithConfiguration:configuration forKey:key];
	...
	[[AWSAppconfig AppconfigForKey:key] listHostedConfigurationVersions:[AWSAppconfigListHostedConfigurationVersionsRequest new] completionHandler:^(AWSAppconfigHostedConfigurationVersions* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
