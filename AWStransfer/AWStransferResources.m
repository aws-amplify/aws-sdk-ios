...
@interface AWStransferResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWStransferResources

+ (instancetype)sharedInstance {
    static AWStransferResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWStransferResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"ConflictException\":{\
      ...
      \"documentation\":\"<p>This exception is thrown when the <code>UpdatServer</code> is called for a file transfer protocol-enabled server that has VPC as the endpoint type and the server's <code>VpcEndpointID</code> is not in the available state.</p>\",\
      \"exception\":true\
    },\
    \"CreateServerRequest\":{\
      \"type\":\"structure\",\
    ...
    \"DescribedServer\":{\
      ...
      \"members\":{\
        \"Arn\":{\
          \"shape\":\"Arn\",\
          \"documentation\":\"<p>Specifies the unique Amazon Resource Name (ARN) for a file transfer protocol-enabled server to be described.</p>\"\
        },\
        \"Certificate\":{\
          \"shape\":\"Certificate\",\
          \"documentation\":\"<p>The Amazon Resource Name (ARN) of the AWS Certificate Manager (ACM) certificate. Required when <code>Protocols</code> is set to <code>FTPS</code>.</p>\"\
    ...
    \"InternalServiceError\":{\
      ...
      \"documentation\":\"<p>This exception is thrown when an error occurs in the AWS Transfer Family service.</p>\",\
      \"exception\":true,\
      \"fault\":true\
    },\
    ...
    \"ResourceNotFoundException\":{\
      ...
      \"documentation\":\"<p>This exception is thrown when a resource is not found by the AWS Transfer Family service.</p>\",\
      \"exception\":true\
    },\
    ...
    \"ServiceUnavailableException\":{\
      ...
      \"documentation\":\"<p>The request has failed because the AWS Transfer Family service is not available.</p>\",\
      \"exception\":true,\
      \"fault\":true,\
      \"synthetic\":true\
    },\
