...
@interface AWSServicecatalogResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSServicecatalogResources

+ (instancetype)sharedInstance {
    static AWSServicecatalogResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSServicecatalogResources new];
    });
