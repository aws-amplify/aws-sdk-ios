...
+ (NSValueTransformer *)typesJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"BACKUP_POLICY"] == NSOrderedSame) {
            return @(AWSOrganizationsPolicyTypeBackupPolicy);
        }
        ...
        switch ([value integerValue]) {
            ...
            case AWSOrganizationsPolicyTypeTagPolicy:
                return @"TAG_POLICY";
            case AWSOrganizationsPolicyTypeBackupPolicy:
...
+ (NSValueTransformer *)policyTypeJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"BACKUP_POLICY"] == NSOrderedSame) {
            return @(AWSOrganizationsEffectivePolicyTypeBackupPolicy);
        }
        ...
        switch ([value integerValue]) {
            case AWSOrganizationsEffectivePolicyTypeTagPolicy:
                return @"TAG_POLICY";
            case AWSOrganizationsEffectivePolicyTypeBackupPolicy:
                return @"BACKUP_POLICY";
            default:
                return nil;
        }
