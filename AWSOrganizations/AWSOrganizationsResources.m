...
@interface AWSOrganizationsResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSOrganizationsResources

+ (instancetype)sharedInstance {
    static AWSOrganizationsResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSOrganizationsResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"DescribeEffectivePolicyRequest\":{\
      ...
      \"members\":{\
        \"PolicyType\":{\
          ...
          \"documentation\":\"<p>The type of policy that you want information about.</p>\"\
        },\
        \"TargetId\":{\
          \"shape\":\"PolicyTargetId\",\
          \"documentation\":\"<p>When you're signed in as the master account, specify the ID of the account that you want details about. Specifying an organization root or OU as the target is not supported. </p>\"\
        }\
      }\
    },\
    ...
    \"EffectivePolicyNotFoundException\":{\
      ...
      \"documentation\":\"<p>If you ran this action on the master account, this policy type is not enabled. If you ran the action on a member account, the account doesn't have an effective policy of this type. Contact the administrator of your organization about attaching a policy of this type to the account. </p>\",\
      \"exception\":true\
    },\
    \"EffectivePolicyType\":{\
      \"type\":\"string\",\
    ...
    \"PolicyChangesInProgressException\":{\
      ...
      \"documentation\":\"<p>Changes to the effective policy are in progress, and its contents can't be returned. Try the operation again later. </p>\",\
      \"exception\":true\
    },\
    \"PolicyContent\":{\
      \"type\":\"string\",\
    ...
    \"TagResourceRequest\":{\
      ...
      \"members\":{\
        ...
        \"Tags\":{\
          \"shape\":\"Tags\",\
          \"documentation\":\"<p>The tag to add to the specified resource. Specifying the tag key is required. You can set the value of a tag to an empty string, but you can't set the value of a tag to null.</p>\"\
        }\
      }\
    },\
    \"TagValue\":{\
    ...
    \"UnsupportedAPIEndpointException\":{\
      ...
      \"documentation\":\"<p>This action isn't available in the current Region.</p>\",\
      \"exception\":true\
    },\
