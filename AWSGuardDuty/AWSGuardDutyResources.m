...
@interface AWSGuardDutyResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSGuardDutyResources

+ (instancetype)sharedInstance {
    static AWSGuardDutyResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSGuardDutyResources new];
    });
  ...
  \"shapes\":{\
    ...
    \"CreateIPSetRequest\":{\
      ...
      \"members\":{\
        ...
        \"Location\":{\
          \"shape\":\"Location\",\
          \"documentation\":\"<p>The URI of the file that contains the IPSet. For example: .</p>\",\
    ...
    \"CreateThreatIntelSetRequest\":{\
      ...
      \"members\":{\
        ...
        \"Location\":{\
          \"shape\":\"Location\",\
          \"documentation\":\"<p>The URI of the file that contains the ThreatIntelSet. For example: .</p>\",\
          \"locationName\":\"location\"\
        },\
        \"Activate\":{\
          \"shape\":\"Boolean\",\
    ...
    \"InviteMembersRequest\":{\
      ...
      \"members\":{\
        ...
        \"DisableEmailNotification\":{\
          \"shape\":\"Boolean\",\
          \"documentation\":\"<p>A Boolean value that specifies whether you want to disable email notification to the accounts that youâre inviting to GuardDuty as members.</p>\",\
          \"locationName\":\"disableEmailNotification\"\
        },\
        \"Message\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The invitation message that you want to send to the accounts that youâre inviting to GuardDuty as members.</p>\",\
          \"locationName\":\"message\"\
        }\
      }\
    },\
    ...
    \"UpdateIPSetRequest\":{\
      ...
      \"members\":{\
        ...
        \"Location\":{\
          \"shape\":\"Location\",\
          \"documentation\":\"<p>The updated URI of the file that contains the IPSet. For example: .</p>\",\
          \"locationName\":\"location\"\
        },\
        \"Activate\":{\
          \"shape\":\"Boolean\",\
    ...
    \"UpdateThreatIntelSetRequest\":{\
      ...
      \"members\":{\
        ...
        \"Location\":{\
          \"shape\":\"Location\",\
          \"documentation\":\"<p>The updated URI of the file that contains the ThreateIntelSet. For example: .</p>\",\
          \"locationName\":\"location\"\
        },\
        \"Activate\":{\
          \"shape\":\"Boolean\",\
