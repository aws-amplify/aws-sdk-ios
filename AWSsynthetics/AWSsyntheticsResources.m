  ...
  \"shapes\":{\
    ...
    \"DeleteCanaryRequest\":{\
      ...
      \"members\":{\
        \"Name\":{\
          \"shape\":\"CanaryName\",\
          \"documentation\":\"<p>The name of the canary that you want to delete. To find the names of your canaries, use <a>DescribeCanaries</a>.</p>\",\
          \"location\":\"uri\",\
          \"locationName\":\"name\"\
        }\
      }\
    ...
    \"StartCanaryRequest\":{\
      ...
      \"members\":{\
        \"Name\":{\
          \"shape\":\"CanaryName\",\
          \"documentation\":\"<p>The name of the canary that you want to run. To find canary names, use <a>DescribeCanaries</a>.</p>\",\
          \"location\":\"uri\",\
          \"locationName\":\"name\"\
        }\
      }\
    ...
    \"StopCanaryRequest\":{\
      ...
      \"members\":{\
        \"Name\":{\
          \"shape\":\"CanaryName\",\
          \"documentation\":\"<p>The name of the canary that you want to stop. To find the names of your canaries, use <a>DescribeCanaries</a>.</p>\",\
          \"location\":\"uri\",\
          \"locationName\":\"name\"\
        }\
      }\
    ...
    \"UpdateCanaryRequest\":{\
      ...
      \"members\":{\
        \"Name\":{\
          \"shape\":\"CanaryName\",\
          \"documentation\":\"<p>The name of the canary that you want to update. To find the names of your canaries, use <a>DescribeCanaries</a>.</p> <p>You cannot change the name of a canary that has already been created.</p>\",\
          \"location\":\"uri\",\
          \"locationName\":\"name\"\
        },\
        \"Code\":{\
