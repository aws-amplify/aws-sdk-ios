...
/**
 <p>The name of the canary that you want to delete. To find the names of your canaries, use <a>DescribeCanaries</a>.</p>
 */
@property (nonatomic, strong) NSString * _Nullable name;
...
/**
 <p>The name of the canary that you want to run. To find canary names, use <a>DescribeCanaries</a>.</p>
 */
@property (nonatomic, strong) NSString * _Nullable name;
...
/**
 <p>The name of the canary that you want to stop. To find the names of your canaries, use <a>DescribeCanaries</a>.</p>
 */
@property (nonatomic, strong) NSString * _Nullable name;
...
/**
 <p>The name of the canary that you want to update. To find the names of your canaries, use <a>DescribeCanaries</a>.</p><p>You cannot change the name of a canary that has already been created.</p>
 */
@property (nonatomic, strong) NSString * _Nullable name;
