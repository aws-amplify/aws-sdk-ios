Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '8.0'
  s.source       = { :git => 'https://github.com/sunchunqiang/aws-sdk-ios.git',
                     :tag => s.version}
  s.requires_arc = true
  ...
  s.subspec 'AWSAPIGateway' do |apigateway|
    apigateway.dependency 'AWSAPIGateway', '2.6.33'
  end
  ...
  s.subspec 'CloudWatch' do |cloudwatch|
  	cloudwatch.dependency 'AWSCloudWatch', '2.6.33'
  end

  s.subspec 'Pinpoint' do |pp|
        pp.dependency 'AWSPinpoint', '2.6.33'
  end
  ...
  s.subspec 'AWSCognitoIdentityProvider' do |cognitoidentityprovider|
    cognitoidentityprovider.dependency 'AWSCognitoIdentityProvider', '2.6.33'
  end

  s.subspec 'AWSComprehend' do |comprehend|
    comprehend.dependency 'AWSComprehend', '2.6.33'
  end

  s.subspec 'DynamoDB' do |ddb|
  	ddb.dependency 'AWSDynamoDB', '2.6.33'
  end

  s.subspec 'EC2' do |ec2|
  	ec2.dependency 'AWSEC2', '2.6.33'
  end

  s.subspec 'ElasticLoadBalancing' do |elasticloadbalancing|
  	elasticloadbalancing.dependency 'AWSElasticLoadBalancing', '2.6.33'
  end
  ...
  s.subspec 'Kinesis' do |kinesis|
    kinesis.dependency 'AWSKinesis', '2.6.33'
  end

  s.subspec 'AWSKMS' do |kms|
    kms.dependency 'AWSKMS', '2.6.33'
  end

  s.subspec 'AWSLambda' do |lambda|
        lambda.dependency 'AWSLambda', '2.6.33'
  end

  s.subspec 'AWSLex' do |lex|
        lex.dependency 'AWSLex', '2.6.33'
  end

   s.subspec 'AWSLogs' do |log|
        log.dependency 'AWSLogs', '2.6.33'
  end

  s.subspec 'AWSMachineLearning' do |machinelearning|
        machinelearning.dependency 'AWSMachineLearning', '2.6.33'
  end

  s.subspec 'AWSPolly' do |polly|
        polly.dependency 'AWSPolly', '2.6.33'
  end

  s.subspec 'MobileAnalytics' do |mobileanalytics|
  	mobileanalytics.dependency 'AWSMobileAnalytics', '2.6.33'
  end

  s.subspec 'AWSRekognition' do |rekognition|
  	rekognition.dependency 'AWSRekognition', '2.6.33'
  end
  ...
  s.subspec 'AWSSES' do |ses|
  	ses.dependency 'AWSSES', '2.6.33'
  end

  s.subspec 'AWSSimpleDB' do |simpledb|
  	simpledb.dependency 'AWSSimpleDB', '2.6.33'
  end
  ...
  s.subspec 'AWSTranscribe' do |transcribe|
    transcribe.dependency 'AWSTranscribe', '2.6.33'
  end

  s.subspec 'AWSTranslate' do |translate|
    translate.dependency 'AWSTranslate', '2.6.33'
  end
