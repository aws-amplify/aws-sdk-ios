...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeletePolicy\":{\
      ...
      \"documentation\":\"<p>Deletes the specified scaling policy.</p> <p>Deleting a policy deletes the underlying alarm action, but does not delete the alarm, even if it no longer has an associated action.</p>\"\
    },\
  ...
  \"shapes\":{\
    ...
    \"CreateAutoScalingGroupType\":{\
      ...
      \"members\":{\
        \"AutoScalingGroupName\":{\
          \"shape\":\"XmlStringMaxLen255\",\
          \"documentation\":\"<p>The name of the Auto Scaling group. This name must be unique within the scope of your AWS account.</p>\"\
        },\
        \"LaunchConfigurationName\":{\
          \"shape\":\"ResourceName\",\
        ...
        \"MixedInstancesPolicy\":{\
          \"shape\":\"MixedInstancesPolicy\",\
          \"documentation\":\"<p>The mixed instances policy to use to launch instances. This parameter, a launch template, a launch configuration, or an EC2 instance must be specified.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-purchase-options.html\\\">Auto Scaling Groups with Multiple Instance Types and Purchase Options</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>\"\
        },\
        \"InstanceId\":{\
          \"shape\":\"XmlStringMaxLen19\",\
          \"documentation\":\"<p>The ID of the instance used to create a launch configuration for the group. This parameter, a launch configuration, a launch template, or a mixed instances policy must be specified.</p> <p>When you specify an ID of an instance, Amazon EC2 Auto Scaling creates a new launch configuration and associates it with the group. This launch configuration derives its attributes from the specified instance, except for the block device mapping.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-from-instance.html\\\">Create an Auto Scaling Group Using an EC2 Instance</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>\"\
        },\
        \"MinSize\":{\
          \"shape\":\"AutoScalingGroupMinSize\",\
          \"documentation\":\"<p>The minimum size of the group.</p>\"\
        ...
        \"LoadBalancerNames\":{\
          \"shape\":\"LoadBalancerNames\",\
          \"documentation\":\"<p>One or more Classic Load Balancers. To specify an Application Load Balancer or a Network Load Balancer, use <code>TargetGroupARNs</code> instead.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html\\\">Using a Load Balancer With an Auto Scaling Group</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>\"\
        },\
        \"TargetGroupARNs\":{\
          \"shape\":\"TargetGroupARNs\",\
    ...
    \"CreateLaunchConfigurationType\":{\
      ...
      \"members\":{\
        ...
        \"PlacementTenancy\":{\
          ...
          \"documentation\":\"<p>The tenancy of the instance. An instance with a tenancy of <code>dedicated</code> runs on single-tenant hardware and can only be launched into a VPC.</p> <p>To launch Dedicated Instances into a shared tenancy VPC (a VPC with the instance placement tenancy attribute set to <code>default</code>), you must set the value of this parameter to <code>dedicated</code>.</p> <p>If you specify this parameter, be sure to specify at least one subnet when you create your group.</p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html\\\">Launching Auto Scaling Instances in a VPC</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p> <p>Valid values: <code>default</code> | <code>dedicated</code> </p>\"\
        }\
      }\
    },\
    ...
    \"Ebs\":{\
      ...
      \"members\":{\
        \"SnapshotId\":{\
          \"shape\":\"XmlStringMaxLen255\",\
          \"documentation\":\"<p>The ID of the snapshot. This parameter is optional if you specify a volume size. </p>\"\
        },\
        \"VolumeSize\":{\
          \"shape\":\"BlockDeviceEbsVolumeSize\",\
          \"documentation\":\"<p>The volume size, in GiB. </p> <p>Constraints: 1-1,024 for <code>standard</code>, 4-16,384 for <code>io1</code>, 1-16,384 for <code>gp2</code>, and 500-16,384 for <code>st1</code> and <code>sc1</code>. If you specify a snapshot, the volume size must be equal to or larger than the snapshot size.</p> <p>Default: If you create a volume from a snapshot and you don't specify a volume size, the default is the snapshot size.</p> <note> <p>At least one of VolumeSize or SnapshotId is required.</p> </note>\"\
        },\
        \"VolumeType\":{\
    ...
    \"InstancesDistribution\":{\
      ...
      \"members\":{\
        ...
        \"SpotInstancePools\":{\
          ...
          \"documentation\":\"<p>The number of Spot pools to use to allocate your Spot capacity. The Spot pools are determined from the different instance types in the Overrides array of <a>LaunchTemplate</a>. </p> <p>The range is 1â20 and the default is 2. </p>\"\
        },\
        \"SpotMaxPrice\":{\
    ...
    \"LaunchTemplate\":{\
      ...
      \"members\":{\
        ...
        \"Overrides\":{\
          \"shape\":\"Overrides\",\
          \"documentation\":\"<p>Any parameters that you specify override the same parameters in the launch template. Currently, the only supported override is instance type. </p> <p>You must specify between 2 and 20 overrides.</p>\"\
        }\
      },\
    ...
    \"MixedInstancesPolicy\":{\
      ...
      \"members\":{\
        \"LaunchTemplate\":{\
          ...
          \"documentation\":\"<p>The launch template and overrides.</p> <p>This parameter is required when creating an Auto Scaling group with a mixed instances policy, but is not required when updating the group.</p>\"\
        },\
        \"InstancesDistribution\":{\
          \"shape\":\"InstancesDistribution\",\
          \"documentation\":\"<p>The instances distribution to use. </p> <p>If you leave this parameter unspecified when creating the group, the default values are used.</p>\"\
        }\
      },\
    ...
    \"ScalingPolicy\":{\
      ...
      \"members\":{\
        ...
        \"PolicyType\":{\
          \"shape\":\"XmlStringMaxLen64\",\
          \"documentation\":\"<p>The policy type. The valid values are <code>SimpleScaling</code> and <code>StepScaling</code>.</p>\"\
        },\
        \"AdjustmentType\":{\
          \"shape\":\"XmlStringMaxLen255\",\
    ...
    \"ScheduledUpdateGroupAction\":{\
      ...
      \"members\":{\
        ...
        \"StartTime\":{\
          \"shape\":\"TimestampType\",\
          \"documentation\":\"<p>The date and time that the action is scheduled to begin. </p> <p>When <code>StartTime</code> and <code>EndTime</code> are specified with <code>Recurrence</code>, they form the boundaries of when the recurring action starts and stops.</p>\"\
        },\
        \"EndTime\":{\
          \"shape\":\"TimestampType\",\
    ...
    \"UpdateAutoScalingGroupType\":{\
      ...
      \"members\":{\
        ...
        \"LaunchConfigurationName\":{\
          \"shape\":\"ResourceName\",\
          \"documentation\":\"<p>The name of the launch configuration. If you specify this parameter, you can't specify a launch template or a mixed instances policy.</p>\"\
        },\
        \"LaunchTemplate\":{\
          \"shape\":\"LaunchTemplateSpecification\",\
          \"documentation\":\"<p>The launch template and version to use to specify the updates. If you specify this parameter, you can't specify a launch configuration or a mixed instances policy.</p>\"\
        },\
        \"MixedInstancesPolicy\":{\
          \"shape\":\"MixedInstancesPolicy\",\
          \"documentation\":\"<p>The mixed instances policy to use to specify the updates. If you specify this parameter, you can't specify a launch configuration or a launch template. </p> <p>For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-purchase-options.html\\\">Auto Scaling Groups with Multiple Instance Types and Purchase Options</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>\"\
        },\
        \"MinSize\":{\
          \"shape\":\"AutoScalingGroupMinSize\",\
        ...
        \"VPCZoneIdentifier\":{\
          \"shape\":\"XmlStringMaxLen2047\",\
          \"documentation\":\"<p>A comma-separated list of subnet IDs, if you are launching into a VPC.</p> <p>If you specify <code>VPCZoneIdentifier</code> with <code>AvailabilityZones</code>, the subnets that you specify for this parameter must reside in those Availability Zones.</p>\"\
        },\
        \"TerminationPolicies\":{\
          \"shape\":\"TerminationPolicies\",\
