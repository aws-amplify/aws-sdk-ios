  ...
  \"shapes\":{\
    ...
    \"AutoScalingGroup\":{\
      ...
      \"members\":{\
        ...
        \"CapacityRebalance\":{\
          ...
          \"documentation\":\"<p>Indicates whether capacity rebalance is enabled.</p>\"\
        }\
      },\
    ...
    \"UpdateAutoScalingGroupType\":{\
      ...
      \"members\":{\
        ...
        \"CapacityRebalance\":{\
          \"shape\":\"CapacityRebalanceEnabled\",\
          \"documentation\":\"<p>Enables or disables capacity rebalance.</p> <p>You can enable capacity rebalancing for your Auto Scaling groups when using Spot Instances. When you turn on capacity rebalancing, Amazon EC2 Auto Scaling attempts to launch a Spot Instance whenever Amazon EC2 predicts that a Spot Instance is at an elevated risk of interruption. After launching a new instance, it then terminates an old instance. For more information, see <a href=\\\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/capacity-rebalance.html\\\">Amazon EC2 Auto Scaling capacity rebalancing</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>\"\
        }\
      }\
    },\
    \"Values\":{\
