...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"TranslateDocument\":{\
      ...
      \"documentation\":\"<p>Translates the input document from the source language to the target language. This synchronous operation supports plain text or HTML for the input document. <code>TranslateDocument</code> supports translations from English to any supported language, and from any supported language to English. Therefore, specify either the source language code or the target language code as âenâ (English). </p> <p> <code>TranslateDocument</code> does not support language auto-detection. </p> <p> If you set the <code>Formality</code> parameter, the request will fail if the target language does not support formality. For a list of target languages that support formality, see <a href=\\\"https://docs.aws.amazon.com/translate/latest/dg/customizing-translations-formality.html\\\">Setting formality</a>. </p>\"\
    },\
    \"TranslateText\":{\
      \"name\":\"TranslateText\",\
      \"http\":{\
  ...
  \"shapes\":{\
    ...
    \"TranslateDocumentRequest\":{\
      ...
      \"members\":{\
        ...
        \"SourceLanguageCode\":{\
          \"shape\":\"LanguageCodeString\",\
          \"documentation\":\"<p>The language code for the language of the source text. Do not use <code>auto</code>, because <code>TranslateDocument</code> does not support language auto-detection. For a list of supported language codes, see <a href=\\\"https://docs.aws.amazon.com/translate/latest/dg/what-is-languages.html\\\">Supported languages</a>.</p>\"\
        },\
        \"TargetLanguageCode\":{\
          \"shape\":\"LanguageCodeString\",\
        ...
        \"Settings\":{\"shape\":\"TranslationSettings\"}\
      }\
    },\
