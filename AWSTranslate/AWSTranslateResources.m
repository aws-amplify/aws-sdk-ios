...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"TranslateDocument\":{\
      ...
      \"input\":{\"shape\":\"TranslateDocumentRequest\"},\
      \"output\":{\"shape\":\"TranslateDocumentResponse\"},\
      \"errors\":[\
        {\"shape\":\"InvalidRequestException\"},\
        {\"shape\":\"LimitExceededException\"},\
        {\"shape\":\"TooManyRequestsException\"},\
      ...
      \"documentation\":\"<p>Translates the input document from the source language to the target language. This synchronous operation supports text, HTML, or Word documents as the input document. <code>TranslateDocument</code> supports translations from English to any supported language, and from any supported language to English. Therefore, specify either the source language code or the target language code as âenâ (English). </p> <p> If you set the <code>Formality</code> parameter, the request will fail if the target language does not support formality. For a list of target languages that support formality, see <a href=\\\"https://docs.aws.amazon.com/translate/latest/dg/customizing-translations-formality.html\\\">Setting formality</a>. </p>\"\
    },\
    \"TranslateText\":{\
      \"name\":\"TranslateText\",\
      \"http\":{\
  ...
  \"shapes\":{\
    ...
    \"Document\":{\
      ...
      \"members\":{\
        \"Content\":{\
          ...
          \"documentation\":\"<p>The <code>Content</code>field type is Binary large object (blob). This object contains the document content converted into base64-encoded binary data. If you use one of the AWS SDKs, the SDK performs the Base64-encoding on this field before sending the request. </p>\"\
        },\
        \"ContentType\":{\
          \"shape\":\"ContentType\",\
    ...
    \"StartTextTranslationJobRequest\":{\
      ...
      \"members\":{\
        ...
        \"Settings\":{\
          ...
          \"documentation\":\"<p>Settings to configure your translation output. You can configure the following options:</p> <ul> <li> <p>Brevity: not supported.</p> </li> <li> <p>Formality: sets the formality level of the output text.</p> </li> <li> <p>Profanity: masks profane words and phrases in your translation output.</p> </li> </ul>\"\
        }\
      }\
    },\
    ...
    \"TextTranslationJobProperties\":{\
      ...
      \"members\":{\
        ...
        \"Settings\":{\
          \"shape\":\"TranslationSettings\",\
          \"documentation\":\"<p>Settings that modify the translation output.</p>\"\
        }\
      },\
    ...
    \"TranslateDocumentResponse\":{\
      ...
      \"members\":{\
        \"TranslatedDocument\":{\
          \"shape\":\"TranslatedDocument\",\
          \"documentation\":\"<p>The document containing the translated content. The document format matches the source document format.</p>\"\
        },\
        \"SourceLanguageCode\":{\
          \"shape\":\"LanguageCodeString\",\
          \"documentation\":\"<p>The language code of the source document.</p>\"\
        },\
        \"TargetLanguageCode\":{\
          \"shape\":\"LanguageCodeString\",\
          \"documentation\":\"<p>The language code of the translated document. </p>\"\
        },\
        \"AppliedTerminologies\":{\
          \"shape\":\"AppliedTerminologyList\",\
          \"documentation\":\"<p>The names of the custom terminologies applied to the input text by Amazon Translate to produce the translated text document.</p>\"\
        },\
        \"AppliedSettings\":{\"shape\":\"TranslationSettings\"}\
      }\
    },\
    \"TranslateTextRequest\":{\
      ...
      \"members\":{\
        ...
        \"TargetLanguageCode\":{\
          \"shape\":\"LanguageCodeString\",\
          \"documentation\":\"<p>The language code requested for the language of the target text. For a list of language codes, see <a href=\\\"https://docs.aws.amazon.com/translate/latest/dg/what-is-languages.html\\\">Supported languages</a>.</p>\"\
        },\
        \"Settings\":{\
          \"shape\":\"TranslationSettings\",\
          \"documentation\":\"<p>Settings to configure your translation output. You can configure the following options:</p> <ul> <li> <p>Brevity: reduces the length of the translated output for most translations.</p> </li> <li> <p>Formality: sets the formality level of the output text.</p> </li> <li> <p>Profanity: masks profane words and phrases in your translation output.</p> </li> </ul>\"\
        }\
      }\
    },\
    \"TranslateTextResponse\":{\
      ...
      \"members\":{\
        ...
        \"AppliedSettings\":{\
          \"shape\":\"TranslationSettings\",\
          \"documentation\":\"<p>Optional settings that modify the translation output.</p>\"\
        }\
      }\
    },\
    \"TranslatedDocument\":{\
      ...
      \"members\":{\
        \"Content\":{\
          \"shape\":\"TranslatedDocumentContent\",\
          \"documentation\":\"<p>The document containing the translated content.</p>\"\
        }\
      },\
      \"documentation\":\"<p>The translated content.</p>\"\
    },\
    ...
    \"UnsupportedLanguagePairException\":{\
      ...
      \"documentation\":\"<p>Amazon Translate does not support translation from the language of the source text into the requested target language. For more information, see <a href=\\\"https://docs.aws.amazon.com/translate/latest/dg/what-is-languages.html\\\">Supported languages</a>. </p>\",\
      \"exception\":true\
    },\
