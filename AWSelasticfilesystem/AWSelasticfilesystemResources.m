...
@interface AWSelasticfilesystemResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSelasticfilesystemResources

+ (instancetype)sharedInstance {
    static AWSelasticfilesystemResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSelasticfilesystemResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"shapes\":{\
    ...
    \"TooManyRequests\":{\
      ...
      \"documentation\":\"<p>Returned if you donât wait at least 24 hours before changing the throughput mode, or decreasing the Provisioned Throughput value.</p>\",\
