...
@interface AWSDataexchangeResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSDataexchangeResources

+ (instancetype)sharedInstance {
    static AWSDataexchangeResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSDataexchangeResources new];
    });
  ...
  \"shapes\": {\
    ...
    \"InternalServerException\": {\
      ...
      \"members\": {\
        \"Message\": {\
          \"shape\": \"__string\",\
          \"documentation\": \"The message identifying the service exception that occurred.\"\
        }\
      },\
      \"documentation\": \"An exception occurred with the service.\",\
      \"required\": [\
        \"Message\"\
      ],\
      \"exception\": true,\
    ...
    \"ServiceLimitExceededException\": {\
      ...
      \"members\": {\
        \"LimitName\": {\
          \"shape\": \"LimitName\",\
          \"documentation\": \"<p>The name of the quota that was exceeded.</p>\"\
        },\
        \"LimitValue\": {\
          \"shape\": \"__double\",\
          \"documentation\": \"<p>The maximum value for the service-specific limit.</p>\"\
        },\
        \"Message\": {\
          \"shape\": \"__string\",\
