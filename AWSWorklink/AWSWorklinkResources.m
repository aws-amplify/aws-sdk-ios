...
@interface AWSWorklinkResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSWorklinkResources

+ (instancetype)sharedInstance {
    static AWSWorklinkResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSWorklinkResources new];
    });
  ...
  \"shapes\":{\
    ...
    \"DescribeIdentityProviderConfigurationResponse\":{\
      ...
      \"members\":{\
        ...
        \"ServiceProviderSamlMetadata\":{\
          \"shape\":\"SamlMetadata\",\
          \"documentation\":\"<p>The SAML metadata document uploaded to the userâs identity provider.</p>\"\
        },\
        \"IdentityProviderSamlMetadata\":{\
          \"shape\":\"SamlMetadata\",\
          \"documentation\":\"<p>The SAML metadata document provided by the userâs identity provider.</p>\"\
        }\
      }\
    },\
    ...
    \"UpdateIdentityProviderConfigurationRequest\":{\
      ...
      \"members\":{\
        ...
        \"IdentityProviderSamlMetadata\":{\
          \"shape\":\"SamlMetadata\",\
          \"documentation\":\"<p>The SAML metadata document provided by the customerâs identity provider. The existing IdentityProviderSamlMetadata is unset if null is passed.</p>\"\
        }\
      }\
    },\
