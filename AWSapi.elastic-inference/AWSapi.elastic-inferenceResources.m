...
@interface AWSapi.elastic-inferenceResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSapi.elastic-inferenceResources

+ (instancetype)sharedInstance {
    static AWSapi.elastic-inferenceResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSapi.elastic-inferenceResources new];
    });
