...
@interface AWSMediatailorResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSMediatailorResources

+ (instancetype)sharedInstance {
    static AWSMediatailorResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSMediatailorResources new];
    });
