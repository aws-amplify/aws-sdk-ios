...
typedef NS_ENUM(NSInteger, AWSElasticacheMultiAZStatus) {
    AWSElasticacheMultiAZStatusUnknown,
    AWSElasticacheMultiAZStatusEnabled,
    AWSElasticacheMultiAZStatusDisabled,
};
...
/**
 <p>Specifies whether a read-only replica is automatically promoted to read/write primary if the existing primary fails.</p><p><code>AutomaticFailoverEnabled</code> must be enabled for Redis (cluster mode enabled) replication groups.</p><p>Default: false</p><p>Amazon ElastiCache for Redis does not support Multi-AZ with automatic failover on:</p><ul><li><p>Redis versions earlier than 2.8.6.</p></li><li><p>Redis (cluster mode disabled): T1 node types.</p></li><li><p>Redis (cluster mode enabled): T1 node types.</p></li></ul>
 */
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable multiAZEnabled;
...
/**
 <p>A flag indicating if you have Multi-AZ enabled to enhance fault tolerance. For more information, see <a href="http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/AutoFailover.html">Minimizing Downtime: Multi-AZ</a></p>
 */
@property (nonatomic, assign) AWSElasticacheMultiAZStatus multiAZ;
