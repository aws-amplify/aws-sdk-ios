...
@interface AWSapi.sagemakerResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSapi.sagemakerResources

+ (instancetype)sharedInstance {
    static AWSapi.sagemakerResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSapi.sagemakerResources new];
    });
...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"DeleteDomain\":{\
      ...
      \"documentation\":\"<p>Used to delete a domain. If you on-boarded with IAM mode, you will need to delete your domain to on-board again using SSO. Use with caution. All of the members of the domain will lose access to their EFS volume, including data, notebooks, and other artifacts. </p>\"\
    },\
    \"DeleteEndpoint\":{\
      \"name\":\"DeleteEndpoint\",\
      \"http\":{\
  ...
  \"shapes\":{\
    ...
    \"CreateAppRequest\":{\
      ...
      \"members\":{\
        ...
        \"ResourceSpec\":{\
          \"shape\":\"ResourceSpec\",\
          \"documentation\":\"<p>The instance type and quantity.</p>\"\
        }\
      }\
    },\
    \"CreateAppResponse\":{\
    ...
    \"DeleteDomainRequest\":{\
      ...
      \"members\":{\
        ...
        \"RetentionPolicy\":{\
          ...
          \"documentation\":\"<p>The retention policy for this domain, which specifies which resources will be retained after the Domain is deleted. By default, all resources are retained (not automatically deleted). </p>\"\
        }\
      }\
    },\
    ...
    \"DescribeUserProfileResponse\":{\
      ...
      \"members\":{\
        ...
        \"HomeEfsFileSystemUid\":{\
          \"shape\":\"EfsUid\",\
          \"documentation\":\"<p>The homa Amazon Elastic File System (EFS) Uid.</p>\"\
        },\
        \"Status\":{\
    ...
    \"ResourceSpec\":{\
      ...
      \"members\":{\
        \"SageMakerImageArn\":{\
          ...
          \"documentation\":\"<p>The Amazon Resource Name (ARN) of the image created on the instance.</p>\"\
        },\
        \"InstanceType\":{\
      ...
      \"documentation\":\"<p>The instance type and the Amazon Resource Name (ARN) of the image created on the instance. The ARN is stored as metadata in Amazon SageMaker Studio notebooks.</p>\"\
    },\
    \"ResourceType\":{\
      \"type\":\"string\",\
      \"enum\":[\
    ...
    \"RetentionPolicy\":{\
      ...
      \"members\":{\
        \"HomeEfsFileSystem\":{\
          \"shape\":\"RetentionType\",\
          \"documentation\":\"<p>The home Amazon Elastic File System (EFS).</p>\"\
        }\
      },\
      \"documentation\":\"<p>The retention policy.</p>\"\
    },\
    \"RetentionType\":{\
      \"type\":\"string\",\
      \"enum\":[\
