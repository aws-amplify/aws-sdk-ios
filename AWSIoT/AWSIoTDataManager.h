...
/**
 Retrieves the service client associated with the key. You need to call `+ registerIoTDataManagerWithConfiguration:forKey:` before invoking this method. If `+ registerIoTDataManagerWithConfiguration:forKey:` has not been called in advance or the key does not exist, this method returns `nil`.
