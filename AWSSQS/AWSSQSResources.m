...
- (NSString *)definitionString {
  ...
  \"operations\":{\
    ...
    \"ListQueues\":{\
      ...
      \"documentation\":\"<p>Returns a list of your queues. The maximum number of queues that can be returned is 1,000. If you specify a value for the optional <code>QueueNamePrefix</code> parameter, only queues with a name that begins with the specified value are returned.</p>\"\
    },\
    \"PurgeQueue\":{\
      \"name\":\"PurgeQueue\",\
      \"http\":{\
  ...
  \"shapes\":{\
    ...
    \"AddPermissionRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue to which permissions are added.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Label\":{\
          \"shape\":\"String\",\
    ...
    \"BatchResultErrorEntry\":{\
      ...
      \"members\":{\
        ...
        \"SenderFault\":{\
          \"shape\":\"Boolean\",\
          \"documentation\":\"<p>Specifies whether the error happened due to the sender's fault.</p>\"\
        },\
        \"Code\":{\
          \"shape\":\"String\",\
    ...
    \"ChangeMessageVisibilityBatchRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue whose messages' visibility is changed.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Entries\":{\
    ...
    \"ChangeMessageVisibilityRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue whose message's visibility is changed.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"ReceiptHandle\":{\
          \"shape\":\"String\",\
    ...
    \"DeleteMessageBatchRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue from which messages are deleted.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Entries\":{\
    ...
    \"DeleteQueueRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue to delete.</p> <p>Queue URLs are case-sensitive.</p>\"\
        }\
      },\
      \"documentation\":\"<p/>\"\
    },\
    ...
    \"GetQueueAttributesRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue whose attribute information is retrieved.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"AttributeNames\":{\
    ...
    \"GetQueueUrlRequest\":{\
      ...
      \"members\":{\
        \"QueueName\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The name of the queue whose URL must be fetched. Maximum 80 characters. Valid values: alphanumeric characters, hyphens (<code>-</code>), and underscores (<code>_</code>).</p> <p>Queue names are case-sensitive.</p>\"\
        },\
    ...
    \"GetQueueUrlResult\":{\
      ...
      \"documentation\":\"<p>For more information, see <a href=\\\"http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/UnderstandingResponses.html\\\">Responses</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>\"\
    },\
    ...
    \"InvalidIdFormat\":{\
      ...
      \"documentation\":\"<p>The receipt handle isn't valid for the current version.</p>\",\
      \"exception\":true\
    },\
    ...
    \"ListDeadLetterSourceQueuesRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of a dead-letter queue.</p> <p>Queue URLs are case-sensitive.</p>\"\
        }\
      },\
      \"documentation\":\"<p/>\"\
    },\
    ...
    \"MessageNotInflight\":{\
      ...
      \"documentation\":\"<p>The message referred to isn't in flight.</p>\",\
      \"error\":{\
    ...
    \"OverLimit\":{\
      ...
      \"documentation\":\"<p>The action that you requested would violate a limit. For example, <code>ReceiveMessage</code> returns this error if the maximum number of inflight messages is reached. <code> <a>AddPermission</a> </code> returns this error if the maximum number of permissions for the queue is reached.</p>\",\
      \"error\":{\
        \"code\":\"OverLimit\",\
        \"httpStatusCode\":403,\
        \"senderFault\":true\
    ...
    \"PurgeQueueRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the queue from which the <code>PurgeQueue</code> action deletes messages.</p> <p>Queue URLs are case-sensitive.</p>\"\
        }\
      },\
      \"documentation\":\"<p/>\"\
    },\
    ...
    \"QueueDeletedRecently\":{\
      ...
      \"documentation\":\"<p>You must wait 60 seconds after deleting a queue before you can create another one with the same name.</p>\",\
      \"error\":{\
    ...
    \"ReceiptHandleIsInvalid\":{\
      ...
      \"documentation\":\"<p>The receipt handle provided isn't valid.</p>\",\
      \"exception\":true\
    },\
    \"ReceiveMessageRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue from which messages are received.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"AttributeNames\":{\
          \"shape\":\"AttributeNameList\",\
        ...
        \"MaxNumberOfMessages\":{\
          \"shape\":\"Integer\",\
          \"documentation\":\"<p>The maximum number of messages to return. Amazon SQS never returns more messages than this value (however, fewer messages might be returned). Valid values are 1 to 10. Default is 1.</p>\"\
        },\
        \"VisibilityTimeout\":{\
          \"shape\":\"Integer\",\
    ...
    \"RemovePermissionRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue from which permissions are removed.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Label\":{\
          \"shape\":\"String\",\
    ...
    \"SendMessageBatchRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue to which batched messages are sent.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Entries\":{\
    ...
    \"SendMessageBatchRequestEntry\":{\
      ...
      \"members\":{\
        \"Id\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>An identifier for a message in this batch used to communicate the result.</p> <note> <p>The <code>Id</code>s of a batch request need to be unique within a request</p> </note>\"\
        },\
        \"MessageBody\":{\
          \"shape\":\"String\",\
    ...
    \"SendMessageRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue to which a message is sent.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"MessageBody\":{\
          \"shape\":\"String\",\
    ...
    \"SetQueueAttributesRequest\":{\
      ...
      \"members\":{\
        \"QueueUrl\":{\
          \"shape\":\"String\",\
          \"documentation\":\"<p>The URL of the Amazon SQS queue whose attributes are set.</p> <p>Queue URLs are case-sensitive.</p>\"\
        },\
        \"Attributes\":{\
          \"shape\":\"QueueAttributeMap\",\
