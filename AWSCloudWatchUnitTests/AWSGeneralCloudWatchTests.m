...
- (void)testListTagsForResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSCloudWatch CloudWatchForKey:key] listTagsForResource:[AWSCloudWatchListTagsForResourceInput new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListTagsForResourceCompletionHandler {
	...
	[[AWSCloudWatch CloudWatchForKey:key] listTagsForResource:[AWSCloudWatchListTagsForResourceInput new] completionHandler:^(AWSCloudWatchListTagsForResourceOutput* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testTagResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSCloudWatch CloudWatchForKey:key] tagResource:[AWSCloudWatchTagResourceInput new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testTagResourceCompletionHandler {
	...
	[[AWSCloudWatch CloudWatchForKey:key] tagResource:[AWSCloudWatchTagResourceInput new] completionHandler:^(AWSCloudWatchTagResourceOutput* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUntagResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSCloudWatch CloudWatchForKey:key] untagResource:[AWSCloudWatchUntagResourceInput new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUntagResourceCompletionHandler {
	...
	[[AWSCloudWatch CloudWatchForKey:key] untagResource:[AWSCloudWatchUntagResourceInput new] completionHandler:^(AWSCloudWatchUntagResourceOutput* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
