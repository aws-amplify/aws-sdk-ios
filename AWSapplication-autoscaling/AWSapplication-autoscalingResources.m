...
@interface AWSapplication-autoscalingResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSapplication-autoscalingResources

+ (instancetype)sharedInstance {
    static AWSapplication-autoscalingResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSapplication-autoscalingResources new];
    });
