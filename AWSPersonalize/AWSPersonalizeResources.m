...
@interface AWSPersonalizeResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSPersonalizeResources

+ (instancetype)sharedInstance {
    static AWSPersonalizeResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSPersonalizeResources new];
    });
